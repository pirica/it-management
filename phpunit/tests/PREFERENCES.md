...
- **HTML coverage:** `<coverage>` in `phpunit/phpunit.xml`; generate with `php scripts/run_tests.php --coverage` → `phpunit/coverage/html/index.html` (Xdebug or PCOV required)
