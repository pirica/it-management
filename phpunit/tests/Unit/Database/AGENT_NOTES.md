...
- **Split files:** `db/01_schema.sql`, `db/02_data.sql`, `db/03_triggers.sql` are generated from `database.sql`; parity gate `php scripts/verify_database_split_parity.php`.
