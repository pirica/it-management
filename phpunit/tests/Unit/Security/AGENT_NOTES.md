...
- **PentestReportTest.php** — subprocess runner for `scripts/verify_pentest_report.php` (`docs/report.md` ITM-PENTEST-001–022; expects `[PASS]`/`[OPEN]`/`[INFO]` labels; asserts ITM-PENTEST-007, ITM-PENTEST-009, ITM-PENTEST-010, ITM-PENTEST-011, ITM-PENTEST-012, ITM-PENTEST-013, ITM-PENTEST-014, ITM-PENTEST-015, and ITM-PENTEST-016 remediated).
