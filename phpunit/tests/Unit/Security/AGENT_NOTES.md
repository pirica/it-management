...
- **ItmEncryptDecryptTest.php** — `itm_encrypt()` / `itm_decrypt()` v2 GCM round-trip, legacy v1 CBC read, tampered v2 rejection, wrong-key contract without vault DB fixtures.
...
- **PentestReportTest.php** — subprocess runner for `scripts/verify_pentest_report.php` (`docs/report.md` ITM-PENTEST-001–023; expects `[PASS]`/`[INFO]` labels; `[INFO]` ITM-PENTEST-004, 004-mitigation, 005; asserts ITM-PENTEST-007, ITM-PENTEST-008, ITM-PENTEST-009, ITM-PENTEST-010, ITM-PENTEST-011, ITM-PENTEST-012, ITM-PENTEST-013, ITM-PENTEST-014, ITM-PENTEST-015, ITM-PENTEST-016, and ITM-PENTEST-023 remediated).
