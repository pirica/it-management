...
- **PentestReportTest.php** — subprocess runner for `scripts/verify_pentest_report.php` (`docs/report.md` ITM-PENTEST-001–022; expects `[PASS]`/`[OPEN]`/`[INFO]` labels; asserts ITM-PENTEST-007, ITM-PENTEST-012, and ITM-PENTEST-014 remediated).
