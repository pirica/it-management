# AGENT_NOTES.md - BudgetCategories Tests

## 1. Module Purpose
Unit/regression tests for `modules/budget_categories/`.

## 3. Required Relationships
- Production docs: `modules/budget_categories/AGENT_NOTES.md` (when present).
