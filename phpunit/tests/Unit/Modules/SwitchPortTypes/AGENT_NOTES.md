# AGENT_NOTES.md - SwitchPortTypes Tests

## 1. Module Purpose
Unit/regression tests for `modules/switch_port_types/`.

## 3. Required Relationships
- Production docs: `modules/switch_port_types/AGENT_NOTES.md` (when present).
