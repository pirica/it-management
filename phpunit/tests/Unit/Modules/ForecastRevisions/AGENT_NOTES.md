# AGENT_NOTES.md - ForecastRevisions Tests

## 1. Module Purpose
Unit/regression tests for `modules/forecast_revisions/`.

## 3. Required Relationships
- Production docs: `modules/forecast_revisions/AGENT_NOTES.md` (when present).
