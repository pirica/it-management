# AGENT_NOTES.md - EquipmentEnvironment Tests

## 1. Module Purpose
Unit/regression tests for `modules/equipment_environment/`.

## 3. Required Relationships
- Production docs: `modules/equipment_environment/AGENT_NOTES.md` (when present).
