# AGENT_NOTES.md - RoleAssignmentRights Tests

## 1. Module Purpose
Unit/regression tests for `modules/role_assignment_rights/`.

## 3. Required Relationships
- Production docs: `modules/role_assignment_rights/AGENT_NOTES.md` (when present).
