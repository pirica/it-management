# AGENT_NOTES.md - WorkstationOsVersions Tests

## 1. Module Purpose
Unit/regression tests for `modules/workstation_os_versions/`.

## 3. Required Relationships
- Production docs: `modules/workstation_os_versions/AGENT_NOTES.md` (when present).
