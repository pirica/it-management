# AGENT_NOTES.md - EquipmentFiber Tests

## 1. Module Purpose
Unit/regression tests for `modules/equipment_fiber/`.

## 3. Required Relationships
- Production docs: `modules/equipment_fiber/AGENT_NOTES.md` (when present).
