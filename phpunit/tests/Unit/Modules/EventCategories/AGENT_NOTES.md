# AGENT_NOTES.md - EventCategories Tests

## 1. Module Purpose
Unit/regression tests for `modules/event_categories/`.

## 3. Required Relationships
- Production docs: `modules/event_categories/AGENT_NOTES.md` (when present).
