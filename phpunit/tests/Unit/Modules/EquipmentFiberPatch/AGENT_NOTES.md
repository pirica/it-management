# AGENT_NOTES.md - EquipmentFiberPatch Tests

## 1. Module Purpose
Unit/regression tests for `modules/equipment_fiber_patch/`.

## 3. Required Relationships
- Production docs: `modules/equipment_fiber_patch/AGENT_NOTES.md` (when present).
