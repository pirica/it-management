# AGENT_NOTES.md - WorkstationDeviceTypes Tests

## 1. Module Purpose
Unit/regression tests for `modules/workstation_device_types/`.

## 3. Required Relationships
- Production docs: `modules/workstation_device_types/AGENT_NOTES.md` (when present).
