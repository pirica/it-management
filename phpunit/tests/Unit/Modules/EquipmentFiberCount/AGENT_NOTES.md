# AGENT_NOTES.md - EquipmentFiberCount Tests

## 1. Module Purpose
Unit/regression tests for `modules/equipment_fiber_count/`.

## 3. Required Relationships
- Production docs: `modules/equipment_fiber_count/AGENT_NOTES.md` (when present).
