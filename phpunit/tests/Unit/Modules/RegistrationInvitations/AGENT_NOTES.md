# AGENT_NOTES.md - RegistrationInvitations Tests

## 1. Module Purpose
Unit/regression tests for `modules/registration_invitations/`.

## 3. Required Relationships
- Production docs: `modules/registration_invitations/AGENT_NOTES.md` (when present).
