# AGENT_NOTES.md - WorkstationRam Tests

## 1. Module Purpose
Unit/regression tests for `modules/workstation_ram/`.

## 3. Required Relationships
- Production docs: `modules/workstation_ram/AGENT_NOTES.md` (when present).
