...
class SwitchPortsTest extends TestCase
{
    ...
    public function testCRUD()
    {
        ...
        $resport_type = mysqli_query($this->conn, "SELECT type FROM `switch_port_types` WHERE " . (strpos('switch_port_types', 'companies') === false && strpos('switch_port_types', 'employees') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resfiber_port_id = mysqli_query($this->conn, "SELECT id FROM `equipment_fiber` WHERE " . (strpos('equipment_fiber', 'companies') === false && strpos('equipment_fiber', 'employees') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resfiber_patch_id = mysqli_query($this->conn, "SELECT id FROM `equipment_fiber_patch` WHERE " . (strpos('equipment_fiber_patch', 'companies') === false && strpos('equipment_fiber_patch', 'employees') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resfiber_rack_id = mysqli_query($this->conn, "SELECT id FROM `equipment_fiber_rack` WHERE " . (strpos('equipment_fiber_rack', 'companies') === false && strpos('equipment_fiber_rack', 'employees') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resto_idf_id = mysqli_query($this->conn, "SELECT id FROM `idfs` WHERE " . (strpos('idfs', 'companies') === false && strpos('idfs', 'employees') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resto_rack_id = mysqli_query($this->conn, "SELECT id FROM `racks` WHERE " . (strpos('racks', 'companies') === false && strpos('racks', 'employees') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resrack_id = mysqli_query($this->conn, "SELECT id FROM `racks` WHERE " . (strpos('racks', 'companies') === false && strpos('racks', 'employees') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resto_location_id = mysqli_query($this->conn, "SELECT id FROM `it_locations` WHERE " . (strpos('it_locations', 'companies') === false && strpos('it_locations', 'employees') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
