# AGENT_NOTES.md - EmployeeOnboardingRequests Tests

## 1. Module Purpose
Unit/regression tests for `modules/employee_onboarding_requests/`.

## 3. Required Relationships
- Production docs: `modules/employee_onboarding_requests/AGENT_NOTES.md` (when present).
