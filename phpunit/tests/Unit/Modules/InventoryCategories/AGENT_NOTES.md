# AGENT_NOTES.md - InventoryCategories Tests

## 1. Module Purpose
Unit/regression tests for `modules/inventory_categories/`.

## 3. Required Relationships
- Production docs: `modules/inventory_categories/AGENT_NOTES.md` (when present).
