# AGENT_NOTES.md - FloorDesignerPoints Tests

## 1. Module Purpose
Unit/regression tests for `modules/floor_designer_points/`.

## 3. Required Relationships
- Production docs: `modules/floor_designer_points/AGENT_NOTES.md` (when present).
