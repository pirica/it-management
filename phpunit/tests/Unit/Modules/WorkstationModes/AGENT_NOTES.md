# AGENT_NOTES.md - WorkstationModes Tests

## 1. Module Purpose
Unit/regression tests for `modules/workstation_modes/`.

## 3. Required Relationships
- Production docs: `modules/workstation_modes/AGENT_NOTES.md` (when present).
