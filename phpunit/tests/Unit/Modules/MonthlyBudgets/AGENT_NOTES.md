# AGENT_NOTES.md - MonthlyBudgets Tests

## 1. Module Purpose
Unit/regression tests for `modules/monthly_budgets/`.

## 3. Required Relationships
- Production docs: `modules/monthly_budgets/AGENT_NOTES.md` (when present).
