...
## 7. File Structure
- `ExplorerTest.php` — `get_full_path()` ACL (`testGetFullPathSecurity`); hidden listing entries (`testHiddenSystemEntries`); preview routing (`testPreviewModeRouting`); ZIP read-only listing (`testZipArchiveEntryListing`).
