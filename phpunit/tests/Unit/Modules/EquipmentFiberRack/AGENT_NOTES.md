# AGENT_NOTES.md - EquipmentFiberRack Tests

## 1. Module Purpose
Unit/regression tests for `modules/equipment_fiber_rack/`.

## 3. Required Relationships
- Production docs: `modules/equipment_fiber_rack/AGENT_NOTES.md` (when present).
