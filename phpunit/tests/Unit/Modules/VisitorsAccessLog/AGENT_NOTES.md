# AGENT_NOTES.md - VisitorsAccessLog Tests

## 1. Module Purpose
Unit/regression tests for `modules/visitors_access_log/`.

## 3. Required Relationships
- Production docs: `modules/visitors_access_log/AGENT_NOTES.md` (when present).
