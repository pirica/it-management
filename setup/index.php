        ...
        <main class="panel">
            <?php if ($currentStep === 1): ?>
                ...
                <form method="post" id="setup-step1-form">
                    ...
                    <table>
                        <tr><th>Auto-detect</th><td><code class="setup-path" id="setup-auto-detect-path"><?php echo itm_setup_wizard_h_path_display($projectRootPreview); ?></code></td></tr>
                        <tr><th>Document root</th><td><code class="setup-path" id="setup-document-root-path"><?php echo itm_setup_wizard_h_path_display($step1DocumentRoot !== '' ? $step1DocumentRoot : '(not detected)'); ?></code></td></tr>
            ...
            <?php elseif ($currentStep === 2): ?>
                ...
                <p class="sub">Confirmed project root from step 1:<br><code class="setup-path"><?php echo itm_setup_wizard_h_path_display(itm_setup_wizard_format_path_display(itm_setup_wizard_project_root())); ?></code></p>
                <table class="setup-verify-table">
                    <?php foreach ($fileChecks as $row): ?>
                        <tr>
                            ...
                            <td class="setup-path-cell">
                                <?php if (!empty($row['path'])): ?>
                                    <span class="setup-verify-label"><?php echo itm_setup_wizard_h($row['label']); ?></span>
                                    <code class="setup-path"><?php echo itm_setup_wizard_h_path_display($row['path']); ?></code>
                                <?php else: ?>
                                    <?php echo itm_setup_wizard_h($row['message']); ?>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
