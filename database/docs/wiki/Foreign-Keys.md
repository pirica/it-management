...
- Audit visible columns in `list_all.php` against `database/01_schema.sql`, `database/02_triggers.sql`, and `database/03_data.sql` and `information_schema` relationships.
