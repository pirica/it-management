...
For an existing database, apply the Floor Plans tables from `database/01_schema.sql`, `database/02_triggers.sql`, and `database/03_data.sql` if they are not already present:
