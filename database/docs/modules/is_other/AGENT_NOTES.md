...
## 10. Common Pitfalls
- **Do not delete canonical wrappers:** Keep `modules/is_other/` and sibling `is_*` folders. [Cursor-Valid]
- **Type filter:** `$equipmentTypeNameFilter` must match `equipment_types.name` (`Other`). [Cursor-Valid]
