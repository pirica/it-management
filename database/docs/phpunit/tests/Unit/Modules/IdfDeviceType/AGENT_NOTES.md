# AGENT_NOTES.md - IdfDeviceType Tests

## 1. Module Purpose
Unit/regression tests for `modules/idf_device_type/`.

## 3. Required Relationships
- Production docs: `modules/idf_device_type/AGENT_NOTES.md` (when present).
