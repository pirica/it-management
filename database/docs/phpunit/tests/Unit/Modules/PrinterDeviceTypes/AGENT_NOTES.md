# AGENT_NOTES.md - PrinterDeviceTypes Tests

## 1. Module Purpose
Unit/regression tests for `modules/printer_device_types/`.

## 3. Required Relationships
- Production docs: `modules/printer_device_types/AGENT_NOTES.md` (when present).
