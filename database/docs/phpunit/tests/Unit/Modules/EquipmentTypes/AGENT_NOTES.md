# AGENT_NOTES.md - EquipmentTypes Tests

## 1. Module Purpose
Unit/regression tests for `modules/equipment_types/`.

## 3. Required Relationships
- Production docs: `modules/equipment_types/AGENT_NOTES.md` (when present).
