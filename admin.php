<?php
/**
 * Admin company overview (admin role only).
 *
...
// Fetch company options for the company switcher
...
<head>
    ...
    <title>Admin - <?php echo sanitize($app_name ?? itm_ui_config_app_name()); ?></title>
        ...
        <div class="main-content">
            ...
            <div class="content">
                <div style="position:relative;display:flex;justify-content:flex-end;align-items:center;margin-bottom:20px;min-height:40px;">
                    <h1 style="position:absolute;left:50%;transform:translateX(-50%);margin:0;text-align:center;" title="Admin overview">🛡️</h1>
