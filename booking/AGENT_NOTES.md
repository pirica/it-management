...
- **Room cards and detail modal** (`rooms.php`, `rooms/customize.php` → `portal_room_detail.php`): `hb_portal_room_type_photo_urls()` + `hb_portal_gallery_html()`; arrows hidden when only one image (`hb-gallery-wrap--single`).
