...
- `rooms/payment.php` — confirmation after step 4: portal header/stay bar, success card (confirmation #, guest, dates, total), stepper complete + aside summary; online payment not enabled (pay at hotel copy).
