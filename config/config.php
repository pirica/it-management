...
require_once ROOT_PATH . 'includes/itm_hotel_date_input.php';
require_once ROOT_PATH . 'includes/itm_uk_date_input.php';
...
require_once ROOT_PATH . 'includes/itm_hotel_booking_distribution_ari_deep.php';
...
require_once ROOT_PATH . 'includes/itm_hotel_booking_distribution_booking_com_connect.php';
require_once ROOT_PATH . 'includes/itm_hotel_booking_distribution_seed.php';
...
$favicon_url = itm_ui_config_favicon_url($ui_config, $company_id);
