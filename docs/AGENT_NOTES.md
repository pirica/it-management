...
- **docs/report.md** — penetration-test findings ITM-PENTEST-001–022; remediated **001–003, 006–008, 009–016**; documented open **004–005**; regression: `php scripts/verify_pentest_report.php` (`[PASS]` / `[OPEN]` / `[INFO]` / `[FAIL]` labels — see report → Regression verifier output). QA browser auth: `php scripts/verify_script_localhost_maintenance_auth.php`.
