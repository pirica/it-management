...
- **`bolt.md`** — BOLT performance journal (sidebar module-access cache); verify claims with `php scripts/benchmark_sidebar_module_access.php` (see **`scripts/SCRIPTS.md` → Sidebar module-access benchmark**).
