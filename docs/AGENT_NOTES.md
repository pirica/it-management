...
- **docs/report.md** — penetration-test findings ITM-PENTEST-001–022; remediated **001–003, 006–014, 016**; documented open **004–005, 008, 015**; regression: `php scripts/verify_pentest_report.php` (`[PASS]` / `[OPEN]` / `[INFO]` / `[FAIL]` labels — see report → Regression verifier output).
