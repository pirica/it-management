...
- **docs/todo.md** — security and platform hardening backlog migrated from retired wiki `TO-DO-3.md`. Item **#10** (PHPUnit pure-logic) and **#12** (`.env.example` strict drift) are **Done** as of 2026-09-04. Living **environment variable drift** snapshot at top of `docs/todo.md` — audit: [check_env_vars_in_use.php?run=1](http://localhost/it-management/scripts/check_env_vars_in_use.php?run=1). Canonical catalog: **`docs/ENV.md`**. Distinct from pentest register (`docs/report.md`) and product gaps (`docs/PRODUCT_GAPS_AND_MISSING.md`). Re-validate item status when closing items.
