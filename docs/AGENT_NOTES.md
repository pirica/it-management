...
- **docs/report.md** — penetration-test findings ITM-PENTEST-001–022; remediated **001–003, 006–007, 009–016**; documented open **004–005, 008**; regression: `php scripts/verify_pentest_report.php` (`[PASS]` / `[OPEN]` / `[INFO]` / `[FAIL]` labels — see report → Regression verifier output). Explorer API cap: `php scripts/verify_explorer_api_rate_limit.php`.
