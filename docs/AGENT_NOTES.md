...
- **docs/report.md** — penetration-test findings ITM-PENTEST-001–022; ITM-PENTEST-001 (approval HMAC) and ITM-PENTEST-006 (error display) remediated; regression: `php scripts/verify_pentest_report.php`.
