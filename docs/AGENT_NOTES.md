...
- **docs/VERIFY.md** — static code-only security review register (findings tables with **Status** `OPEN`/`FIXED`; `.env` root `.htaccess` marked **FIXED** / `ITM-PENTEST-023`). Distinct from live pentest register (`docs/report.md`) and backlog (`docs/todo.md`).
