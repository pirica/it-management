...
- **docs/report.md** — penetration-test findings ITM-PENTEST-001–022; ITM-PENTEST-001–003 and 006 remediated; regression: `php scripts/verify_pentest_report.php` (`[PASS]` / `[OPEN]` / `[INFO]` / `[FAIL]` labels — see report → Regression verifier output).
