...
- **docs/readme/** — README screenshots and architecture images. Root `README.md` documents seed companies (1–5) and login accounts (`Admin` / `Admin2`–`Admin5`, `demo1`–`demo5`) plus dashboard company switching.
