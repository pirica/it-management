...
|------|--------------|------------------------|
| **Live Agent** | Start Live Chat, Appointment, Knowledge Base, Create Ticket, Re-open Ticket, Email IT | In-app chat, `modules/appointment/`, `modules/knowledge_base/`, `modules/tickets/`, `send-email.php` |
