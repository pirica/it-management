...
| `examples/env.development.sample` | Local Laragon / Dunebox |
| `examples/env.production.sample` | Production-style |
...
Either line is enough for a dev label; using **both** is fine and matches [examples/env.development.sample](../examples/env.development.sample).
...
Or omit both keys (defaults to production). See [examples/env.production.sample](../examples/env.production.sample).
