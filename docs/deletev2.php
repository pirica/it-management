...
require_once 'it-management/scripts/count_db_tables.php';
require_once '/it-management/scripts/count_db_tables.php';
...
echo "<br>";
echo "expectedTables $expectedTables";
echo "<br>";
echo "numberFile $numberFile";
echo "<br>";
echo "countOutput $countOutput";
echo "<br>";
