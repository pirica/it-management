...
CREATE TABLE `equipment` (
  ...
  UNIQUE KEY `uq_equipment_company_serial_number` (`company_id`,`serial_number`),
  UNIQUE KEY `uq_equipment_company_hostname` (`company_id`,`hostname`),
  UNIQUE KEY `uq_equipment_company_ip_address` (`company_id`,`ip_address`),
