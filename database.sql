...
INSERT INTO `email_smtp_configurations` (`id`, `company_id`, `config_name`, `smtp_host`, `smtp_port`, `username`, `password_encrypted`, `from_email`, `from_name`, `is_default`, `active`, `created_at`, `updated_at`) VALUES ('1', '1', 'IT Manager', 'ABestaQuadrada', '25', 'noreply@example.com', NULL, 'noreply@example.com', 'Mail Manager', '1', '1', '2026-06-18 01:00:00', '2026-06-19 22:49:25');
INSERT INTO `email_smtp_configurations` (`id`, `company_id`, `config_name`, `smtp_host`, `smtp_port`, `username`, `password_encrypted`, `from_email`, `from_name`, `is_default`, `active`, `created_at`, `updated_at`) VALUES ('2', '2', 'IT Manager', 'ABestaQuadrada', '25', 'noreply@example.com', NULL, 'noreply@example.com', 'Mail Manager', '1', '1', '2026-06-18 01:00:00', '2026-06-19 22:49:25');
INSERT INTO `email_smtp_configurations` (`id`, `company_id`, `config_name`, `smtp_host`, `smtp_port`, `username`, `password_encrypted`, `from_email`, `from_name`, `is_default`, `active`, `created_at`, `updated_at`) VALUES ('3', '3', 'IT Manager', 'ABestaQuadrada', '25', 'noreply@example.com', NULL, 'noreply@example.com', 'Mail Manager', '1', '1', '2026-06-18 01:00:00', '2026-06-19 22:49:25');
INSERT INTO `email_smtp_configurations` (`id`, `company_id`, `config_name`, `smtp_host`, `smtp_port`, `username`, `password_encrypted`, `from_email`, `from_name`, `is_default`, `active`, `created_at`, `updated_at`) VALUES ('4', '4', 'IT Manager', 'ABestaQuadrada', '25', 'noreply@example.com', NULL, 'noreply@example.com', 'Mail Manager', '1', '1', '2026-06-18 01:00:00', '2026-06-19 22:49:25');
INSERT INTO `email_smtp_configurations` (`id`, `company_id`, `config_name`, `smtp_host`, `smtp_port`, `username`, `password_encrypted`, `from_email`, `from_name`, `is_default`, `active`, `created_at`, `updated_at`) VALUES ('5', '5', 'IT Manager', 'ABestaQuadrada', '25', 'noreply@example.com', NULL, 'noreply@example.com', 'Mail Manager', '1', '1', '2026-06-18 01:00:00', '2026-06-19 22:49:25');
...
-- Data for `equipment`
INSERT INTO `equipment` (`id`, `company_id`, `equipment_type_id`, `manufacturer_id`, `location_id`, `rack_id`, `idf_id`, `name`, `serial_number`, `model`, `hostname`, `ip_address`, `patch_port`, `mac_address`, `department_id`, `supplier_id`, `assigned_to_employee_id`, `status_id`, `purchase_date`, `purchase_cost`, `warranty_expiry`, `certificate_expiry`, `warranty_type_id`, `printer_device_type_id`, `printer_color_capable`, `printer_scan`, `workstation_device_type_id`, `workstation_os_type_id`, `workstation_processor`, `workstation_storage`, `workstation_os_installed_on`, `workstation_ram_id`, `workstation_os_version_id`, `switch_rj45_id`, `switch_port_numbering_layout_id`, `switch_fiber_id`, `switch_fiber_patch_id`, `switch_fiber_rack_id`, `switch_fiber_ports_number`, `switch_fiber_port_label`, `switch_poe_id`, `switch_environment_id`, `notes`, `photo_filename`, `active`, `created_at`, `updated_at`) VALUES (1, 1, 1, NULL, NULL, NULL, NULL, 'Primary File Server', 'SN-SRV-001', 'PowerEdge R760', 'srv-file-01', '192.168.10.20', NULL, NULL, NULL, NULL, NULL, 1, '2025-01-10', 8500.00, '2026-07-15', NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2026-01-01 00:00:01', '2026-04-26 22:07:32');
...
INSERT INTO `bookmarks` (`company_id`, `employee_id`, `title`, `url`, `shared`, `active`) VALUES
...
CREATE TRIGGER `trg_system_status_audit_insert` AFTER INSERT ON `system_status` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'system_status', NEW.`id`, 'INSERT', NULL,
...
CREATE TRIGGER `trg_system_status_audit_update` AFTER UPDATE ON `system_status` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'system_status', NEW.`id`, 'UPDATE',
...
CREATE TRIGGER `trg_system_status_audit_delete` AFTER DELETE ON `system_status` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'system_status', OLD.`id`, 'DELETE',
  JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'tab_key', OLD.`tab_key`, 'active', OLD.`active`),
  NULL, @app_ip_address, @app_user_agent);
END$$
DELIMITER ;
