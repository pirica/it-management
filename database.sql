...
INSERT INTO `sidebar_layout` (`company_id`, `entry_type`, `entry_id`, `section_id`, `display_order`, `is_visible`) VALUES
  (1, 'section', 'dashboard', NULL, 0, 1),
  (1, 'section', 'management', NULL, 1, 1),
  (1, 'section', 'employee', NULL, 2, 1),
  (1, 'section', 'admin', NULL, 3, 1),
  (1, 'section', 'reference_data', NULL, 4, 1),
  (1, 'item', 'dashboard_link', 'dashboard', 0, 1),
  (1, 'item', 'settings', 'dashboard', 1, 1),
  (1, 'item', 'equipment', 'management', 0, 1),
  (1, 'item', 'is_workstation', 'management', 1, 1),
  (1, 'item', 'is_server', 'management', 2, 1),
  (1, 'item', 'is_switch', 'management', 3, 1),
  (1, 'item', 'is_printer', 'management', 4, 1),
  (1, 'item', 'is_pos', 'management', 5, 1),
  (1, 'item', 'switch_ports', 'management', 6, 1),
  (1, 'item', 'tickets', 'management', 7, 1),
  (1, 'item', 'is_other', 'management', 8, 1),
  (1, 'item', 'is_port_patch_panel', 'management', 9, 1),
  (1, 'item', 'is_cctv', 'management', 10, 1),
  (1, 'item', 'is_phone', 'management', 11, 1),
  (1, 'item', 'is_access_point', 'management', 12, 1),
  (1, 'item', 'is_firewall', 'management', 13, 1),
  (1, 'item', 'is_router', 'management', 14, 1),
  (1, 'item', 'employees', 'employee', 0, 1),
  (1, 'item', 'employee_system_access', 'employee', 1, 1),
  (1, 'item', 'system_access', 'employee', 2, 1),
  (1, 'item', 'departments', 'employee', 3, 1),
  (1, 'item', 'inventory', 'admin', 0, 1),
  (1, 'item', 'users', 'admin', 1, 1),
  (1, 'item', 'companies', 'admin', 2, 1),
  (1, 'item', 'it_locations', 'reference_data', 0, 1),
  (1, 'item', 'location_types', 'reference_data', 1, 1),
  (1, 'item', 'equipment_types', 'reference_data', 2, 1),
  (1, 'item', 'equipment_statuses', 'reference_data', 3, 1),
  (1, 'item', 'manufacturers', 'reference_data', 4, 1),
  (1, 'item', 'catalogs', 'reference_data', 5, 1),
  (1, 'item', 'suppliers', 'reference_data', 6, 1),
  (1, 'item', 'supplier_statuses', 'reference_data', 7, 1),
  (1, 'item', 'racks', 'reference_data', 8, 1),
  (1, 'item', 'idfs', 'reference_data', 9, 1),
  (1, 'item', 'rack_statuses', 'reference_data', 10, 1),
  (1, 'item', 'switch_status', 'reference_data', 11, 1),
  (1, 'item', 'cable_colors', 'reference_data', 12, 1),
  (1, 'item', 'ticket_categories', 'reference_data', 13, 1),
  (1, 'item', 'ticket_statuses', 'reference_data', 14, 1),
  (1, 'item', 'ticket_priorities', 'reference_data', 15, 1),
  (1, 'item', 'employee_statuses', 'reference_data', 16, 1),
  (1, 'item', 'audit_logs', 'reference_data', 17, 1),
  (1, 'item', 'access_levels', 'reference_data', 18, 1),
  (1, 'item', 'assignment_types', 'reference_data', 19, 1),
  (1, 'item', 'attempts', 'reference_data', 20, 1),
  (1, 'item', 'employee_onboarding_requests', 'reference_data', 21, 1),
  (1, 'item', 'employee_system_access_relations', 'reference_data', 22, 1),
  (1, 'item', 'equipment_environment', 'reference_data', 23, 1),
  (1, 'item', 'equipment_fiber', 'reference_data', 24, 1),
  (1, 'item', 'equipment_fiber_count', 'reference_data', 25, 1),
  (1, 'item', 'equipment_fiber_patch', 'reference_data', 26, 1),
  (1, 'item', 'equipment_fiber_rack', 'reference_data', 27, 1),
  (1, 'item', 'equipment_poe', 'reference_data', 28, 1),
  (1, 'item', 'equipment_rj45', 'reference_data', 29, 1),
  (1, 'item', 'idf_device_type', 'reference_data', 30, 1),
  (1, 'item', 'idf_links', 'reference_data', 31, 1),
  (1, 'item', 'idf_ports', 'reference_data', 32, 1),
  (1, 'item', 'idf_positions', 'reference_data', 33, 1),
  (1, 'item', 'inventory_categories', 'reference_data', 34, 1),
  (1, 'item', 'inventory_items', 'reference_data', 35, 1),
  (1, 'item', 'patches_updates', 'reference_data', 36, 1),
  (1, 'item', 'patches_updates_level', 'reference_data', 37, 1),
  (1, 'item', 'patches_updates_status', 'reference_data', 38, 1),
  (1, 'item', 'printer_device_types', 'reference_data', 39, 1),
  (1, 'item', 'role_assignment_rights', 'reference_data', 40, 1),
  (1, 'item', 'role_hierarchy', 'reference_data', 41, 1),
  (1, 'item', 'role_module_permissions', 'reference_data', 42, 1),
  (1, 'item', 'sidebar_layout', 'reference_data', 43, 1),
  (1, 'item', 'switch_port_numbering_layout', 'reference_data', 44, 1),
  (1, 'item', 'switch_port_types', 'reference_data', 45, 1),
  (1, 'item', 'ui_configuration', 'reference_data', 46, 1),
  (1, 'item', 'user_companies', 'reference_data', 47, 1),
  (1, 'item', 'user_roles', 'reference_data', 48, 1),
  (1, 'item', 'vlans', 'reference_data', 49, 1),
  (1, 'item', 'warranty_types', 'reference_data', 50, 1),
  (1, 'item', 'workstation_device_types', 'reference_data', 51, 1),
  (1, 'item', 'workstation_modes', 'reference_data', 52, 1),
  (1, 'item', 'workstation_office', 'reference_data', 53, 1),
  (1, 'item', 'workstation_os_types', 'reference_data', 54, 1),
  (1, 'item', 'workstation_os_versions', 'reference_data', 55, 1),
  (1, 'item', 'workstation_ram', 'reference_data', 56, 1),
  (1, 'item', 'registration_invitations', 'reference_data', 57, 1),
  (2, 'section', 'dashboard', NULL, 0, 1),
  (2, 'section', 'management', NULL, 1, 1),
  (2, 'section', 'employee', NULL, 2, 1),
  (2, 'section', 'admin', NULL, 3, 1),
  (2, 'section', 'reference_data', NULL, 4, 1),
  (2, 'item', 'dashboard_link', 'dashboard', 0, 1),
  (2, 'item', 'settings', 'dashboard', 1, 1),
  (2, 'item', 'equipment', 'management', 0, 1),
  (2, 'item', 'is_workstation', 'management', 1, 1),
  (2, 'item', 'is_server', 'management', 2, 1),
  (2, 'item', 'is_switch', 'management', 3, 1),
  (2, 'item', 'is_printer', 'management', 4, 1),
  (2, 'item', 'is_pos', 'management', 5, 1),
  (2, 'item', 'switch_ports', 'management', 6, 1),
  (2, 'item', 'tickets', 'management', 7, 1),
  (2, 'item', 'is_other', 'management', 8, 1),
  (2, 'item', 'is_port_patch_panel', 'management', 9, 1),
  (2, 'item', 'is_cctv', 'management', 10, 1),
  (2, 'item', 'is_phone', 'management', 11, 1),
  (2, 'item', 'is_access_point', 'management', 12, 1),
  (2, 'item', 'is_firewall', 'management', 13, 1),
  (2, 'item', 'is_router', 'management', 14, 1),
  (2, 'item', 'employees', 'employee', 0, 1),
  (2, 'item', 'employee_system_access', 'employee', 1, 1),
  (2, 'item', 'system_access', 'employee', 2, 1),
  (2, 'item', 'departments', 'employee', 3, 1),
  (2, 'item', 'inventory', 'admin', 0, 1),
  (2, 'item', 'users', 'admin', 1, 1),
  (2, 'item', 'companies', 'admin', 2, 1),
  (2, 'item', 'it_locations', 'reference_data', 0, 1),
  (2, 'item', 'location_types', 'reference_data', 1, 1),
  (2, 'item', 'equipment_types', 'reference_data', 2, 1),
  (2, 'item', 'equipment_statuses', 'reference_data', 3, 1),
  (2, 'item', 'manufacturers', 'reference_data', 4, 1),
  (2, 'item', 'catalogs', 'reference_data', 5, 1),
  (2, 'item', 'suppliers', 'reference_data', 6, 1),
  (2, 'item', 'supplier_statuses', 'reference_data', 7, 1),
  (2, 'item', 'racks', 'reference_data', 8, 1),
  (2, 'item', 'idfs', 'reference_data', 9, 1),
  (2, 'item', 'rack_statuses', 'reference_data', 10, 1),
  (2, 'item', 'switch_status', 'reference_data', 11, 1),
  (2, 'item', 'cable_colors', 'reference_data', 12, 1),
  (2, 'item', 'ticket_categories', 'reference_data', 13, 1),
  (2, 'item', 'ticket_statuses', 'reference_data', 14, 1),
  (2, 'item', 'ticket_priorities', 'reference_data', 15, 1),
  (2, 'item', 'employee_statuses', 'reference_data', 16, 1),
  (2, 'item', 'audit_logs', 'reference_data', 17, 1),
  (2, 'item', 'access_levels', 'reference_data', 18, 1),
  (2, 'item', 'assignment_types', 'reference_data', 19, 1),
  (2, 'item', 'attempts', 'reference_data', 20, 1),
  (2, 'item', 'employee_onboarding_requests', 'reference_data', 21, 1),
  (2, 'item', 'employee_system_access_relations', 'reference_data', 22, 1),
  (2, 'item', 'equipment_environment', 'reference_data', 23, 1),
  (2, 'item', 'equipment_fiber', 'reference_data', 24, 1),
  (2, 'item', 'equipment_fiber_count', 'reference_data', 25, 1),
  (2, 'item', 'equipment_fiber_patch', 'reference_data', 26, 1),
  (2, 'item', 'equipment_fiber_rack', 'reference_data', 27, 1),
  (2, 'item', 'equipment_poe', 'reference_data', 28, 1),
  (2, 'item', 'equipment_rj45', 'reference_data', 29, 1),
  (2, 'item', 'idf_device_type', 'reference_data', 30, 1),
  (2, 'item', 'idf_links', 'reference_data', 31, 1),
  (2, 'item', 'idf_ports', 'reference_data', 32, 1),
  (2, 'item', 'idf_positions', 'reference_data', 33, 1),
  (2, 'item', 'inventory_categories', 'reference_data', 34, 1),
  (2, 'item', 'inventory_items', 'reference_data', 35, 1),
  (2, 'item', 'patches_updates', 'reference_data', 36, 1),
  (2, 'item', 'patches_updates_level', 'reference_data', 37, 1),
  (2, 'item', 'patches_updates_status', 'reference_data', 38, 1),
  (2, 'item', 'printer_device_types', 'reference_data', 39, 1),
  (2, 'item', 'role_assignment_rights', 'reference_data', 40, 1),
  (2, 'item', 'role_hierarchy', 'reference_data', 41, 1),
  (2, 'item', 'role_module_permissions', 'reference_data', 42, 1),
  (2, 'item', 'sidebar_layout', 'reference_data', 43, 1),
  (2, 'item', 'switch_port_numbering_layout', 'reference_data', 44, 1),
  (2, 'item', 'switch_port_types', 'reference_data', 45, 1),
  (2, 'item', 'ui_configuration', 'reference_data', 46, 1),
  (2, 'item', 'user_companies', 'reference_data', 47, 1),
  (2, 'item', 'user_roles', 'reference_data', 48, 1),
  (2, 'item', 'vlans', 'reference_data', 49, 1),
  (2, 'item', 'warranty_types', 'reference_data', 50, 1),
  (2, 'item', 'workstation_device_types', 'reference_data', 51, 1),
  (2, 'item', 'workstation_modes', 'reference_data', 52, 1),
  (2, 'item', 'workstation_office', 'reference_data', 53, 1),
  (2, 'item', 'workstation_os_types', 'reference_data', 54, 1),
  (2, 'item', 'workstation_os_versions', 'reference_data', 55, 1),
  (2, 'item', 'workstation_ram', 'reference_data', 56, 1),
  (2, 'item', 'registration_invitations', 'reference_data', 57, 1),
  (3, 'section', 'dashboard', NULL, 0, 1),
  (3, 'section', 'management', NULL, 1, 1),
  (3, 'section', 'employee', NULL, 2, 1),
  (3, 'section', 'admin', NULL, 3, 1),
  (3, 'section', 'reference_data', NULL, 4, 1),
  (3, 'item', 'dashboard_link', 'dashboard', 0, 1),
  (3, 'item', 'settings', 'dashboard', 1, 1),
  (3, 'item', 'equipment', 'management', 0, 1),
  (3, 'item', 'is_workstation', 'management', 1, 1),
  (3, 'item', 'is_server', 'management', 2, 1),
  (3, 'item', 'is_switch', 'management', 3, 1),
  (3, 'item', 'is_printer', 'management', 4, 1),
  (3, 'item', 'is_pos', 'management', 5, 1),
  (3, 'item', 'switch_ports', 'management', 6, 1),
  (3, 'item', 'tickets', 'management', 7, 1),
  (3, 'item', 'is_other', 'management', 8, 1),
  (3, 'item', 'is_port_patch_panel', 'management', 9, 1),
  (3, 'item', 'is_cctv', 'management', 10, 1),
  (3, 'item', 'is_phone', 'management', 11, 1),
  (3, 'item', 'is_access_point', 'management', 12, 1),
  (3, 'item', 'is_firewall', 'management', 13, 1),
  (3, 'item', 'is_router', 'management', 14, 1),
  (3, 'item', 'employees', 'employee', 0, 1),
  (3, 'item', 'employee_system_access', 'employee', 1, 1),
  (3, 'item', 'system_access', 'employee', 2, 1),
  (3, 'item', 'departments', 'employee', 3, 1),
  (3, 'item', 'inventory', 'admin', 0, 1),
  (3, 'item', 'users', 'admin', 1, 1),
  (3, 'item', 'companies', 'admin', 2, 1),
  (3, 'item', 'it_locations', 'reference_data', 0, 1),
  (3, 'item', 'location_types', 'reference_data', 1, 1),
  (3, 'item', 'equipment_types', 'reference_data', 2, 1),
  (3, 'item', 'equipment_statuses', 'reference_data', 3, 1),
  (3, 'item', 'manufacturers', 'reference_data', 4, 1),
  (3, 'item', 'catalogs', 'reference_data', 5, 1),
  (3, 'item', 'suppliers', 'reference_data', 6, 1),
  (3, 'item', 'supplier_statuses', 'reference_data', 7, 1),
  (3, 'item', 'racks', 'reference_data', 8, 1),
  (3, 'item', 'idfs', 'reference_data', 9, 1),
  (3, 'item', 'rack_statuses', 'reference_data', 10, 1),
  (3, 'item', 'switch_status', 'reference_data', 11, 1),
  (3, 'item', 'cable_colors', 'reference_data', 12, 1),
  (3, 'item', 'ticket_categories', 'reference_data', 13, 1),
  (3, 'item', 'ticket_statuses', 'reference_data', 14, 1),
  (3, 'item', 'ticket_priorities', 'reference_data', 15, 1),
  (3, 'item', 'employee_statuses', 'reference_data', 16, 1),
  (3, 'item', 'audit_logs', 'reference_data', 17, 1),
  (3, 'item', 'access_levels', 'reference_data', 18, 1),
  (3, 'item', 'assignment_types', 'reference_data', 19, 1),
  (3, 'item', 'attempts', 'reference_data', 20, 1),
  (3, 'item', 'employee_onboarding_requests', 'reference_data', 21, 1),
  (3, 'item', 'employee_system_access_relations', 'reference_data', 22, 1),
  (3, 'item', 'equipment_environment', 'reference_data', 23, 1),
  (3, 'item', 'equipment_fiber', 'reference_data', 24, 1),
  (3, 'item', 'equipment_fiber_count', 'reference_data', 25, 1),
  (3, 'item', 'equipment_fiber_patch', 'reference_data', 26, 1),
  (3, 'item', 'equipment_fiber_rack', 'reference_data', 27, 1),
  (3, 'item', 'equipment_poe', 'reference_data', 28, 1),
  (3, 'item', 'equipment_rj45', 'reference_data', 29, 1),
  (3, 'item', 'idf_device_type', 'reference_data', 30, 1),
  (3, 'item', 'idf_links', 'reference_data', 31, 1),
  (3, 'item', 'idf_ports', 'reference_data', 32, 1),
  (3, 'item', 'idf_positions', 'reference_data', 33, 1),
  (3, 'item', 'inventory_categories', 'reference_data', 34, 1),
  (3, 'item', 'inventory_items', 'reference_data', 35, 1),
  (3, 'item', 'patches_updates', 'reference_data', 36, 1),
  (3, 'item', 'patches_updates_level', 'reference_data', 37, 1),
  (3, 'item', 'patches_updates_status', 'reference_data', 38, 1),
  (3, 'item', 'printer_device_types', 'reference_data', 39, 1),
  (3, 'item', 'role_assignment_rights', 'reference_data', 40, 1),
  (3, 'item', 'role_hierarchy', 'reference_data', 41, 1),
  (3, 'item', 'role_module_permissions', 'reference_data', 42, 1),
  (3, 'item', 'sidebar_layout', 'reference_data', 43, 1),
  (3, 'item', 'switch_port_numbering_layout', 'reference_data', 44, 1),
  (3, 'item', 'switch_port_types', 'reference_data', 45, 1),
  (3, 'item', 'ui_configuration', 'reference_data', 46, 1),
  (3, 'item', 'user_companies', 'reference_data', 47, 1),
  (3, 'item', 'user_roles', 'reference_data', 48, 1),
  (3, 'item', 'vlans', 'reference_data', 49, 1),
  (3, 'item', 'warranty_types', 'reference_data', 50, 1),
  (3, 'item', 'workstation_device_types', 'reference_data', 51, 1),
  (3, 'item', 'workstation_modes', 'reference_data', 52, 1),
  (3, 'item', 'workstation_office', 'reference_data', 53, 1),
  (3, 'item', 'workstation_os_types', 'reference_data', 54, 1),
  (3, 'item', 'workstation_os_versions', 'reference_data', 55, 1),
  (3, 'item', 'workstation_ram', 'reference_data', 56, 1),
  (3, 'item', 'registration_invitations', 'reference_data', 57, 1),
  (4, 'section', 'dashboard', NULL, 0, 1),
  (4, 'section', 'management', NULL, 1, 1),
  (4, 'section', 'employee', NULL, 2, 1),
  (4, 'section', 'admin', NULL, 3, 1),
  (4, 'section', 'reference_data', NULL, 4, 1),
  (4, 'item', 'dashboard_link', 'dashboard', 0, 1),
  (4, 'item', 'settings', 'dashboard', 1, 1),
  (4, 'item', 'equipment', 'management', 0, 1),
  (4, 'item', 'is_workstation', 'management', 1, 1),
  (4, 'item', 'is_server', 'management', 2, 1),
  (4, 'item', 'is_switch', 'management', 3, 1),
  (4, 'item', 'is_printer', 'management', 4, 1),
  (4, 'item', 'is_pos', 'management', 5, 1),
  (4, 'item', 'switch_ports', 'management', 6, 1),
  (4, 'item', 'tickets', 'management', 7, 1),
  (4, 'item', 'is_other', 'management', 8, 1),
  (4, 'item', 'is_port_patch_panel', 'management', 9, 1),
  (4, 'item', 'is_cctv', 'management', 10, 1),
  (4, 'item', 'is_phone', 'management', 11, 1),
  (4, 'item', 'is_access_point', 'management', 12, 1),
  (4, 'item', 'is_firewall', 'management', 13, 1),
  (4, 'item', 'is_router', 'management', 14, 1),
  (4, 'item', 'employees', 'employee', 0, 1),
  (4, 'item', 'employee_system_access', 'employee', 1, 1),
  (4, 'item', 'system_access', 'employee', 2, 1),
  (4, 'item', 'departments', 'employee', 3, 1),
  (4, 'item', 'inventory', 'admin', 0, 1),
  (4, 'item', 'users', 'admin', 1, 1),
  (4, 'item', 'companies', 'admin', 2, 1),
  (4, 'item', 'it_locations', 'reference_data', 0, 1),
  (4, 'item', 'location_types', 'reference_data', 1, 1),
  (4, 'item', 'equipment_types', 'reference_data', 2, 1),
  (4, 'item', 'equipment_statuses', 'reference_data', 3, 1),
  (4, 'item', 'manufacturers', 'reference_data', 4, 1),
  (4, 'item', 'catalogs', 'reference_data', 5, 1),
  (4, 'item', 'suppliers', 'reference_data', 6, 1),
  (4, 'item', 'supplier_statuses', 'reference_data', 7, 1),
  (4, 'item', 'racks', 'reference_data', 8, 1),
  (4, 'item', 'idfs', 'reference_data', 9, 1),
  (4, 'item', 'rack_statuses', 'reference_data', 10, 1),
  (4, 'item', 'switch_status', 'reference_data', 11, 1),
  (4, 'item', 'cable_colors', 'reference_data', 12, 1),
  (4, 'item', 'ticket_categories', 'reference_data', 13, 1),
  (4, 'item', 'ticket_statuses', 'reference_data', 14, 1),
  (4, 'item', 'ticket_priorities', 'reference_data', 15, 1),
  (4, 'item', 'employee_statuses', 'reference_data', 16, 1),
  (4, 'item', 'audit_logs', 'reference_data', 17, 1),
  (4, 'item', 'access_levels', 'reference_data', 18, 1),
  (4, 'item', 'assignment_types', 'reference_data', 19, 1),
  (4, 'item', 'attempts', 'reference_data', 20, 1),
  (4, 'item', 'employee_onboarding_requests', 'reference_data', 21, 1),
  (4, 'item', 'employee_system_access_relations', 'reference_data', 22, 1),
  (4, 'item', 'equipment_environment', 'reference_data', 23, 1),
  (4, 'item', 'equipment_fiber', 'reference_data', 24, 1),
  (4, 'item', 'equipment_fiber_count', 'reference_data', 25, 1),
  (4, 'item', 'equipment_fiber_patch', 'reference_data', 26, 1),
  (4, 'item', 'equipment_fiber_rack', 'reference_data', 27, 1),
  (4, 'item', 'equipment_poe', 'reference_data', 28, 1),
  (4, 'item', 'equipment_rj45', 'reference_data', 29, 1),
  (4, 'item', 'idf_device_type', 'reference_data', 30, 1),
  (4, 'item', 'idf_links', 'reference_data', 31, 1),
  (4, 'item', 'idf_ports', 'reference_data', 32, 1),
  (4, 'item', 'idf_positions', 'reference_data', 33, 1),
  (4, 'item', 'inventory_categories', 'reference_data', 34, 1),
  (4, 'item', 'inventory_items', 'reference_data', 35, 1),
  (4, 'item', 'patches_updates', 'reference_data', 36, 1),
  (4, 'item', 'patches_updates_level', 'reference_data', 37, 1),
  (4, 'item', 'patches_updates_status', 'reference_data', 38, 1),
  (4, 'item', 'printer_device_types', 'reference_data', 39, 1),
  (4, 'item', 'role_assignment_rights', 'reference_data', 40, 1),
  (4, 'item', 'role_hierarchy', 'reference_data', 41, 1),
  (4, 'item', 'role_module_permissions', 'reference_data', 42, 1),
  (4, 'item', 'sidebar_layout', 'reference_data', 43, 1),
  (4, 'item', 'switch_port_numbering_layout', 'reference_data', 44, 1),
  (4, 'item', 'switch_port_types', 'reference_data', 45, 1),
  (4, 'item', 'ui_configuration', 'reference_data', 46, 1),
  (4, 'item', 'user_companies', 'reference_data', 47, 1),
  (4, 'item', 'user_roles', 'reference_data', 48, 1),
  (4, 'item', 'vlans', 'reference_data', 49, 1),
  (4, 'item', 'warranty_types', 'reference_data', 50, 1),
  (4, 'item', 'workstation_device_types', 'reference_data', 51, 1),
  (4, 'item', 'workstation_modes', 'reference_data', 52, 1),
  (4, 'item', 'workstation_office', 'reference_data', 53, 1),
  (4, 'item', 'workstation_os_types', 'reference_data', 54, 1),
  (4, 'item', 'workstation_os_versions', 'reference_data', 55, 1),
  (4, 'item', 'workstation_ram', 'reference_data', 56, 1),
  (4, 'item', 'registration_invitations', 'reference_data', 57, 1),
  (5, 'section', 'dashboard', NULL, 0, 1),
  (5, 'section', 'management', NULL, 1, 1),
  (5, 'section', 'employee', NULL, 2, 1),
  (5, 'section', 'admin', NULL, 3, 1),
  (5, 'section', 'reference_data', NULL, 4, 1),
  (5, 'item', 'dashboard_link', 'dashboard', 0, 1),
  (5, 'item', 'settings', 'dashboard', 1, 1),
  (5, 'item', 'equipment', 'management', 0, 1),
  (5, 'item', 'is_workstation', 'management', 1, 1),
  (5, 'item', 'is_server', 'management', 2, 1),
  (5, 'item', 'is_switch', 'management', 3, 1),
  (5, 'item', 'is_printer', 'management', 4, 1),
  (5, 'item', 'is_pos', 'management', 5, 1),
  (5, 'item', 'switch_ports', 'management', 6, 1),
  (5, 'item', 'tickets', 'management', 7, 1),
  (5, 'item', 'is_other', 'management', 8, 1),
  (5, 'item', 'is_port_patch_panel', 'management', 9, 1),
  (5, 'item', 'is_cctv', 'management', 10, 1),
  (5, 'item', 'is_phone', 'management', 11, 1),
  (5, 'item', 'is_access_point', 'management', 12, 1),
  (5, 'item', 'is_firewall', 'management', 13, 1),
  (5, 'item', 'is_router', 'management', 14, 1),
  (5, 'item', 'employees', 'employee', 0, 1),
  (5, 'item', 'employee_system_access', 'employee', 1, 1),
  (5, 'item', 'system_access', 'employee', 2, 1),
  (5, 'item', 'departments', 'employee', 3, 1),
  (5, 'item', 'inventory', 'admin', 0, 1),
  (5, 'item', 'users', 'admin', 1, 1),
  (5, 'item', 'companies', 'admin', 2, 1),
  (5, 'item', 'it_locations', 'reference_data', 0, 1),
  (5, 'item', 'location_types', 'reference_data', 1, 1),
  (5, 'item', 'equipment_types', 'reference_data', 2, 1),
  (5, 'item', 'equipment_statuses', 'reference_data', 3, 1),
  (5, 'item', 'manufacturers', 'reference_data', 4, 1),
  (5, 'item', 'catalogs', 'reference_data', 5, 1),
  (5, 'item', 'suppliers', 'reference_data', 6, 1),
  (5, 'item', 'supplier_statuses', 'reference_data', 7, 1),
  (5, 'item', 'racks', 'reference_data', 8, 1),
  (5, 'item', 'idfs', 'reference_data', 9, 1),
  (5, 'item', 'rack_statuses', 'reference_data', 10, 1),
  (5, 'item', 'switch_status', 'reference_data', 11, 1),
  (5, 'item', 'cable_colors', 'reference_data', 12, 1),
  (5, 'item', 'ticket_categories', 'reference_data', 13, 1),
  (5, 'item', 'ticket_statuses', 'reference_data', 14, 1),
  (5, 'item', 'ticket_priorities', 'reference_data', 15, 1),
  (5, 'item', 'employee_statuses', 'reference_data', 16, 1),
  (5, 'item', 'audit_logs', 'reference_data', 17, 1),
  (5, 'item', 'access_levels', 'reference_data', 18, 1),
  (5, 'item', 'assignment_types', 'reference_data', 19, 1),
  (5, 'item', 'attempts', 'reference_data', 20, 1),
  (5, 'item', 'employee_onboarding_requests', 'reference_data', 21, 1),
  (5, 'item', 'employee_system_access_relations', 'reference_data', 22, 1),
  (5, 'item', 'equipment_environment', 'reference_data', 23, 1),
  (5, 'item', 'equipment_fiber', 'reference_data', 24, 1),
  (5, 'item', 'equipment_fiber_count', 'reference_data', 25, 1),
  (5, 'item', 'equipment_fiber_patch', 'reference_data', 26, 1),
  (5, 'item', 'equipment_fiber_rack', 'reference_data', 27, 1),
  (5, 'item', 'equipment_poe', 'reference_data', 28, 1),
  (5, 'item', 'equipment_rj45', 'reference_data', 29, 1),
  (5, 'item', 'idf_device_type', 'reference_data', 30, 1),
  (5, 'item', 'idf_links', 'reference_data', 31, 1),
  (5, 'item', 'idf_ports', 'reference_data', 32, 1),
  (5, 'item', 'idf_positions', 'reference_data', 33, 1),
  (5, 'item', 'inventory_categories', 'reference_data', 34, 1),
  (5, 'item', 'inventory_items', 'reference_data', 35, 1),
  (5, 'item', 'patches_updates', 'reference_data', 36, 1),
  (5, 'item', 'patches_updates_level', 'reference_data', 37, 1),
  (5, 'item', 'patches_updates_status', 'reference_data', 38, 1),
  (5, 'item', 'printer_device_types', 'reference_data', 39, 1),
  (5, 'item', 'role_assignment_rights', 'reference_data', 40, 1),
  (5, 'item', 'role_hierarchy', 'reference_data', 41, 1),
  (5, 'item', 'role_module_permissions', 'reference_data', 42, 1),
  (5, 'item', 'sidebar_layout', 'reference_data', 43, 1),
  (5, 'item', 'switch_port_numbering_layout', 'reference_data', 44, 1),
  (5, 'item', 'switch_port_types', 'reference_data', 45, 1),
  (5, 'item', 'ui_configuration', 'reference_data', 46, 1),
  (5, 'item', 'user_companies', 'reference_data', 47, 1),
  (5, 'item', 'user_roles', 'reference_data', 48, 1),
  (5, 'item', 'vlans', 'reference_data', 49, 1),
  (5, 'item', 'warranty_types', 'reference_data', 50, 1),
  (5, 'item', 'workstation_device_types', 'reference_data', 51, 1),
  (5, 'item', 'workstation_modes', 'reference_data', 52, 1),
  (5, 'item', 'workstation_office', 'reference_data', 53, 1),
  (5, 'item', 'workstation_os_types', 'reference_data', 54, 1),
  (5, 'item', 'workstation_os_versions', 'reference_data', 55, 1),
  (5, 'item', 'workstation_ram', 'reference_data', 56, 1),
  (5, 'item', 'registration_invitations', 'reference_data', 57, 1);
...
(1, 1, 1, 'left', 'left', 'left', 'left', 1, 1, '25', '⚙️ IT Controls', '', '{"is_access_point":1,"is_cctv":1,"is_firewall":1,"is_other":1,"is_phone":1,"is_port_patch_panel":1,"is_pos":1,"is_printer":1,"is_router":1,"is_server":1,"is_switch":1,"is_workstation":1}', '2026-03-28 19:44:25', '2026-04-13 17:01:07'),
(2, 2, 1, 'left', 'left', 'left', 'left', 1, 1, '25', '⚙️ IT Controls', '', '{"is_access_point":1,"is_cctv":1,"is_firewall":1,"is_other":1,"is_phone":1,"is_port_patch_panel":1,"is_pos":1,"is_printer":1,"is_router":1,"is_server":1,"is_switch":1,"is_workstation":1}', '2026-03-28 19:44:25', '2026-04-13 17:01:07'),
(3, 3, 1, 'left', 'left', 'left', 'left', 1, 1, '25', '⚙️ IT Controls', '', '{"is_access_point":1,"is_cctv":1,"is_firewall":1,"is_other":1,"is_phone":1,"is_port_patch_panel":1,"is_pos":1,"is_printer":1,"is_router":1,"is_server":1,"is_switch":1,"is_workstation":1}', '2026-03-28 19:44:25', '2026-04-13 17:01:07'),
(4, 4, 1, 'left', 'left', 'left', 'left', 1, 1, '25', '⚙️ IT Controls', '', '{"is_access_point":1,"is_cctv":1,"is_firewall":1,"is_other":1,"is_phone":1,"is_port_patch_panel":1,"is_pos":1,"is_printer":1,"is_router":1,"is_server":1,"is_switch":1,"is_workstation":1}', '2026-03-28 19:44:25', '2026-04-13 17:01:07'),
(5, 5, 1, 'left', 'left', 'left', 'left', 1, 1, '25', '⚙️ IT Controls', '', '{"is_access_point":1,"is_cctv":1,"is_firewall":1,"is_other":1,"is_phone":1,"is_port_patch_panel":1,"is_pos":1,"is_printer":1,"is_router":1,"is_server":1,"is_switch":1,"is_workstation":1}', '2026-03-28 19:44:25', '2026-04-13 17:01:07');
