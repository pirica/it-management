...
-- Data for `equipment`
INSERT INTO `equipment` (`id`, `company_id`, `equipment_type_id`, `manufacturer_id`, `location_id`, `rack_id`, `idf_id`, `name`, `serial_number`, `model`, `hostname`, `ip_address`, `patch_port`, `mac_address`, `department_id`, `supplier_id`, `assigned_to_employee_id`, `status_id`, `purchase_date`, `purchase_cost`, `warranty_expiry`, `certificate_expiry`, `warranty_type_id`, `printer_device_type_id`, `printer_color_capable`, `printer_scan`, `workstation_device_type_id`, `workstation_os_type_id`, `workstation_processor`, `workstation_storage`, `workstation_os_installed_on`, `workstation_ram_id`, `workstation_os_version_id`, `switch_rj45_id`, `switch_port_numbering_layout_id`, `switch_fiber_id`, `switch_fiber_patch_id`, `switch_fiber_rack_id`, `switch_fiber_ports_number`, `switch_fiber_port_label`, `switch_poe_id`, `switch_environment_id`, `notes`, `photo_filename`, `created_at`, `updated_at`) VALUES (1, 1, 1, NULL, 1, NULL, NULL, 'Primary File Server', 'SN-SRV-001', 'PowerEdge R760', 'srv-file-01', '192.168.10.20', NULL, NULL, 1, NULL, NULL, 1, '2026-06-05', 8500.00, '2026-07-15', NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-01 00:00:01', '2026-04-26 22:07:32');
...
CREATE TABLE `bookmark_folders` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_bookmark_folders_company_scope` (`company_id`, `name`),
  KEY `company_id` (`company_id`),
  KEY `employee_id` (`employee_id`),
  KEY `parent_folder_id` (`parent_folder_id`),
...
-- Backfill of missing audit triggers (15 triggers for 5 tables)
-- Why: scripts/check_audit_logs_coverage.php reported these tables lacked trg_*_audit_insert in database.sql
-- Tables: bookmark_folders, bookmarks, password_entries, password_folders, private_contacts

DROP TRIGGER IF EXISTS `trg_bookmark_folders_audit_insert`$$
CREATE TRIGGER `trg_bookmark_folders_audit_insert` AFTER INSERT ON `bookmark_folders` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'bookmark_folders', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'employee_id', NEW.`employee_id`, 'parent_folder_id', NEW.`parent_folder_id`, 'name', NEW.`name`, 'position', NEW.`position`, 'shared', NEW.`shared`, 'active', NEW.`active`, 'created_at', NEW.`created_at`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$
DROP TRIGGER IF EXISTS `trg_bookmark_folders_audit_update`$$
CREATE TRIGGER `trg_bookmark_folders_audit_update` AFTER UPDATE ON `bookmark_folders` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'bookmark_folders', COALESCE(NEW.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'employee_id', OLD.`employee_id`, 'parent_folder_id', OLD.`parent_folder_id`, 'name', OLD.`name`, 'position', OLD.`position`, 'shared', OLD.`shared`, 'active', OLD.`active`, 'created_at', OLD.`created_at`, 'updated_at', OLD.`updated_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'employee_id', NEW.`employee_id`, 'parent_folder_id', NEW.`parent_folder_id`, 'name', NEW.`name`, 'position', NEW.`position`, 'shared', NEW.`shared`, 'active', NEW.`active`, 'created_at', NEW.`created_at`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$
DROP TRIGGER IF EXISTS `trg_bookmark_folders_audit_delete`$$
CREATE TRIGGER `trg_bookmark_folders_audit_delete` AFTER DELETE ON `bookmark_folders` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'bookmark_folders', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'employee_id', OLD.`employee_id`, 'parent_folder_id', OLD.`parent_folder_id`, 'name', OLD.`name`, 'position', OLD.`position`, 'shared', OLD.`shared`, 'active', OLD.`active`, 'created_at', OLD.`created_at`, 'updated_at', OLD.`updated_at`), NULL, @app_ip_address, @app_user_agent);
END$$
DROP TRIGGER IF EXISTS `trg_bookmarks_audit_insert`$$
CREATE TRIGGER `trg_bookmarks_audit_insert` AFTER INSERT ON `bookmarks` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'bookmarks', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'employee_id', NEW.`employee_id`, 'folder_id', NEW.`folder_id`, 'title', NEW.`title`, 'url', NEW.`url`, 'notes', NEW.`notes`, 'position', NEW.`position`, 'shared', NEW.`shared`, 'active', NEW.`active`, 'created_at', NEW.`created_at`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$
DROP TRIGGER IF EXISTS `trg_bookmarks_audit_update`$$
CREATE TRIGGER `trg_bookmarks_audit_update` AFTER UPDATE ON `bookmarks` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'bookmarks', COALESCE(NEW.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'employee_id', OLD.`employee_id`, 'folder_id', OLD.`folder_id`, 'title', OLD.`title`, 'url', OLD.`url`, 'notes', OLD.`notes`, 'position', OLD.`position`, 'shared', OLD.`shared`, 'active', OLD.`active`, 'created_at', OLD.`created_at`, 'updated_at', OLD.`updated_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'employee_id', NEW.`employee_id`, 'folder_id', NEW.`folder_id`, 'title', NEW.`title`, 'url', NEW.`url`, 'notes', NEW.`notes`, 'position', NEW.`position`, 'shared', NEW.`shared`, 'active', NEW.`active`, 'created_at', NEW.`created_at`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$
DROP TRIGGER IF EXISTS `trg_bookmarks_audit_delete`$$
CREATE TRIGGER `trg_bookmarks_audit_delete` AFTER DELETE ON `bookmarks` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'bookmarks', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'employee_id', OLD.`employee_id`, 'folder_id', OLD.`folder_id`, 'title', OLD.`title`, 'url', OLD.`url`, 'notes', OLD.`notes`, 'position', OLD.`position`, 'shared', OLD.`shared`, 'active', OLD.`active`, 'created_at', OLD.`created_at`, 'updated_at', OLD.`updated_at`), NULL, @app_ip_address, @app_user_agent);
END$$
DROP TRIGGER IF EXISTS `trg_password_entries_audit_insert`$$
CREATE TRIGGER `trg_password_entries_audit_insert` AFTER INSERT ON `password_entries` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'password_entries', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'employee_id', NEW.`employee_id`, 'folder_id', NEW.`folder_id`, 'account', NEW.`account`, 'login_name', NEW.`login_name`, 'password', NEW.`password`, 'website', NEW.`website`, 'comments', NEW.`comments`, 'active', NEW.`active`, 'created_at', NEW.`created_at`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$
DROP TRIGGER IF EXISTS `trg_password_entries_audit_update`$$
CREATE TRIGGER `trg_password_entries_audit_update` AFTER UPDATE ON `password_entries` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'password_entries', COALESCE(NEW.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'employee_id', OLD.`employee_id`, 'folder_id', OLD.`folder_id`, 'account', OLD.`account`, 'login_name', OLD.`login_name`, 'password', OLD.`password`, 'website', OLD.`website`, 'comments', OLD.`comments`, 'active', OLD.`active`, 'created_at', OLD.`created_at`, 'updated_at', OLD.`updated_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'employee_id', NEW.`employee_id`, 'folder_id', NEW.`folder_id`, 'account', NEW.`account`, 'login_name', NEW.`login_name`, 'password', NEW.`password`, 'website', NEW.`website`, 'comments', NEW.`comments`, 'active', NEW.`active`, 'created_at', NEW.`created_at`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$
DROP TRIGGER IF EXISTS `trg_password_entries_audit_delete`$$
CREATE TRIGGER `trg_password_entries_audit_delete` AFTER DELETE ON `password_entries` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'password_entries', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'employee_id', OLD.`employee_id`, 'folder_id', OLD.`folder_id`, 'account', OLD.`account`, 'login_name', OLD.`login_name`, 'password', OLD.`password`, 'website', OLD.`website`, 'comments', OLD.`comments`, 'active', OLD.`active`, 'created_at', OLD.`created_at`, 'updated_at', OLD.`updated_at`), NULL, @app_ip_address, @app_user_agent);
END$$
DROP TRIGGER IF EXISTS `trg_password_folders_audit_insert`$$
CREATE TRIGGER `trg_password_folders_audit_insert` AFTER INSERT ON `password_folders` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'password_folders', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'employee_id', NEW.`employee_id`, 'parent_id', NEW.`parent_id`, 'name', NEW.`name`, 'active', NEW.`active`, 'created_at', NEW.`created_at`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$
DROP TRIGGER IF EXISTS `trg_password_folders_audit_update`$$
CREATE TRIGGER `trg_password_folders_audit_update` AFTER UPDATE ON `password_folders` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'password_folders', COALESCE(NEW.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'employee_id', OLD.`employee_id`, 'parent_id', OLD.`parent_id`, 'name', OLD.`name`, 'active', OLD.`active`, 'created_at', OLD.`created_at`, 'updated_at', OLD.`updated_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'employee_id', NEW.`employee_id`, 'parent_id', NEW.`parent_id`, 'name', NEW.`name`, 'active', NEW.`active`, 'created_at', NEW.`created_at`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$
DROP TRIGGER IF EXISTS `trg_password_folders_audit_delete`$$
CREATE TRIGGER `trg_password_folders_audit_delete` AFTER DELETE ON `password_folders` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'password_folders', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'employee_id', OLD.`employee_id`, 'parent_id', OLD.`parent_id`, 'name', OLD.`name`, 'active', OLD.`active`, 'created_at', OLD.`created_at`, 'updated_at', OLD.`updated_at`), NULL, @app_ip_address, @app_user_agent);
END$$
DROP TRIGGER IF EXISTS `trg_private_contacts_audit_insert`$$
CREATE TRIGGER `trg_private_contacts_audit_insert` AFTER INSERT ON `private_contacts` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'private_contacts', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'employee_id', NEW.`employee_id`, 'name_prefix', NEW.`name_prefix`, 'first_name', NEW.`first_name`, 'middle_name', NEW.`middle_name`, 'last_name', NEW.`last_name`, 'name_suffix', NEW.`name_suffix`, 'phonetic_first_name', NEW.`phonetic_first_name`, 'phonetic_middle_name', NEW.`phonetic_middle_name`, 'phonetic_last_name', NEW.`phonetic_last_name`, 'nickname', NEW.`nickname`, 'file_as', NEW.`file_as`, 'email1_label', NEW.`email1_label`, 'email1_value', NEW.`email1_value`, 'phone1_label', NEW.`phone1_label`, 'phone1_value', NEW.`phone1_value`, 'address1_label', NEW.`address1_label`, 'address1_country', NEW.`address1_country`, 'address1_street', NEW.`address1_street`, 'address1_extended', NEW.`address1_extended`, 'address1_city', NEW.`address1_city`, 'address1_region', NEW.`address1_region`, 'address1_postcode', NEW.`address1_postcode`, 'address1_po_box', NEW.`address1_po_box`, 'organization_name', NEW.`organization_name`, 'organization_title', NEW.`organization_title`, 'organization_department', NEW.`organization_department`, 'birthday', NEW.`birthday`, 'event1_label', NEW.`event1_label`, 'event1_value', NEW.`event1_value`, 'relation1_label', NEW.`relation1_label`, 'relation1_value', NEW.`relation1_value`, 'website1_label', NEW.`website1_label`, 'website1_value', NEW.`website1_value`, 'custom_field1_label', NEW.`custom_field1_label`, 'custom_field1_value', NEW.`custom_field1_value`, 'notes', NEW.`notes`, 'labels', NEW.`labels`, 'photo', NEW.`photo`, 'is_favorite', NEW.`is_favorite`, 'active', NEW.`active`, 'created_at', NEW.`created_at`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$
DROP TRIGGER IF EXISTS `trg_private_contacts_audit_update`$$
CREATE TRIGGER `trg_private_contacts_audit_update` AFTER UPDATE ON `private_contacts` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'private_contacts', COALESCE(NEW.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'employee_id', OLD.`employee_id`, 'name_prefix', OLD.`name_prefix`, 'first_name', OLD.`first_name`, 'middle_name', OLD.`middle_name`, 'last_name', OLD.`last_name`, 'name_suffix', OLD.`name_suffix`, 'phonetic_first_name', OLD.`phonetic_first_name`, 'phonetic_middle_name', OLD.`phonetic_middle_name`, 'phonetic_last_name', OLD.`phonetic_last_name`, 'nickname', OLD.`nickname`, 'file_as', OLD.`file_as`, 'email1_label', OLD.`email1_label`, 'email1_value', OLD.`email1_value`, 'phone1_label', OLD.`phone1_label`, 'phone1_value', OLD.`phone1_value`, 'address1_label', OLD.`address1_label`, 'address1_country', OLD.`address1_country`, 'address1_street', OLD.`address1_street`, 'address1_extended', OLD.`address1_extended`, 'address1_city', OLD.`address1_city`, 'address1_region', OLD.`address1_region`, 'address1_postcode', OLD.`address1_postcode`, 'address1_po_box', OLD.`address1_po_box`, 'organization_name', OLD.`organization_name`, 'organization_title', OLD.`organization_title`, 'organization_department', OLD.`organization_department`, 'birthday', OLD.`birthday`, 'event1_label', OLD.`event1_label`, 'event1_value', OLD.`event1_value`, 'relation1_label', OLD.`relation1_label`, 'relation1_value', OLD.`relation1_value`, 'website1_label', OLD.`website1_label`, 'website1_value', OLD.`website1_value`, 'custom_field1_label', OLD.`custom_field1_label`, 'custom_field1_value', OLD.`custom_field1_value`, 'notes', OLD.`notes`, 'labels', OLD.`labels`, 'photo', OLD.`photo`, 'is_favorite', OLD.`is_favorite`, 'active', OLD.`active`, 'created_at', OLD.`created_at`, 'updated_at', OLD.`updated_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'employee_id', NEW.`employee_id`, 'name_prefix', NEW.`name_prefix`, 'first_name', NEW.`first_name`, 'middle_name', NEW.`middle_name`, 'last_name', NEW.`last_name`, 'name_suffix', NEW.`name_suffix`, 'phonetic_first_name', NEW.`phonetic_first_name`, 'phonetic_middle_name', NEW.`phonetic_middle_name`, 'phonetic_last_name', NEW.`phonetic_last_name`, 'nickname', NEW.`nickname`, 'file_as', NEW.`file_as`, 'email1_label', NEW.`email1_label`, 'email1_value', NEW.`email1_value`, 'phone1_label', NEW.`phone1_label`, 'phone1_value', NEW.`phone1_value`, 'address1_label', NEW.`address1_label`, 'address1_country', NEW.`address1_country`, 'address1_street', NEW.`address1_street`, 'address1_extended', NEW.`address1_extended`, 'address1_city', NEW.`address1_city`, 'address1_region', NEW.`address1_region`, 'address1_postcode', NEW.`address1_postcode`, 'address1_po_box', NEW.`address1_po_box`, 'organization_name', NEW.`organization_name`, 'organization_title', NEW.`organization_title`, 'organization_department', NEW.`organization_department`, 'birthday', NEW.`birthday`, 'event1_label', NEW.`event1_label`, 'event1_value', NEW.`event1_value`, 'relation1_label', NEW.`relation1_label`, 'relation1_value', NEW.`relation1_value`, 'website1_label', NEW.`website1_label`, 'website1_value', NEW.`website1_value`, 'custom_field1_label', NEW.`custom_field1_label`, 'custom_field1_value', NEW.`custom_field1_value`, 'notes', NEW.`notes`, 'labels', NEW.`labels`, 'photo', NEW.`photo`, 'is_favorite', NEW.`is_favorite`, 'active', NEW.`active`, 'created_at', NEW.`created_at`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$
DROP TRIGGER IF EXISTS `trg_private_contacts_audit_delete`$$
CREATE TRIGGER `trg_private_contacts_audit_delete` AFTER DELETE ON `private_contacts` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'private_contacts', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'employee_id', OLD.`employee_id`, 'name_prefix', OLD.`name_prefix`, 'first_name', OLD.`first_name`, 'middle_name', OLD.`middle_name`, 'last_name', OLD.`last_name`, 'name_suffix', OLD.`name_suffix`, 'phonetic_first_name', OLD.`phonetic_first_name`, 'phonetic_middle_name', OLD.`phonetic_middle_name`, 'phonetic_last_name', OLD.`phonetic_last_name`, 'nickname', OLD.`nickname`, 'file_as', OLD.`file_as`, 'email1_label', OLD.`email1_label`, 'email1_value', OLD.`email1_value`, 'phone1_label', OLD.`phone1_label`, 'phone1_value', OLD.`phone1_value`, 'address1_label', OLD.`address1_label`, 'address1_country', OLD.`address1_country`, 'address1_street', OLD.`address1_street`, 'address1_extended', OLD.`address1_extended`, 'address1_city', OLD.`address1_city`, 'address1_region', OLD.`address1_region`, 'address1_postcode', OLD.`address1_postcode`, 'address1_po_box', OLD.`address1_po_box`, 'organization_name', OLD.`organization_name`, 'organization_title', OLD.`organization_title`, 'organization_department', OLD.`organization_department`, 'birthday', OLD.`birthday`, 'event1_label', OLD.`event1_label`, 'event1_value', OLD.`event1_value`, 'relation1_label', OLD.`relation1_label`, 'relation1_value', OLD.`relation1_value`, 'website1_label', OLD.`website1_label`, 'website1_value', OLD.`website1_value`, 'custom_field1_label', OLD.`custom_field1_label`, 'custom_field1_value', OLD.`custom_field1_value`, 'notes', OLD.`notes`, 'labels', OLD.`labels`, 'photo', OLD.`photo`, 'is_favorite', OLD.`is_favorite`, 'active', OLD.`active`, 'created_at', OLD.`created_at`, 'updated_at', OLD.`updated_at`), NULL, @app_ip_address, @app_user_agent);
END$$
