...
## 1. Module Purpose
A filtered view of the Equipment module specifically for Firewall devices.
...
- **Filter**: Strictly filters equipment where `equipment_type_name = 'Firewall'`.
...
Provides a specialized view for Firewall asset management.
