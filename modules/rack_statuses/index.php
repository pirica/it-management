<?php
$crud_table = 'rack_statuses';
$crud_title = 'Rack Statuses';
$crud_action = 'index';
?>
<?php
...
if ($crud_action === 'delete') {
    ...
    itm_require_crud_role_module_permission($conn, 'delete', 'rack_statuses');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && in_array($crud_action, ['create', 'edit'], true)) {
    ...
    itm_require_crud_role_module_permission($conn, $crud_action, 'rack_statuses');
    cr_require_valid_csrf_token();
    $sqlValues = [];
