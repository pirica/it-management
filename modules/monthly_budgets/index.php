...
itm_crud_record_share_handle_ajax_request($conn, 'monthly_budgets');
...
function cr_fk_metadata($conn, $table) {
    ...
    foreach (['name', 'title', 'username', 'account_name', 'account_code', 'code', 'description', 'email', 'mode_name', 'year'] as $candidate) {
            ...
            <?php elseif ($crud_action === 'view'): ?>
                ...
                <div class="card">
                    ...
                    <p style="margin-top:16px;">
                        <?php echo itm_crud_record_share_render_action_buttons('monthly_budgets', (int)($data['id'] ?? 0), 'monthly budget'); ?>
