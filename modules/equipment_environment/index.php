...
/**
 * Equipment Environment Module - Index
 * 
 * Main list view for equipment statuses. Users can view, create, edit, and delete
 * records defined for the company.
 */

$crud_table = $crud_table ?? 'equipment_environment';
$crud_title = $crud_title ?? 'Equipment Environment';
...
if ($crud_action === 'delete') {
    ...
    itm_require_crud_role_module_permission($conn, 'delete', 'equipment_environment');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && in_array($crud_action, ['create', 'edit'], true)) {
    ...
    itm_require_crud_role_module_permission($conn, $crud_action, 'equipment_environment');
    cr_require_valid_csrf_token();
