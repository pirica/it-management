...
/**
 * Positions Titles Module - Index
 * 
 * Main list view for employee statuses. Users can view, create, edit, and delete
 * records defined for the company.
 */

$crud_table = $crud_table ?? 'employee_positions';
$crud_title = $crud_title ?? 'Positions Titles';
...
if (itm_handle_json_table_import($conn, $crud_table, (int)$company_id)) {
    exit;
}
...
if ($crud_action === 'delete') {
    ...
    itm_require_crud_role_module_permission($conn, 'delete', 'employee_positions');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && in_array($crud_action, ['create', 'edit'], true)) {
    ...
    itm_require_crud_role_module_permission($conn, $crud_action, 'employee_positions');
    cr_require_valid_csrf_token();
                            ...
                            <tr>
                                ...
                                <?php foreach ($uiColumns as $col): $f = $col['Field']; ?>
                                    <td>
                                        ...
                                        <?php elseif ($f === 'department_id'): ?>
                                            <?php echo sanitize($row['department_name'] ?? ''); ?>
                                        <?php else: ?>
                    ...
                    <table>
                        ...
                        <?php foreach ($uiColumns as $col): $f = $col['Field']; ?>
                            <tr>
                                ...
                                <td>
                                    <?php if ($f === 'department_id'): ?>
                                        <?php echo sanitize($data['department_name'] ?? ''); ?>
                                    <?php else: ?>
