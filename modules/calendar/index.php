                ...
                <div class="calendar-main">
                    <div class="calendar-header">
                        ...
                        <div class="calendar-view-selector">
                            <a href="?view=day&date=<?php echo $current_date_param; ?>" class="itm-plain-link <?php echo $view === 'day' ? 'active' : ''; ?>">Day</a>
                            <a href="?view=week&date=<?php echo $current_date_param; ?>" class="itm-plain-link <?php echo $view === 'week' ? 'active' : ''; ?>">Week</a>
                            <a href="?view=month&date=<?php echo $current_date_param; ?>" class="itm-plain-link <?php echo $view === 'month' ? 'active' : ''; ?>">Month</a>
                            <a href="?view=year&date=<?php echo $current_date_param; ?>" class="itm-plain-link <?php echo $view === 'year' ? 'active' : ''; ?>">Year</a>
                        </div>
