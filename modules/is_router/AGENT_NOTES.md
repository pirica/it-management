...
## 1. Module Purpose
A filtered view of the Equipment module specifically for Router devices.
...
- **Filter**: Strictly filters equipment where `equipment_type_name = 'Router'`.
...
Provides a specialized view for Router asset management.
