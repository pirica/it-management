<?php
$crud_table = 'hotel_booking_housekeeping_statuses';
$crud_title = 'HSK Statuses';
$crud_action = 'create';
?>
<?php
require '../../config/config.php';
itm_require_crud_role_module_permission($conn, 'create', 'hotel_booking_housekeeping_statuses');
