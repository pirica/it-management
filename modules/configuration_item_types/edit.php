<?php
$crud_table = 'configuration_item_types';
$crud_title = 'Configuration Item Types';
$crud_action = 'edit';
?>
<?php
require '../../config/config.php';
itm_require_crud_role_module_permission($conn, 'edit', 'configuration_item_types');
