...
/**
 * Employee Notifications Module - Index
 * 
...
itm_crud_record_share_handle_ajax_request($conn, 'employee_notifications');
...
if ($field === 'active') {
    ...
    if (($GLOBALS['crud_table'] ?? '') === 'employee_notifications' && $field === 'is_read') {
        return ((int)$value === 1) ? '✅' : '❌';
    }
