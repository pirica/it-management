...
- Lists: **From** and **To** on every folder tab; **CC** on Inbox, Sent, and Archived. Pagination (emoji controls), filters (status, starred/archived on inbox, date range, search).
