...
/**
 * Warranty Types Management - Main Entry Point
 * 
...
if ($crud_action === 'delete') {
    ...
    itm_require_crud_role_module_permission($conn, 'delete', 'warranty_types');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && in_array($crud_action, ['create', 'edit'], true)) {
    ...
    itm_require_crud_role_module_permission($conn, $crud_action, 'warranty_types');
    cr_require_valid_csrf_token();
    $sqlValues = [];
