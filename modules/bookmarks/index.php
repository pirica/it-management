        ...
        <div class="bookmarks-layout">
            <div class="bookmarks-sidebar">
                ...
                <div class="view-filters">
                    <a href="index.php?view=all" class="itm-plain-link <?php echo $view_mode === 'all' ? 'active' : ''; ?>">All</a>
                    <a href="index.php?view=private" class="itm-plain-link <?php echo $view_mode === 'private' ? 'active' : ''; ?>">🔒 Private</a>
                    <a href="index.php?view=shared" class="itm-plain-link <?php echo $view_mode === 'shared' ? 'active' : ''; ?>">🔓 Shared</a>
                </div>
                        ...
                        <div style="display: flex; gap: 8px;">
                            ...
                            <div class="dropdown" style="position: relative;">
                                ...
                                <div class="dropdown-menu" style="right: 0; min-width: 180px;">
                                    <a class="itm-plain-link dropdown-item" href="list_all.php">📋 Table View</a>
                ...
                <?php if (!empty($bookmarks) && $totalRows > $perPage): ?>
                    <div style="display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap;margin-top:12px;">
                        ...
                        <div style="display:flex;gap:6px;flex-wrap:wrap;">
                            <?php if ($page > 1): ?>
                                <a class="btn btn-sm" href="<?php echo sanitize(bkm_build_index_query(array_merge($bkmListQueryState, ['page' => 1]))); ?>" title="First page">⏮️</a>
                            ...
                            <?php if ($page < $totalPages): ?>
                                <a class="btn btn-sm" href="<?php echo sanitize(bkm_build_index_query(array_merge($bkmListQueryState, ['page' => $page + 1]))); ?>" title="Next page">▶️</a>
