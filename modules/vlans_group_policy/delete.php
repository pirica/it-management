<?php
/**
 * Vlans Group Policy - Delete Handler
 *
 * Processes the deletion of warranty type records.
 */
$crud_table = 'vlans_group_policy';
$crud_title = 'Vlans Group Policy';
$crud_action = 'delete';
?>
<?php
require '../../config/config.php';
itm_require_crud_role_module_permission($conn, 'delete', 'vlans_group_policy');
