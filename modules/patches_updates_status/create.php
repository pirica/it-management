<?php
$crud_table = $crud_table ?? 'patches_updates_status';
$crud_title = 'Patches Updates Status';
$crud_action = 'create';
?>
<?php
require '../../config/config.php';
itm_require_crud_role_module_permission($conn, 'create', 'patches_updates_status');
...
if ($crud_action === 'delete') {
    ...
    if ($id > 0) {
        $oldAuditData = itm_fetch_audit_record($conn, $crud_table, $id, $company_id);
        ...
        itm_log_audit($conn, $crud_table, $id, 'DELETE', $oldAuditData, null);
    }
    header('Location: ' . $listUrl);
    exit;
}
