<?php
/**
 * Finance Payment Allocations Module - Delete
 *
 * Handles deletion of departments. Implements referential integrity checks
 * to avoid removing records that are still referenced by other data.
 */
