...
## 1. Module Purpose
A filtered view of the Equipment module specifically for Switch devices.
...
- **Filter**: Strictly filters equipment where `equipment_type_name = 'Switch'`.
...
Provides a specialized view for Switch asset management.
