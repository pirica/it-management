...
itm_crud_record_share_handle_ajax_request($conn, 'approvals_stage');
...
function cr_fk_metadata($conn, $table) {
    ...
    foreach (['name', 'title', 'username', 'account_name', 'account_code', 'code', 'description', 'email', 'stage', 'status', 'mode_name'] as $candidate) {
                        ...
                        <div class="form-group">
                            ...
                            <?php elseif (isset($fkMap[$name])): ?>
                                <?php
                                    ...
                                    if ($fkSelectedId > 0 && (int)$company_id > 0) {
            ...
            <?php elseif ($crud_action === 'view'): ?>
                ...
                <div class="card">
                    ...
                    <p style="margin-top:16px;">
                        <?php echo itm_crud_record_share_render_action_buttons('approvals_stage', (int)($data['id'] ?? 0), 'approvals stage'); ?>
