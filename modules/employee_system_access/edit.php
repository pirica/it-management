...
$employeeSql = 'SELECT id, first_name, last_name, display_name, work_email, personal_email FROM employees WHERE id=' . $employeeId . ' AND company_id=' . (int)$company_id . ' LIMIT 1';
...
if (!isset($crud_title)) {
    $crud_title = 'Edit Employee System Access';
}
?>
