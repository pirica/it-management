...
itm_crud_record_share_handle_ajax_request($conn, 'cost_centers');
            ...
            <?php elseif ($crud_action === 'view'): ?>
                ...
                <div class="card">
                    ...
                    <p style="margin-top:16px;">
                        <?php echo itm_crud_record_share_render_action_buttons('cost_centers', (int)($data['id'] ?? 0), 'cost center'); ?>
