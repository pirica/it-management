...
$item = null;
if ($id > 0) {
    $query = mysqli_query($conn, "SELECT * FROM workstations WHERE id = $id AND company_id = $company_id LIMIT 1");
...
<div class="container">
    ...
    <div class="main-content">
        ...
        <div class="content">
            <h1>🔎 View Workstations Record</h1>
            <div class="card">
                <?php if (!$item): ?>
