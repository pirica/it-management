...
$crud_table = 'configuration_items';
$crud_title = 'Configuration Items';
...
function cr_humanize_field($field) {
    ...
    $map = [
        ...
        'record_module_slug' => 'Source Module',
