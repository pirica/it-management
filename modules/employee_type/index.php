...
/**
 * Employee Type Module - Index
 * 
 * Main list view for employee types. Users can view, create, edit, and delete
 * records defined for the company.
 */

$crud_table = 'employee_type';
$crud_title = 'Employee Type';
$crud_action = 'index';
?>
<?php
...
function cr_fk_metadata($conn, $table) {
    ...
    foreach (['name_type', 'name', 'title', 'username', 'code', 'mode_name'] as $candidate) {
...
if ($crud_action === 'delete') {
    ...
    itm_require_crud_role_module_permission($conn, 'delete', 'employee_type');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && in_array($crud_action, ['create', 'edit'], true)) {
    ...
    itm_require_crud_role_module_permission($conn, $crud_action, 'employee_type');
    cr_require_valid_csrf_token();
