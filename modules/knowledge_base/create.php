...
/**
 * Knowledge Base Module - Create
 *
 * Provides the interface and logic for adding new knowledge base articles to the system.
 */

$crud_table = $crud_table ?? 'knowledge_base';
$crud_title = $crud_title ?? 'Knowledge Base';
