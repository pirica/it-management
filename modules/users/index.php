...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;"><h1>👥 Users</h1><a href="create.php" class="btn btn-primary">+ Add User</a></div>
