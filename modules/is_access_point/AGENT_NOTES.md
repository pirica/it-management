...
## 1. Module Purpose
A filtered view of the Equipment module specifically for Wireless Access Points (WAPs).
...
- **Filter**: Strictly filters equipment where `equipment_type_name = 'Access Point'`.
...
Provides a specialized view for networking teams.
