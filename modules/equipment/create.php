    ...
    <div class="card">
        <form method="POST" enctype="multipart/form-data">
            <div class="form-row">
                ...
                <div class="form-group"><label>Type *</label><select name="equipment_type_id" required><option value="">-- Select --</option><?php render_options($types, $data['equipment_type_id']); ?></select></div>
            </div>
            <div class="form-row">
                ...
                <div class="form-group"><label>Location</label><select name="location_id"><option value="">-- None --</option><?php render_options($locations, $data['location_id']); ?></select></div>
            </div>
            <div class="form-row">
                ...
                <div class="form-group"><label>Status *</label><select name="status_id" required><option value="">-- Select --</option><?php render_options($statuses, $data['status_id']); ?></select></div>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="form-group"><label>Warranty Type *</label><select name="warranty_type_id" required><option value="">-- Select --</option><?php render_options($warrantyTypes, $data['warranty_type_id']); ?></select></div>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
                <div class="form-group"><label>Printer Type</label><select name="printer_device_type_id"><option value="">-- None --</option><?php render_options($printerTypes, $data['printer_device_type_id']); ?></select></div>
            ...
            <div class="form-row">
                <div class="form-group"><label>Workstation Device Type</label><select name="workstation_device_type_id"><option value="">-- None --</option><?php render_options($workstationDeviceTypes, $data['workstation_device_type_id']); ?></select></div>
                <div class="form-group"><label>Workstation OS Type</label><select name="workstation_os_type_id"><option value="">-- None --</option><?php render_options($workstationOsTypes, $data['workstation_os_type_id']); ?></select></div>
            </div>
            <div class="form-row">
