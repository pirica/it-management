...
/**
 * Workstation Modes - Main Entry Point
 * 
...
/**
 * Filters out system columns and specific legacy fields for UI management.
 */
...
if ($crud_action === 'delete') {
    ...
    itm_require_crud_role_module_permission($conn, 'delete', 'workstation_modes');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && in_array($crud_action, ['create', 'edit'], true)) {
    ...
    itm_require_crud_role_module_permission($conn, $crud_action, 'workstation_modes');
    cr_require_valid_csrf_token();
