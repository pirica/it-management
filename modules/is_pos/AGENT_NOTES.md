...
## 1. Module Purpose
A filtered view of the Equipment module specifically for Pos devices.
...
- **Filter**: Strictly filters equipment where `equipment_type_name = 'Pos'`.
...
Provides a specialized view for Pos asset management.
