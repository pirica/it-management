<?php
$crud_table = 'hotel_bookings_future';
$crud_title = 'Booking Future Status';
$crud_action = 'create';
?>
<?php
require '../../config/config.php';
itm_require_crud_role_module_permission($conn, 'create', 'hotel_bookings_future');
