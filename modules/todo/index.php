...
<head>
    <meta charset="UTF-8">
    <title>Todo - IT Management</title>
    <link rel="stylesheet" href="../../css/styles.css">
    <style>
        .todo-container { display: flex; height: calc(100vh - 60px); background-color: var(--bg-primary); }
        .todo-sidebar { width: 280px; background-color: var(--bg-secondary); border-right: 1px solid var(--border); padding: 20px 10px; display: flex; flex-direction: column; }
        .todo-sidebar-item { padding: 10px 15px; margin-bottom: 5px; border-radius: 4px; cursor: pointer; display: flex; align-items: center; color: var(--text-primary); text-decoration: none; transition: background 0.2s; }
        .todo-sidebar-item:hover, .todo-sidebar-item.active { background-color: var(--bg-tertiary); }
                    ...
                    <div class="task-list" id="taskList">
                        <?php if (empty($tasks)): ?>
                            <div class="empty-state">
                                ...
                                <div>No tasks here. Enjoy your day!</div>
                            </div>
                        <?php else: ?>
