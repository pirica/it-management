...
/**
 * RJ45 Ports Module - Index
 * 
 * Main list view for RJ45 ports. Users can view, create, edit, and delete
 * records defined for the company.
 */

$crud_table = $crud_table ?? 'equipment_rj45';
$crud_title = $crud_title ?? 'RJ45 Ports';
...
if ($crud_action === 'delete') {
    ...
    itm_require_crud_role_module_permission($conn, 'delete', 'equipment_rj45');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && in_array($crud_action, ['create', 'edit'], true)) {
    ...
    itm_require_crud_role_module_permission($conn, $crud_action, 'equipment_rj45');
    cr_require_valid_csrf_token();
