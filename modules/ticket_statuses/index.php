<?php
$crud_table = 'ticket_statuses';
$crud_title = 'Ticket Statuses';
$crud_action = 'index';
?>
<?php
...
if ($crud_action === 'delete') {
    ...
    itm_require_crud_role_module_permission($conn, 'delete', 'ticket_statuses');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && in_array($crud_action, ['create', 'edit'], true)) {
    ...
    itm_require_crud_role_module_permission($conn, $crud_action, 'ticket_statuses');
    cr_require_valid_csrf_token();
    $sqlValues = [];
