 ...
 *
 * FIX: Added RBAC check to ensure the user has CREATE permission for the target module.
 */
...
// WHY: Enforce RBAC CREATE permission for the target module before allowing insertion.
if (function_exists('itm_require_crud_role_module_permission')) {
    itm_require_crud_role_module_permission($conn, 'create', $table);
}
