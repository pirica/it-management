...
## 1. Module Purpose
A filtered view of the Equipment module specifically for Printer devices.
...
- **Filter**: Strictly filters equipment where `equipment_type_name = 'Printer'`.
...
Provides a specialized view for Printer asset management.
