...
<?php elseif ($type === 'coupon'): ?>
    ...
    <div class="form-group"><label>Expires</label><input type="text" name="payload[expires]" class="form-control" value="<?= sanitize((string)($p['expires'] ?? '')) ?>" placeholder="dd/mm/yyyy"></div>
