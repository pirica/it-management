...
- **create.php** — step 1 type grid; step 2 wizard with **Content** (1) and **Design** (2) tabs, live static preview, PNG/JPG/SVG download, **design templates** (`qr_design_templates` per employee). Coupon **Expires** uses **`itm_render_uk_date_input()`** (dd/mm/yyyy + 📅 picker); landing shows dd/mm/yyyy via `itm_format_date_display()`.
