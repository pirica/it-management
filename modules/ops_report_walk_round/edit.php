<?php
$crud_table = 'ops_report_walk_round';
$crud_title = 'Ops Report Walk Round';
$crud_action = 'edit';
?>
<?php
require '../../config/config.php';
itm_require_crud_role_module_permission($conn, 'edit', 'ops_report_walk_round');
