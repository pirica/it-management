...
itm_crud_record_share_handle_ajax_request($conn, 'annual_budgets');
            ...
            <?php elseif ($crud_action === 'view'): ?>
                ...
                <div class="card">
                    ...
                    <p style="margin-top:16px;">
                        <?php echo itm_crud_record_share_render_action_buttons('annual_budgets', (int)($data['id'] ?? 0), 'annual budget'); ?>
