...
## 10. Common Pitfalls
- **Duplicate Budgets**: Attempting to insert a budget for a combination that already exists will trigger a unique key violation.
- **Cascade Deletes**: Be careful when deleting annual budgets as it removes the monthly breakdown.
