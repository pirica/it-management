<?php
/**
 * Workstation OS Versions - Edit Record
 *
 * Provides the interface for updating existing workstation OS version records.
 */
...
itm_require_crud_role_module_permission($conn, 'edit', 'workstation_os_versions');
