...
/**
 * Fiber Racks Module - Index
 * 
 * Main list view for fiber racks. Users can view, create, edit, and delete
...
if ($crud_action === 'delete') {
    ...
    itm_require_crud_role_module_permission($conn, 'delete', 'equipment_fiber_rack');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && in_array($crud_action, ['create', 'edit'], true)) {
    ...
    itm_require_crud_role_module_permission($conn, $crud_action, 'equipment_fiber_rack');
    cr_require_valid_csrf_token();
