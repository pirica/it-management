...
/**
 * Employee Statuses Module - Index
 * 
 * Main list view for employee statuses. Users can view, create, edit, and delete
 * records defined for the company.
 */

$crud_table = $crud_table ?? 'employee_statuses';
$crud_title = $crud_title ?? 'Employee Statuses';
...
if ($crud_action === 'delete') {
    ...
    itm_require_crud_role_module_permission($conn, 'delete', 'employee_statuses');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && in_array($crud_action, ['create', 'edit'], true)) {
    ...
    itm_require_crud_role_module_permission($conn, $crud_action, 'employee_statuses');
    cr_require_valid_csrf_token();
