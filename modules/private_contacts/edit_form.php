                    ...
                    <div class="col-auto">
                        <div class="position-relative">
                            <?php if (isset($contact['photo']) && $contact['photo']): ?>
                                <img src="../../files/contacts/<?php echo htmlspecialchars($contact['photo']); ?>" id="photo-preview" class="rounded-circle border" width="100" height="100" style="object-fit: cover;">
                            <?php else: ?>
