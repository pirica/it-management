...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="edit.php?id=<?php echo $id; ?>" class="btn btn-primary mr-1"><i class="fas fa-edit"></i> Edit</a>
            <form method="POST" action="index_logic.php" class="d-inline" onsubmit="return confirm('Are you sure?');">
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <?php if ($contact['photo']): ?>
                            <img src="../../files/<?php echo $_SESSION[company_id]; ?>/Private/<?php echo $_SESSION[username] . "_" . $_SESSION[user_id]; ?>/private_contacts/<?php echo htmlspecialchars($contact['photo']); ?>" class="rounded-circle border" width="120" height="120" style="object-fit: cover;">
                        <?php else: ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    <div class="card h-100">
                        <div class="card-header bg-white"><h5 class="mb-0">Contact Information</h5></div>
                        <div class="card-body">
                ...
                <div class="col-md-6 mb-4">
                    <div class="card h-100">
                        <div class="card-header bg-white"><h5 class="mb-0">Address</h5></div>
                        <div class="card-body">
                ...
                <div class="col-md-6 mb-4">
                    <div class="card h-100">
                        <div class="card-header bg-white"><h5 class="mb-0">About</h5></div>
                        <div class="card-body">
        ...
        <div class="col-md-4">
            <!-- Details for Phonetic / Other -->
            <?php if ($contact['nickname'] || $contact['phonetic_first_name']): ?>
            <div class="card mb-4">
                <div class="card-header bg-white"><h5 class="mb-0">Names Detail</h5></div>
                <div class="card-body">
            ...
            <div class="card mb-4">
                <div class="card-header bg-white"><h5 class="mb-0">Other</h5></div>
                <div class="card-body">
