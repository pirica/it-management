...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt->bind_param("iisssssssssssssssssssssssssssssssssssii",
        $_SESSION['company_id'], $_SESSION['user_id'], $_POST['name_prefix'], $_POST['first_name'], $_POST['middle_name'], $_POST['last_name'], $_POST['name_suffix'],
