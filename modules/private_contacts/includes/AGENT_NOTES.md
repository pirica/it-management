...
## 10. Common Pitfalls
- Hand-building direct relative HTTP links to the upload files on-disk—these are blocked by the `.htaccess` `deny_http` rule. Always route them through `itm_files_serve_url()`. [Cursor-Valid]
