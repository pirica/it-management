<?php
$crud_table = 'hotel_booking_housekeeping_maintenance_status';
$crud_title = 'HSK Maintenance Status';
$crud_action = 'delete';
?>
<?php
require '../../config/config.php';
itm_require_crud_role_module_permission($conn, 'delete', 'hotel_booking_housekeeping_maintenance_status');
