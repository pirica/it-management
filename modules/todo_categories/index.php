...
/**
 * Todo Categories - Main Entry Point
 *
...
if ($crud_action === 'delete') {
    ...
    itm_require_crud_role_module_permission($conn, 'delete', 'todo_categories');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && in_array($crud_action, ['create', 'edit'], true)) {
    ...
    itm_require_crud_role_module_permission($conn, $crud_action, 'todo_categories');
    cr_require_valid_csrf_token();
    $sqlValues = [];
