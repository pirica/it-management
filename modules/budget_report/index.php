        ...
        <div class="content">
            ...
            <div class="card">
                <table class="bgr-table" data-itm-db-import-endpoint="index.php">
                    <thead>
                    <tr>
                        <th><a style="text-decoration:none;color:inherit;" href="<?php echo sanitize(bgr_sort_url('cost_center', $sort, $dir, $selectedYear, $selectedMonth, $selectedCostCenterId, $selectedGlAccountId, $search)); ?>">Cost Center<?php echo bgr_sort_indicator('cost_center', $sort, $dir); ?></a></th>
                        <th><a style="text-decoration:none;color:inherit;" href="<?php echo sanitize(bgr_sort_url('account_code', $sort, $dir, $selectedYear, $selectedMonth, $selectedCostCenterId, $selectedGlAccountId, $search)); ?>">Account Code<?php echo bgr_sort_indicator('account_code', $sort, $dir); ?></a></th>
                        <th><a style="text-decoration:none;color:inherit;" href="<?php echo sanitize(bgr_sort_url('account_name', $sort, $dir, $selectedYear, $selectedMonth, $selectedCostCenterId, $selectedGlAccountId, $search)); ?>">Account Name<?php echo bgr_sort_indicator('account_name', $sort, $dir); ?></a></th>
                        <th><a style="text-decoration:none;color:inherit;" href="<?php echo sanitize(bgr_sort_url('budget_selected_period', $sort, $dir, $selectedYear, $selectedMonth, $selectedCostCenterId, $selectedGlAccountId, $search)); ?>">Budget (Selected Period)<?php echo bgr_sort_indicator('budget_selected_period', $sort, $dir); ?></a></th>
                        <th><a style="text-decoration:none;color:inherit;" href="<?php echo sanitize(bgr_sort_url('forecast_selected_period', $sort, $dir, $selectedYear, $selectedMonth, $selectedCostCenterId, $selectedGlAccountId, $search)); ?>">Forecast (Selected Period)<?php echo bgr_sort_indicator('forecast_selected_period', $sort, $dir); ?></a></th>
                        <th><a style="text-decoration:none;color:inherit;" href="<?php echo sanitize(bgr_sort_url('actual_curr_period', $sort, $dir, $selectedYear, $selectedMonth, $selectedCostCenterId, $selectedGlAccountId, $search)); ?>"><?php echo $isMonthMode ? 'Actual (Selected Month)' : 'Actual (Selected Year)'; ?><?php echo bgr_sort_indicator('actual_curr_period', $sort, $dir); ?></a></th>
                        <th><a style="text-decoration:none;color:inherit;" href="<?php echo sanitize(bgr_sort_url('actual_prev_period', $sort, $dir, $selectedYear, $selectedMonth, $selectedCostCenterId, $selectedGlAccountId, $search)); ?>"><?php echo $isMonthMode ? 'Actual (Previous Month)' : 'Actual (Previous Year)'; ?><?php echo bgr_sort_indicator('actual_prev_period', $sort, $dir); ?></a></th>
                        <th><a style="text-decoration:none;color:inherit;" href="<?php echo sanitize(bgr_sort_url('actual_prev_year_same_month', $sort, $dir, $selectedYear, $selectedMonth, $selectedCostCenterId, $selectedGlAccountId, $search)); ?>">Actual (Same Month Previous Year)<?php echo bgr_sort_indicator('actual_prev_year_same_month', $sort, $dir); ?></a></th>
