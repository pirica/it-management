...
## 10. Common Pitfalls
- **Do not delete canonical wrappers:** Keep `modules/is_port_patch_panel/` and sibling `is_*` folders. [Valid]-[2026-07-15]
- **Type filter:** `$equipmentTypeNameFilter` must match `equipment_types.name` exactly (`Port Patch Panel` — multi-word string). [Valid]-[2026-07-15]
