<?php
/**
 * Vlans Per Port Types - Delete Handler
 *
 * Processes the deletion of warranty type records.
 */
$crud_table = 'vlans_per_port_types';
$crud_title = 'Vlans Per Port Types';
$crud_action = 'delete';
?>
<?php
require '../../config/config.php';
itm_require_crud_role_module_permission($conn, 'delete', 'vlans_per_port_types');
