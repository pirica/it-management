<?php
/**
 * Idf Positions Module - Index
 * 
 * Central implementation for the isolated IDF Positions CRUD module.
 * This file is dedicated to the `idf_positions` table and does not
 * delegate to or depend on the shared manufacturers module.
 * 
 * Features:
