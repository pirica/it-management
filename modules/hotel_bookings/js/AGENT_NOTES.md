...
| File | Role |
|------|------|
| `hotel-bookings-planning.js` | Planning grid: anchor navigation (⬅️/➡️), drag-and-drop moves (`ajax_action=planning_move`), HSK double-click rotate, OOO/OOS modal iframe, bar double-click to view |
