...
- Portal rate plan options filter by selected room’s `hotel_id`; ➕ opens `hotel_booking_portal_rate_plans/create.php?embed=1` in a modal (`js/hotel-bookings-rate-plan-select.js`). View/edit links open the rate plan module in a new tab.
