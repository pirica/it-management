...
/**
 * Hotel Booking Hotel Photos Module - Create
 *
...
function cr_render_cell_value($table, $field, $value) {
    ...
    if (($GLOBALS['crud_table'] ?? '') === 'hotel_booking_hotel_photos' && $field === 'is_cover') {
        return ((int)$value === 1) ? '✅' : '❌';
    }
