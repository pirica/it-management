...
itm_crud_record_share_handle_ajax_request($conn, 'approvers');
                        ...
                        <div class="form-group">
                            ...
                            <?php elseif (isset($fkMap[$name])): ?>
                                <?php
                                    ...
                                    $addExtraFieldsJson = '';
                                    if ((string)$fkRow['REFERENCED_TABLE_NAME'] === 'employees') {
            ...
            <?php elseif ($crud_action === 'view'): ?>
                ...
                <div class="card">
                    ...
                    <p style="margin-top:16px;">
                        <?php echo itm_crud_record_share_render_action_buttons('approvers', (int)($data['id'] ?? 0), 'approver'); ?>
