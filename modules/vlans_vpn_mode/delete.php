<?php
/**
 * Vlans Vpn Mode - Delete Handler
 *
 * Processes the deletion of warranty type records.
 */
$crud_table = 'vlans_vpn_mode';
$crud_title = 'Vlans Vpn Mode';
$crud_action = 'delete';
?>
<?php
require '../../config/config.php';
itm_require_crud_role_module_permission($conn, 'delete', 'vlans_vpn_mode');
