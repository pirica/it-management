...
/**
 * Fiber Patches Module - Index
 * 
 * Main list view for fiber patches. Users can view, create, edit, and delete
 * records defined for the company.
 */

$crud_table = 'equipment_fiber_patch';
$crud_title = 'Fiber Patches';
$crud_action = 'index';
?>
<?php
...
if ($crud_action === 'delete') {
    ...
    itm_require_crud_role_module_permission($conn, 'delete', 'equipment_fiber_patch');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && in_array($crud_action, ['create', 'edit'], true)) {
    ...
    itm_require_crud_role_module_permission($conn, $crud_action, 'equipment_fiber_patch');
    cr_require_valid_csrf_token();
