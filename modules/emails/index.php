    ...
    <div class="main-content">
        ...
        <div class="content">
            ...
            <div class="email-stats">
                <a class="itm-plain-link stat-card stat-card-link" href="<?php echo $sendLogsStatHrefAll; ?>">
                    <div class="stat-label">Total Emails Logged</div>
                    <div class="stat-number"><?php echo (int)$totalEmails; ?></div>
                </a>
                <a class="itm-plain-link stat-card stat-card-link" href="<?php echo $sendLogsStatHrefSent; ?>">
                    <div class="stat-label">Successfully Sent</div>
                    <div class="stat-number"><?php echo (int)$sentEmails; ?></div>
                </a>
                <a class="itm-plain-link stat-card stat-card-link" href="<?php echo $sendLogsStatHrefFailed; ?>">
                    <div class="stat-label">Failed</div>
                    <div class="stat-number"><?php echo (int)$failedEmails; ?></div>
                </a>
                <a class="itm-plain-link stat-card stat-card-link" href="<?php echo $sendLogsStatHrefReceived; ?>">
            ...
            <div class="email-tabs">
                <a href="?tab=send_logs" class="itm-plain-link email-tab <?php echo $active_tab === 'send_logs' ? 'active' : ''; ?>">Send Logs</a>
                <a href="?tab=smtp" class="itm-plain-link email-tab <?php echo $active_tab === 'smtp' ? 'active' : ''; ?>">SMTP Configurations</a>
                <a href="?tab=alert_rules" class="itm-plain-link email-tab <?php echo $active_tab === 'alert_rules' ? 'active' : ''; ?>">Alert Rules</a>
            </div>
