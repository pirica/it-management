<?php
$crud_table = 'ticket_categories';
$crud_title = 'Ticket Categories';
$crud_action = 'index';
?>
<?php
...
if ($crud_action === 'delete') {
    ...
    itm_require_crud_role_module_permission($conn, 'delete', 'ticket_categories');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && in_array($crud_action, ['create', 'edit'], true)) {
    ...
    itm_require_crud_role_module_permission($conn, $crud_action, 'ticket_categories');
    cr_require_valid_csrf_token();
    $sqlValues = [];
