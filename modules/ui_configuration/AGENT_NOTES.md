...
- Hardcoding a fallback company ID instead of using the active session.
- Displaying the raw `api_key` or `active` fields in visible list screens when they are meant to be secured or hidden.
