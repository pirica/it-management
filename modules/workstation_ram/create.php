...
itm_require_crud_role_module_permission($conn, 'create', 'workstation_ram');
                        ...
                        <div class="form-group">
                            ...
                            <?php if ($name === 'active'): ?>
                                <label class="itm-checkbox-control">
                                    <input type="checkbox" name="active" value="1" <?php echo ((int)$displayVal === 1) ? 'checked' : ''; ?>>
