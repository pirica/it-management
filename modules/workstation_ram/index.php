...
/**
 * Workstation RAM - Main Entry Point
 * 
...
if ($crud_action === 'delete') {
    ...
    itm_require_crud_role_module_permission($conn, 'delete', 'workstation_ram');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && in_array($crud_action, ['create', 'edit'], true)) {
    ...
    itm_require_crud_role_module_permission($conn, $crud_action, 'workstation_ram');
    cr_require_valid_csrf_token();
    $sqlValues = [];
