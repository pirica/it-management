        ...
        <div class="content">
            ...
            <div class="card" style="overflow:auto;">
                <table class="table resign-table" data-itm-no-import-excel="1">
                    <thead>
                        <tr>
                            <th><a style="text-decoration:none;color:inherit;" href="<?= sanitize(resign_sort_url('external_id', $sort, $dir, $selectedYear, $selectedMonth, $selectedWeek, $search, $selectedStatusIds, $selectedTypeIds)) ?>">ID TM<?= resign_sort_indicator('external_id', $sort, $dir) ?></a></th>
                            <th><a style="text-decoration:none;color:inherit;" href="<?= sanitize(resign_sort_url('name', $sort, $dir, $selectedYear, $selectedMonth, $selectedWeek, $search, $selectedStatusIds, $selectedTypeIds)) ?>">Name<?= resign_sort_indicator('name', $sort, $dir) ?></a></th>
                            <th><a style="text-decoration:none;color:inherit;" href="<?= sanitize(resign_sort_url('employee_type', $sort, $dir, $selectedYear, $selectedMonth, $selectedWeek, $search, $selectedStatusIds, $selectedTypeIds)) ?>">Team member / Internship<?= resign_sort_indicator('employee_type', $sort, $dir) ?></a></th>
                            <th><a style="text-decoration:none;color:inherit;" href="<?= sanitize(resign_sort_url('department', $sort, $dir, $selectedYear, $selectedMonth, $selectedWeek, $search, $selectedStatusIds, $selectedTypeIds)) ?>">Department<?= resign_sort_indicator('department', $sort, $dir) ?></a></th>
                            <th><a style="text-decoration:none;color:inherit;" href="<?= sanitize(resign_sort_url('start_date', $sort, $dir, $selectedYear, $selectedMonth, $selectedWeek, $search, $selectedStatusIds, $selectedTypeIds)) ?>">Admission date<?= resign_sort_indicator('start_date', $sort, $dir) ?></a></th>
                            <th><a style="text-decoration:none;color:inherit;" href="<?= sanitize(resign_sort_url('termination_date', $sort, $dir, $selectedYear, $selectedMonth, $selectedWeek, $search, $selectedStatusIds, $selectedTypeIds)) ?>">Last work day<?= resign_sort_indicator('termination_date', $sort, $dir) ?></a></th>
                            <th><a style="text-decoration:none;color:inherit;" href="<?= sanitize(resign_sort_url('resignation_week', $sort, $dir, $selectedYear, $selectedMonth, $selectedWeek, $search, $selectedStatusIds, $selectedTypeIds)) ?>">Official Resignation Week<?= resign_sort_indicator('resignation_week', $sort, $dir) ?></a></th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php if (empty($rows)): ?>
