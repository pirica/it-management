...
- **Share implementation list:** `itm_qr_share_capable_module_slugs()` in `includes/itm_qr_share.php` — matrix shows all registry modules; only capable slugs can create sessions today.
