        ...
        if ($crud_action === 'create') {
            ...
            if ($stmtInsert) {
                ...
                if (mysqli_stmt_execute($stmtInsert)) {
                    ...
                    itm_seed_company_module_share_for_module($conn, $newId);
                    header('Location: ' . $modulePath . '/list_all.php');
                    exit;
                }
                                ...
                                <tr data-sms-search="<?= sanitize($rowSearch) ?>">
                                    <td>
                                        ...
                                        <div style="color:var(--text-secondary);font-size:12px;">
                                            <a class="itm-plain-link" href="../<?= sanitize($moduleSlug) ?>" target="_blank" rel="noopener noreferrer nofollow" style="color:var(--accent); text-decoration:none;">
                                                <?= sanitize($moduleSlug) ?>
                                            </a>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="itm-actions-cell" data-itm-actions-origin="1">
                                        <div class="itm-actions-wrap">
                                            <a class="btn btn-sm" href="view.php?id=<?= (int)$registryRow['id'] ?>" title="View">🔎</a>
                                            <a class="btn btn-sm" href="edit.php?id=<?= (int)$registryRow['id'] ?>" title="Edit">✏️</a>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            ...
                            <a class="btn btn-sm" href="edit.php?id=<?= (int)$viewRow['id'] ?>" title="Edit">✏️</a>
                            <a class="btn btn-sm" href="list_all.php" title="Back">🔙</a>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endif; ?>
