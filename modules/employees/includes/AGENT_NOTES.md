...
## 10. Common Pitfalls
- Forgetting that `edit.php` and `create.php` both include these files. Ensure modifications do not cause undefined variable warnings in either flow. [Cursor-Valid]
