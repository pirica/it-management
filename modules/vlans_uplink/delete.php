<?php
/**
 * Vlans Uplink - Delete Handler
 *
 * Processes the deletion of warranty type records.
 */
$crud_table = 'vlans_uplink';
$crud_title = 'Vlans Uplink';
$crud_action = 'delete';
?>
<?php
require '../../config/config.php';
itm_require_crud_role_module_permission($conn, 'delete', 'vlans_uplink');
