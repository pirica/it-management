    ...
    <div class="main-content">
        ...
        <div class="content">
            ...
            <div class="status-tabs">
                <a href="?tab=monitoring" class="itm-plain-link status-tab <?php echo $active_tab === 'monitoring' ? 'active' : ''; ?>">📊 Monitoring</a>
                <a href="?tab=php_settings" class="itm-plain-link status-tab <?php echo $active_tab === 'php_settings' ? 'active' : ''; ?>">🧩 PHP Settings</a>
                <a href="?tab=database" class="itm-plain-link status-tab <?php echo $active_tab === 'database' ? 'active' : ''; ?>">🗄️ Database</a>
            </div>
