...
## 10. Common Pitfalls
- Writing inline HTML styles inside templates instead of relying on the global variables and utility classes defined in `css/styles.css` and `modules/system_status/index.php`.
