...
function cr_render_cell_value($table, $field, $value) {
    ...
    if ($table === 'ip_addresses' && $field === 'status') {
        ...
        if ($status === 'used') {
            ...
            $class = 'badge-warning';
        } elseif (in_array($status, ['gateway', 'dns'], true)) {
            $class = 'badge-info';
        } elseif ($status === 'free') {
            $class = 'badge-secondary';
        }
        return '<span class="badge ' . $class . '">' . sanitize(ucfirst($status)) . '</span>';
    }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input
                                            ...
                                            maxlength="255"
                                            placeholder="IP-only note (not equipment notes)…"
