<?php
$crud_table = 'printer_device_types';
$crud_title = 'Printer Device Types';
$crud_action = 'index';
?>
<?php
...
if ($crud_action === 'delete') {
    ...
    itm_require_crud_role_module_permission($conn, 'delete', 'printer_device_types');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && in_array($crud_action, ['create', 'edit'], true)) {
    ...
    itm_require_crud_role_module_permission($conn, $crud_action, 'printer_device_types');
    cr_require_valid_csrf_token();
    $sqlValues = [];
