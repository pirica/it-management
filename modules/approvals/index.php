...
/**
 * Forecast Approvals Module - Index
 * 
...
itm_crud_record_share_handle_ajax_request($conn, 'approvals');
...
function cr_fk_metadata($conn, $table) {
    ...
    foreach (['name', 'title', 'username', 'account_name', 'account_code', 'code', 'stage', 'status', 'approver_type_description', 'description', 'email', 'mode_name'] as $candidate) {
            ...
            <?php elseif ($crud_action === 'view'): ?>
                ...
                <div class="card">
                    ...
                    <p style="margin-top:16px;">
                        <?php echo itm_crud_record_share_render_action_buttons('approvals', (int)($data['id'] ?? 0), 'approval'); ?>
