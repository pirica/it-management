...
- **Do not delete canonical wrappers:** Keep `modules/is_phone/` and sibling `is_*` folders. [Valid]-[2026-07-15]
- **Type filter:** `$equipmentTypeNameFilter` must match `equipment_types.name` (`Phone`). [Valid]-[2026-07-15]
