...
## 1. Module Purpose
A filtered view of the Equipment module specifically for Phone devices.
...
- **Filter**: Strictly filters equipment where `equipment_type_name = 'Phone'`.
...
Provides a specialized view for Phone asset management.
