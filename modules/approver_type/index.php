...
itm_crud_record_share_handle_ajax_request($conn, 'approver_type');
            ...
            <?php elseif ($crud_action === 'view'): ?>
                ...
                <div class="card">
                    ...
                    <p style="margin-top:16px;">
                        <?php echo itm_crud_record_share_render_action_buttons('approver_type', (int)($data['id'] ?? 0), 'approver type'); ?>
