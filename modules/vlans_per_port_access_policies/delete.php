<?php
/**
 * Vlans Per Port Access Policies - Delete Handler
 *
 * Processes the deletion of warranty type records.
 */
$crud_table = 'vlans_per_port_access_policies';
$crud_title = 'Vlans Per Port Access Policies';
$crud_action = 'delete';
?>
<?php
require '../../config/config.php';
itm_require_crud_role_module_permission($conn, 'delete', 'vlans_per_port_access_policies');
