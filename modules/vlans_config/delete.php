<?php
/**
 * Vlans Config - Delete Handler
 *
 * Processes the deletion of warranty type records.
 */
$crud_table = 'vlans_config';
$crud_title = 'Vlans Config';
$crud_action = 'delete';
?>
<?php
require '../../config/config.php';
itm_require_crud_role_module_permission($conn, 'delete', 'vlans_config');
