...
The application is composed of **13 central functional domains**, with **220** module folders (`modules/*/index.php`) and **210** database tables (`db/01_schema.sql`).
