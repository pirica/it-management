...
The application is composed of **13 central functional domains**, with **221** module folders (`modules/*/index.php`) and **241** database tables (`db/01_schema.sql`).
