...
INSERT INTO `email_smtp_configurations` (`id`, `company_id`, `config_name`, `smtp_host`, `smtp_port`, `username`, `password_encrypted`, `from_email`, `from_name`, `imap_port`, `pop3_port`, `pop3_tls_mode`, `pop3_require_secure_connection`, `is_default`, `active`, `created_at`, `updated_at`) VALUES ('1', '1', 'IT Manager', '127.0.0.1', '1025', NULL, NULL, 'noreply@example.com', 'Mail Manager', '143', '110', 'None', '0', '1', '1', '2026-06-18 01:00:00', '2026-06-19 22:49:25');

INSERT INTO `email_smtp_configurations` (`id`, `company_id`, `config_name`, `smtp_host`, `smtp_port`, `username`, `password_encrypted`, `from_email`, `from_name`, `imap_port`, `pop3_port`, `pop3_tls_mode`, `pop3_require_secure_connection`, `is_default`, `active`, `created_at`, `updated_at`) VALUES ('2', '2', 'IT Manager', '127.0.0.1', '1025', NULL, NULL, 'noreply@example.com', 'Mail Manager', '143', '110', 'None', '0', '1', '1', '2026-06-18 01:00:00', '2026-06-19 22:49:25');

INSERT INTO `email_smtp_configurations` (`id`, `company_id`, `config_name`, `smtp_host`, `smtp_port`, `username`, `password_encrypted`, `from_email`, `from_name`, `imap_port`, `pop3_port`, `pop3_tls_mode`, `pop3_require_secure_connection`, `is_default`, `active`, `created_at`, `updated_at`) VALUES ('3', '3', 'IT Manager', '127.0.0.1', '1025', NULL, NULL, 'noreply@example.com', 'Mail Manager', '143', '110', 'None', '0', '1', '1', '2026-06-18 01:00:00', '2026-06-19 22:49:25');

INSERT INTO `email_smtp_configurations` (`id`, `company_id`, `config_name`, `smtp_host`, `smtp_port`, `username`, `password_encrypted`, `from_email`, `from_name`, `imap_port`, `pop3_port`, `pop3_tls_mode`, `pop3_require_secure_connection`, `is_default`, `active`, `created_at`, `updated_at`) VALUES ('4', '4', 'IT Manager', '127.0.0.1', '1025', NULL, NULL, 'noreply@example.com', 'Mail Manager', '143', '110', 'None', '0', '1', '1', '2026-06-18 01:00:00', '2026-06-19 22:49:25');
...
INSERT INTO `hotel_booking_settings` (`company_id`, `public_portal_enabled`, `welcome_title`, `welcome_subtitle`, `price_footnote`, `reviews_url`, `tourist_tax_per_person_per_night`, `free_cancellation_days_before_check_in`, `calendar_month_advance_days_left`, `urlmybooking`, `active`, `created_at`) VALUES
(1, 1, 'Find your stay', 'Browse hotels and book with confidence.', 'Prices include tourist tax and may vary by date and availability.', 'https://www.tripadvisor.pt/Hotel_Review-g262054-d2142716-Reviews-Conrad_Algarve-Almancil_Loule_Faro_District_Algarve.html#REVIEWS', 2.00, 5, 3, 'https://localhost/it-management/booking/users/bookings.php', 1, '2026-01-01 00:00:01');

INSERT IGNORE INTO `hotel_booking_settings` (`company_id`, `public_portal_enabled`, `welcome_title`, `welcome_subtitle`, `price_footnote`, `reviews_url`, `tourist_tax_per_person_per_night`, `free_cancellation_days_before_check_in`, `calendar_month_advance_days_left`, `urlmybooking`, `active`, `created_at`) SELECT c.`id`, t.`public_portal_enabled`, t.`welcome_title`, t.`welcome_subtitle`, t.`price_footnote`, t.`reviews_url`, t.`tourist_tax_per_person_per_night`, t.`free_cancellation_days_before_check_in`, t.`calendar_month_advance_days_left`, t.`urlmybooking`, t.`active`, '2026-01-01 00:00:01' FROM `hotel_booking_settings` t JOIN `companies` c ON c.`id` <> t.`company_id` WHERE t.`company_id` = 1;
...
SELECT c.`id`, CONCAT('TechCorp Retreat (', c.`company`, ')'), t.`description`, t.`location`, CONCAT('+351 210 000 00', c.`id`), t.`website_url`, t.`reviews_url`, t.`check_in_time`, t.`check_out_time`, t.`currency_code`, t.`parking_info`, t.`pets_policy`, 1, '2026-01-01 00:00:01'
FROM `companies` c
