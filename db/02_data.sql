...
INSERT INTO `modules_registry` (`module_slug`, `module_name`, `is_system_module`, `active`, `icon`) VALUES ("webmail", "Webmail", 0, 1, "📬");
...
INSERT INTO `modules_registry` (`module_slug`, `module_name`, `is_system_module`, `active`, `icon`) VALUES ("network_discovery", "Network Discovery", 0, 1, "🔍");
...
INSERT INTO `modules_registry` (`module_slug`, `module_name`, `is_system_module`, `active`, `icon`) VALUES ("problems", "Problem Management", 0, 1, "🔍");
INSERT INTO `modules_registry` (`module_slug`, `module_name`, `is_system_module`, `active`, `icon`) VALUES ("master_tickets", "Master Tickets", 0, 1, "🎫");
...
INSERT INTO `modules_registry` (`module_slug`, `module_name`, `is_system_module`, `active`, `icon`) VALUES ("job_queue", "Job Queue", 1, 1, "⏱️");
...
INSERT INTO `email_smtp_configurations` (`id`, `company_id`, `config_name`, `smtp_host`, `smtp_port`, `username`, `password_encrypted`, `from_email`, `from_name`, `imap_host`, `inbound_ticket_enabled`, `imap_port`, `pop3_port`, `pop3_tls_mode`, `pop3_require_secure_connection`, `is_default`, `active`, `created_at`, `updated_at`) VALUES ('1', '1', 'IT Manager', '127.0.0.1', '1025', NULL, NULL, 'noreply@example.com', 'Mail Manager', 'mailpit', '1', '143', '110', 'None', '0', '1', '1', '2026-06-18 01:00:00', '2026-06-19 22:49:25');

INSERT INTO `email_smtp_configurations` (`id`, `company_id`, `config_name`, `smtp_host`, `smtp_port`, `username`, `password_encrypted`, `from_email`, `from_name`, `imap_host`, `inbound_ticket_enabled`, `imap_port`, `pop3_port`, `pop3_tls_mode`, `pop3_require_secure_connection`, `is_default`, `active`, `created_at`, `updated_at`) VALUES ('2', '2', 'IT Manager', '127.0.0.1', '1025', NULL, NULL, 'noreply@example.com', 'Mail Manager', 'mailpit', '1', '143', '110', 'None', '0', '1', '1', '2026-06-18 01:00:00', '2026-06-19 22:49:25');

INSERT INTO `email_smtp_configurations` (`id`, `company_id`, `config_name`, `smtp_host`, `smtp_port`, `username`, `password_encrypted`, `from_email`, `from_name`, `imap_host`, `inbound_ticket_enabled`, `imap_port`, `pop3_port`, `pop3_tls_mode`, `pop3_require_secure_connection`, `is_default`, `active`, `created_at`, `updated_at`) VALUES ('3', '3', 'IT Manager', '127.0.0.1', '1025', NULL, NULL, 'noreply@example.com', 'Mail Manager', 'mailpit', '1', '143', '110', 'None', '0', '1', '1', '2026-06-18 01:00:00', '2026-06-19 22:49:25');

INSERT INTO `email_smtp_configurations` (`id`, `company_id`, `config_name`, `smtp_host`, `smtp_port`, `username`, `password_encrypted`, `from_email`, `from_name`, `imap_host`, `inbound_ticket_enabled`, `imap_port`, `pop3_port`, `pop3_tls_mode`, `pop3_require_secure_connection`, `is_default`, `active`, `created_at`, `updated_at`) VALUES ('4', '4', 'IT Manager', '127.0.0.1', '1025', NULL, NULL, 'noreply@example.com', 'Mail Manager', 'mailpit', '1', '143', '110', 'None', '0', '1', '1', '2026-06-18 01:00:00', '2026-06-19 22:49:25');

INSERT INTO `email_smtp_configurations` (`id`, `company_id`, `config_name`, `smtp_host`, `smtp_port`, `username`, `password_encrypted`, `from_email`, `from_name`, `imap_host`, `inbound_ticket_enabled`, `imap_port`, `pop3_port`, `pop3_tls_mode`, `pop3_require_secure_connection`, `is_default`, `active`, `created_at`, `updated_at`) VALUES ('5', '5', 'IT Manager', '127.0.0.1', '1025', NULL, NULL, 'noreply@example.com', 'Mail Manager', 'mailpit', '1', '143', '110', 'None', '0', '1', '1', '2026-06-18 01:00:00', '2026-06-19 22:49:25');

INSERT INTO `emails` (`id`, `company_id`, `smtp_config_id`, `to_email`, `from_email`, `cc_email`, `subject`, `status`, `details`, `sent_at`, `active`, `is_archived`, `is_star`, `is_deleted`, `created_at`) VALUES ('1', '1', '1', 'nelson.salvador@gmail.com', 'noreply@example.com', '', 'Test Email from IT Manager Pro', 'sent', NULL, '2026-06-18 02:06:00', '1', '0', '0', '0', '2026-06-18 02:06:00');
...
SELECT e.`company_id`, e.`id`, 'left', 'left', 'left', 'left', 0, 1, 1, 0, '25', '⚙️ IT Controls', CONCAT('images/favicons/company_', e.`company_id`, '.ico'), '{"is_access_point":1, "is_cctv":1, "is_firewall":1, "is_other":1, "is_phone":1, "is_port_patch_panel":1, "is_printer":1, "is_router":1, "is_server":1, "is_switch":1, "is_workstation":1}', '2026-01-01 00:00:01', NULL
FROM `employees` e
WHERE e.`username` LIKE 'Admin%';
...
INSERT INTO `modules_registry` (`module_slug`, `module_name`, `is_system_module`, `active`, `icon`) VALUES ("hotel_booking_room_type_calendar", "Room Type Calendar", 0, 1, "📆");
...
INSERT IGNORE INTO `hotel_booking_settings` (`company_id`, `public_portal_enabled`, `welcome_title`, `welcome_subtitle`, `price_footnote`, `reviews_url`, `tourist_tax_per_person_per_night`, `free_cancellation_days_before_check_in`, `calendar_month_advance_days_left`, `show_discount_strikethrough`, `portal_accessible_banner_enabled`, `portal_accessibility_options_enabled`, `urlaccessibilitypep`, `urlmybooking`, `active`, `created_at`) SELECT c.`id`, t.`public_portal_enabled`, t.`welcome_title`, t.`welcome_subtitle`, t.`price_footnote`, t.`reviews_url`, t.`tourist_tax_per_person_per_night`, t.`free_cancellation_days_before_check_in`, t.`calendar_month_advance_days_left`, t.`show_discount_strikethrough`, t.`portal_accessible_banner_enabled`, t.`portal_accessibility_options_enabled`, t.`urlaccessibilitypep`, t.`urlmybooking`, t.`active`, '2026-01-01 00:00:01' FROM `hotel_booking_settings` t JOIN `companies` c ON c.`id` <> t.`company_id` WHERE t.`company_id` = 1;
...
SELECT c.`id`, CONCAT('TechCorp Retreat (', c.`company`, ')'), t.`description`, t.`location`, CONCAT('+351 210 000 00', c.`id`), CONCAT('info@retreat.', LOWER(REPLACE(c.`company`, ' ', '')), '.example'), CONCAT('reservations@retreat.', LOWER(REPLACE(c.`company`, ' ', '')), '.example'), t.`website_url`, t.`reviews_url`, t.`check_in_time`, t.`check_out_time`, t.`currency_code`, t.`parking_info`, t.`pets_policy`, 1, '2026-01-01 00:00:01'
FROM `companies` c
...
SELECT h.`company_id`, h.`id`, rt.`id`,
  CASE rt.`code`
    WHEN 'DLX' THEN 120.00
    WHEN 'SUP' THEN 95.00
    WHEN 'STD' THEN 75.00
    WHEN 'POOL' THEN 145.00
    ELSE 0.00
  END,
  1, '2026-01-01 00:00:01'
FROM `hotel_booking_hotels` h
INNER JOIN `booking_rooms_types` rt ON rt.`company_id` = h.`company_id` AND rt.`deleted_at` IS NULL
WHERE h.`company_id` BETWEEN 2 AND 5 AND h.`deleted_at` IS NULL;

-- Distribution channels (3 per tenant) — demo API keys itm_hbd_seed_demo_c{company}{slot} (see includes/itm_hotel_booking_distribution_seed.php).
INSERT INTO `hotel_booking_distribution_channels` (`company_id`, `channel_code`, `name`, `standard`, `api_key_prefix`, `api_key_hash`, `partner_property_id`, `partner_sandbox_mode`, `hourly_rate_limit`, `active`, `created_at`) VALUES
(1, 'itm_demo', 'ITM Demo Channel', 'itm_native', 'itm_hbd_seed_dem', '$2y$10$azYgPlW7lxMUNQQsS1qveurtHepVpBLbnEcmPsJbKXre55Qs7hVsG', NULL, 0, 1000, 1, '2026-01-01 00:00:01'),
(1, 'booking_com', 'Booking.com Sandbox', 'booking_com', 'itm_hbd_seed_dem', '$2y$10$OqTT6orHkn/A/q.jFZgHAuiIUKIfVMu5vp6hyOO2FyMenIIqFcwd6', 'DEMO-PROP-1', 1, 1000, 1, '2026-01-01 00:00:01'),
(1, 'opentravel', 'OpenTravel OTA', 'opentravel', 'itm_hbd_seed_dem', '$2y$10$0pQ4yM91dTG2vsJQOulPCeE5VLAcBSVbWVI4JWR9UoEOXJniSLK66', NULL, 0, 1000, 1, '2026-01-01 00:00:01'),
(2, 'itm_demo', 'ITM Demo Channel', 'itm_native', 'itm_hbd_seed_dem', '$2y$10$t7vcGJU3WGPgkl1RmU4aQekM5nrw66RIuDOorcOZjpitjlc0YKUGO', NULL, 0, 1000, 1, '2026-01-01 00:00:01'),
(2, 'booking_com', 'Booking.com Sandbox', 'booking_com', 'itm_hbd_seed_dem', '$2y$10$rvrhIGj0nop0iekJmsJ6.eUPv7KoPbODT1L5ERVoTk2GVoGRXliXG', 'DEMO-PROP-2', 1, 1000, 1, '2026-01-01 00:00:01'),
(2, 'opentravel', 'OpenTravel OTA', 'opentravel', 'itm_hbd_seed_dem', '$2y$10$.mFUjLixsRZDDl1dhJ1oJ.ASGrLYAttQBvbll1WBEoLbgYyhxuB9q', NULL, 0, 1000, 1, '2026-01-01 00:00:01'),
(3, 'itm_demo', 'ITM Demo Channel', 'itm_native', 'itm_hbd_seed_dem', '$2y$10$1P1n9SBhy3jRn0i3GdiKa.2C.clDCpVDfaGf2oN6lnpsY/p1Ys1cm', NULL, 0, 1000, 1, '2026-01-01 00:00:01'),
(3, 'booking_com', 'Booking.com Sandbox', 'booking_com', 'itm_hbd_seed_dem', '$2y$10$LZGTzysMAqLzaSsGQDAZiumjDHMrWcBD6m//BAHHXvOlpiFvNOEOO', 'DEMO-PROP-3', 1, 1000, 1, '2026-01-01 00:00:01'),
(3, 'opentravel', 'OpenTravel OTA', 'opentravel', 'itm_hbd_seed_dem', '$2y$10$ol1cA91ePYl/mbOOxr/1Ser2TPJyakvcSLo5i.CoH.T.P4oFkDdES', NULL, 0, 1000, 1, '2026-01-01 00:00:01'),
(4, 'itm_demo', 'ITM Demo Channel', 'itm_native', 'itm_hbd_seed_dem', '$2y$10$IZHn9rh3IXjzLz2byw3G0u/Oce0GDegnMlp9h/pZ8G5BsHjkxMkcS', NULL, 0, 1000, 1, '2026-01-01 00:00:01'),
(4, 'booking_com', 'Booking.com Sandbox', 'booking_com', 'itm_hbd_seed_dem', '$2y$10$mQz.rIxgQN9r/GiW9Cw9JeL41OzzJwsLTJGMDEwoNcQ90LQzUt3V2', 'DEMO-PROP-4', 1, 1000, 1, '2026-01-01 00:00:01'),
(4, 'opentravel', 'OpenTravel OTA', 'opentravel', 'itm_hbd_seed_dem', '$2y$10$iWCFzIZqf2uGol9bIE83KuNk5KD1/P2kzH1joWlL0VINXVXRJhYTu', NULL, 0, 1000, 1, '2026-01-01 00:00:01'),
...
FROM `hotel_booking_distribution_channels` ch
INNER JOIN `hotel_booking_hotels` h ON h.`company_id` = ch.`company_id` AND h.`deleted_at` IS NULL AND h.`active` = 1
WHERE ch.`channel_code` IN ('itm_demo', 'booking_com', 'opentravel') AND ch.`deleted_at` IS NULL;

INSERT INTO `hotel_booking_distribution_mappings` (`company_id`, `channel_id`, `entity_type`, `internal_id`, `external_code`, `active`, `created_at`)
SELECT ch.`company_id`, ch.`id`, 'room_type', rt.`id`, rt.`code`, 1, '2026-01-01 00:00:01'
FROM `hotel_booking_distribution_channels` ch
INNER JOIN `booking_rooms_types` rt ON rt.`company_id` = ch.`company_id` AND rt.`deleted_at` IS NULL AND rt.`active` = 1
WHERE ch.`channel_code` IN ('itm_demo', 'booking_com', 'opentravel') AND ch.`deleted_at` IS NULL;

INSERT INTO `hotel_booking_distribution_rate_plan_mappings` (`company_id`, `channel_id`, `hotel_id`, `portal_rate_plan_id`, `external_rate_plan_code`, `min_los`, `max_los`, `price_multiplier`, `active`, `created_at`)
SELECT ch.`company_id`, ch.`id`, rp.`hotel_id`, rp.`id`, CONCAT('RP', rp.`plan_slot`), 1, NULL, 1.00, 1, '2026-01-01 00:00:01'
FROM `hotel_booking_distribution_channels` ch
INNER JOIN `hotel_booking_portal_rate_plans` rp ON rp.`company_id` = ch.`company_id` AND rp.`deleted_at` IS NULL AND rp.`active` = 1
WHERE ch.`channel_code` = 'booking_com' AND ch.`deleted_at` IS NULL;
