...
DROP TRIGGER IF EXISTS `trg_appointment_type_audit_insert`;
DROP TRIGGER IF EXISTS `trg_appointment_type_audit_update`;
DROP TRIGGER IF EXISTS `trg_appointment_type_audit_delete`;
...
CREATE TRIGGER `trg_appointment_type_audit_insert` AFTER INSERT ON `appointment_type` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'appointment_type', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'name', NEW.`name`, 'label', NEW.`label`, 'active', NEW.`active`, 'deleted_by', NEW.`deleted_by`, 'deleted_at', NEW.`deleted_at`, 'created_by', NEW.`created_by`, 'created_at', NEW.`created_at`, 'updated_by', NEW.`updated_by`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_appointment_type_audit_update` AFTER UPDATE ON `appointment_type` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'appointment_type', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'name', OLD.`name`, 'label', OLD.`label`, 'active', OLD.`active`, 'deleted_by', OLD.`deleted_by`, 'deleted_at', OLD.`deleted_at`, 'created_by', OLD.`created_by`, 'created_at', OLD.`created_at`, 'updated_by', OLD.`updated_by`, 'updated_at', OLD.`updated_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'name', NEW.`name`, 'label', NEW.`label`, 'active', NEW.`active`, 'deleted_by', NEW.`deleted_by`, 'deleted_at', NEW.`deleted_at`, 'created_by', NEW.`created_by`, 'created_at', NEW.`created_at`, 'updated_by', NEW.`updated_by`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_appointment_type_audit_delete` AFTER DELETE ON `appointment_type` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'appointment_type', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'name', OLD.`name`, 'label', OLD.`label`, 'active', OLD.`active`, 'deleted_by', OLD.`deleted_by`, 'deleted_at', OLD.`deleted_at`, 'created_by', OLD.`created_by`, 'created_at', OLD.`created_at`, 'updated_by', OLD.`updated_by`, 'updated_at', OLD.`updated_at`), NULL, @app_ip_address, @app_user_agent);
END$$
...
CREATE TRIGGER `trg_appointments_audit_insert` AFTER INSERT ON `appointments` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'appointments', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'employee_id', NEW.`employee_id`, 'visit_reason_id', NEW.`visit_reason_id`, 'appointment_date', NEW.`appointment_date`, 'start_time', NEW.`start_time`, 'end_time', NEW.`end_time`, 'appointment_type_id', NEW.`appointment_type_id`, 'status', NEW.`status`, 'timezone', NEW.`timezone`, 'booking_lock', NEW.`booking_lock`, 'active', NEW.`active`, 'deleted_by', NEW.`deleted_by`, 'deleted_at', NEW.`deleted_at`, 'created_by', NEW.`created_by`, 'created_at', NEW.`created_at`, 'updated_by', NEW.`updated_by`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_appointments_audit_update` AFTER UPDATE ON `appointments` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'appointments', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'employee_id', OLD.`employee_id`, 'visit_reason_id', OLD.`visit_reason_id`, 'appointment_date', OLD.`appointment_date`, 'start_time', OLD.`start_time`, 'end_time', OLD.`end_time`, 'appointment_type_id', OLD.`appointment_type_id`, 'status', OLD.`status`, 'timezone', OLD.`timezone`, 'booking_lock', OLD.`booking_lock`, 'active', OLD.`active`, 'deleted_by', OLD.`deleted_by`, 'deleted_at', OLD.`deleted_at`, 'created_by', OLD.`created_by`, 'created_at', OLD.`created_at`, 'updated_by', OLD.`updated_by`, 'updated_at', OLD.`updated_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'employee_id', NEW.`employee_id`, 'visit_reason_id', NEW.`visit_reason_id`, 'appointment_date', NEW.`appointment_date`, 'start_time', NEW.`start_time`, 'end_time', NEW.`end_time`, 'appointment_type_id', NEW.`appointment_type_id`, 'status', NEW.`status`, 'timezone', NEW.`timezone`, 'booking_lock', NEW.`booking_lock`, 'active', NEW.`active`, 'deleted_by', NEW.`deleted_by`, 'deleted_at', NEW.`deleted_at`, 'created_by', NEW.`created_by`, 'created_at', NEW.`created_at`, 'updated_by', NEW.`updated_by`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$
...
DROP TRIGGER IF EXISTS `trg_software_audit_insert`;

DROP TRIGGER IF EXISTS `trg_software_audit_update`;

DROP TRIGGER IF EXISTS `trg_software_audit_delete`;

DELIMITER $$

CREATE TRIGGER `trg_software_audit_insert` AFTER INSERT ON `software` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'software', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'name', NEW.`name`, 'build', NEW.`build`, 'eol_date', NEW.`eol_date`, 'extended_date', NEW.`extended_date`, 'esu_date', NEW.`esu_date`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_software_audit_update` AFTER UPDATE ON `software` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'software', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'name', OLD.`name`, 'build', OLD.`build`, 'eol_date', OLD.`eol_date`, 'extended_date', OLD.`extended_date`, 'esu_date', OLD.`esu_date`, 'active', OLD.`active`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'name', NEW.`name`, 'build', NEW.`build`, 'eol_date', NEW.`eol_date`, 'extended_date', NEW.`extended_date`, 'esu_date', NEW.`esu_date`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_software_audit_delete` AFTER DELETE ON `software` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'software', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'name', OLD.`name`, 'build', OLD.`build`, 'eol_date', OLD.`eol_date`, 'extended_date', OLD.`extended_date`, 'esu_date', OLD.`esu_date`, 'active', OLD.`active`), NULL, @app_ip_address, @app_user_agent);
END$$

DELIMITER ;

DROP TRIGGER IF EXISTS `trg_equipment_software_audit_insert`;

DROP TRIGGER IF EXISTS `trg_equipment_software_audit_update`;

DROP TRIGGER IF EXISTS `trg_equipment_software_audit_delete`;

DELIMITER $$

CREATE TRIGGER `trg_equipment_software_audit_insert` AFTER INSERT ON `equipment_software` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'equipment_software', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'equipment_id', NEW.`equipment_id`, 'software_id', NEW.`software_id`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_equipment_software_audit_update` AFTER UPDATE ON `equipment_software` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'equipment_software', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'equipment_id', OLD.`equipment_id`, 'software_id', OLD.`software_id`, 'active', OLD.`active`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'equipment_id', NEW.`equipment_id`, 'software_id', NEW.`software_id`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_equipment_software_audit_delete` AFTER DELETE ON `equipment_software` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'equipment_software', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'equipment_id', OLD.`equipment_id`, 'software_id', OLD.`software_id`, 'active', OLD.`active`), NULL, @app_ip_address, @app_user_agent);
END$$
...
DROP TRIGGER IF EXISTS `trg_background_jobs_audit_insert`;

DROP TRIGGER IF EXISTS `trg_background_jobs_audit_update`;

DROP TRIGGER IF EXISTS `trg_background_jobs_audit_delete`;

DELIMITER $$

CREATE TRIGGER `trg_background_jobs_audit_insert` AFTER INSERT ON `background_jobs` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'background_jobs', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'job_type', NEW.`job_type`, 'status', NEW.`status`, 'progress_offset', NEW.`progress_offset`, 'progress_total', NEW.`progress_total`, 'attempt_count', NEW.`attempt_count`, 'max_attempts', NEW.`max_attempts`, 'active', NEW.`active`, 'created_at', NEW.`created_at`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_background_jobs_audit_update` AFTER UPDATE ON `background_jobs` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'background_jobs', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'job_type', OLD.`job_type`, 'status', OLD.`status`, 'progress_offset', OLD.`progress_offset`, 'progress_total', OLD.`progress_total`, 'attempt_count', OLD.`attempt_count`, 'max_attempts', OLD.`max_attempts`, 'active', OLD.`active`, 'created_at', OLD.`created_at`, 'updated_at', OLD.`updated_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'job_type', NEW.`job_type`, 'status', NEW.`status`, 'progress_offset', NEW.`progress_offset`, 'progress_total', NEW.`progress_total`, 'attempt_count', NEW.`attempt_count`, 'max_attempts', NEW.`max_attempts`, 'active', NEW.`active`, 'created_at', NEW.`created_at`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_background_jobs_audit_delete` AFTER DELETE ON `background_jobs` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'background_jobs', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'job_type', OLD.`job_type`, 'status', OLD.`status`, 'progress_offset', OLD.`progress_offset`, 'progress_total', OLD.`progress_total`, 'attempt_count', OLD.`attempt_count`, 'max_attempts', OLD.`max_attempts`, 'active', OLD.`active`, 'created_at', OLD.`created_at`, 'updated_at', OLD.`updated_at`), NULL, @app_ip_address, @app_user_agent);
END$$
...
DROP TRIGGER IF EXISTS `trg_expense_recurrence_audit_insert`;
DROP TRIGGER IF EXISTS `trg_expense_recurrence_audit_update`;
DROP TRIGGER IF EXISTS `trg_expense_recurrence_audit_delete`;
DROP TRIGGER IF EXISTS `trg_customer_statuses_audit_insert`;
DROP TRIGGER IF EXISTS `trg_customer_statuses_audit_update`;
DROP TRIGGER IF EXISTS `trg_customer_statuses_audit_delete`;

CREATE TRIGGER `trg_expense_recurrence_audit_insert` AFTER INSERT ON `expense_recurrence` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'expense_recurrence', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'name', NEW.`name`, 'code', NEW.`code`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_expense_recurrence_audit_update` AFTER UPDATE ON `expense_recurrence` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'expense_recurrence', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'name', OLD.`name`, 'code', OLD.`code`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'name', NEW.`name`, 'code', NEW.`code`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_expense_recurrence_audit_delete` AFTER DELETE ON `expense_recurrence` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'expense_recurrence', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'name', OLD.`name`, 'code', OLD.`code`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_customer_statuses_audit_insert` AFTER INSERT ON `customer_statuses` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'customer_statuses', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'name', NEW.`name`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_customer_statuses_audit_update` AFTER UPDATE ON `customer_statuses` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'customer_statuses', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'name', OLD.`name`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'name', NEW.`name`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_customer_statuses_audit_delete` AFTER DELETE ON `customer_statuses` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'customer_statuses', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'name', OLD.`name`), NULL, @app_ip_address, @app_user_agent);
END$$
...
DROP TRIGGER IF EXISTS `trg_customers_audit_insert`;
DROP TRIGGER IF EXISTS `trg_customers_audit_update`;
DROP TRIGGER IF EXISTS `trg_customers_audit_delete`;
DROP TRIGGER IF EXISTS `trg_finance_payment_allocations_audit_insert`;
DROP TRIGGER IF EXISTS `trg_finance_payment_allocations_audit_update`;
DROP TRIGGER IF EXISTS `trg_finance_payment_allocations_audit_delete`;

CREATE TRIGGER `trg_customers_audit_insert` AFTER INSERT ON `customers` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'customers', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'name', NEW.`name`, 'customer_code', NEW.`customer_code`, 'contact_person', NEW.`contact_person`, 'email', NEW.`email`, 'phone', NEW.`phone`, 'status_id', NEW.`status_id`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_customers_audit_update` AFTER UPDATE ON `customers` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'customers', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'name', OLD.`name`, 'customer_code', OLD.`customer_code`, 'status_id', OLD.`status_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'name', NEW.`name`, 'customer_code', NEW.`customer_code`, 'status_id', NEW.`status_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_customers_audit_delete` AFTER DELETE ON `customers` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'customers', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'name', OLD.`name`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_finance_payment_allocations_audit_insert` AFTER INSERT ON `finance_payment_allocations` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'finance_payment_allocations', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'amount', NEW.`amount`, 'bill_id', NEW.`bill_id`, 'invoice_id', NEW.`invoice_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_finance_payment_allocations_audit_update` AFTER UPDATE ON `finance_payment_allocations` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'finance_payment_allocations', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'amount', OLD.`amount`), JSON_OBJECT('id', NEW.`id`, 'amount', NEW.`amount`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_finance_payment_allocations_audit_delete` AFTER DELETE ON `finance_payment_allocations` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
...
DROP TRIGGER IF EXISTS `trg_automation_rules_audit_insert`;

DROP TRIGGER IF EXISTS `trg_automation_rules_audit_update`;

DROP TRIGGER IF EXISTS `trg_automation_rules_audit_delete`;

DROP TRIGGER IF EXISTS `trg_automation_rule_runs_audit_insert`;

DROP TRIGGER IF EXISTS `trg_automation_rule_runs_audit_update`;

DROP TRIGGER IF EXISTS `trg_automation_rule_runs_audit_delete`;

DELIMITER $$

CREATE TRIGGER `trg_automation_rules_audit_insert` AFTER INSERT ON `automation_rules` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'automation_rules', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'name', NEW.`name`, 'trigger_slug', NEW.`trigger_slug`, 'enabled', NEW.`enabled`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_automation_rules_audit_update` AFTER UPDATE ON `automation_rules` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'automation_rules', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'name', OLD.`name`, 'trigger_slug', OLD.`trigger_slug`, 'enabled', OLD.`enabled`, 'active', OLD.`active`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'name', NEW.`name`, 'trigger_slug', NEW.`trigger_slug`, 'enabled', NEW.`enabled`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_automation_rules_audit_delete` AFTER DELETE ON `automation_rules` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'automation_rules', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'name', OLD.`name`, 'trigger_slug', OLD.`trigger_slug`, 'enabled', OLD.`enabled`, 'active', OLD.`active`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_automation_rule_runs_audit_insert` AFTER INSERT ON `automation_rule_runs` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'automation_rule_runs', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'rule_id', NEW.`rule_id`, 'status', NEW.`status`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_automation_rule_runs_audit_update` AFTER UPDATE ON `automation_rule_runs` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'automation_rule_runs', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'rule_id', OLD.`rule_id`, 'status', OLD.`status`, 'active', OLD.`active`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'rule_id', NEW.`rule_id`, 'status', NEW.`status`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_automation_rule_runs_audit_delete` AFTER DELETE ON `automation_rule_runs` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'automation_rule_runs', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'rule_id', OLD.`rule_id`, 'status', OLD.`status`, 'active', OLD.`active`), NULL, @app_ip_address, @app_user_agent);
END$$
...
CREATE TRIGGER `trg_tickets_audit_insert` AFTER INSERT ON `tickets` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'tickets', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'ticket_external_code', NEW.`ticket_external_code`, 'title', NEW.`title`, 'description', NEW.`description`, 'category_id', NEW.`category_id`, 'status_id', NEW.`status_id`, 'priority_id', NEW.`priority_id`, 'created_by_employee_id', NEW.`created_by_employee_id`, 'assigned_to_employee_id', NEW.`assigned_to_employee_id`, 'equipment_id', NEW.`equipment_id`, 'due_date', NEW.`due_date`, 'first_response_at', NEW.`first_response_at`, 'resolved_at', NEW.`resolved_at`, 'sla_response_due_at', NEW.`sla_response_due_at`, 'sla_resolve_due_at', NEW.`sla_resolve_due_at`, 'sla_response_breached_at', NEW.`sla_response_breached_at`, 'sla_resolve_breached_at', NEW.`sla_resolve_breached_at`, 'is_archived', NEW.`is_archived`, 'merged_into_ticket_id', NEW.`merged_into_ticket_id`, 'csat_score', NEW.`csat_score`, 'csat_comment', NEW.`csat_comment`, 'csat_submitted_at', NEW.`csat_submitted_at`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_tickets_audit_update` AFTER UPDATE ON `tickets` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'tickets', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'ticket_external_code', OLD.`ticket_external_code`, 'title', OLD.`title`, 'description', OLD.`description`, 'category_id', OLD.`category_id`, 'status_id', OLD.`status_id`, 'priority_id', OLD.`priority_id`, 'created_by_employee_id', OLD.`created_by_employee_id`, 'assigned_to_employee_id', OLD.`assigned_to_employee_id`, 'equipment_id', OLD.`equipment_id`, 'due_date', OLD.`due_date`, 'first_response_at', OLD.`first_response_at`, 'resolved_at', OLD.`resolved_at`, 'sla_response_due_at', OLD.`sla_response_due_at`, 'sla_resolve_due_at', OLD.`sla_resolve_due_at`, 'sla_response_breached_at', OLD.`sla_response_breached_at`, 'sla_resolve_breached_at', OLD.`sla_resolve_breached_at`, 'is_archived', OLD.`is_archived`, 'merged_into_ticket_id', OLD.`merged_into_ticket_id`, 'csat_score', OLD.`csat_score`, 'csat_comment', OLD.`csat_comment`, 'csat_submitted_at', OLD.`csat_submitted_at`, 'created_at', OLD.`created_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'ticket_external_code', NEW.`ticket_external_code`, 'title', NEW.`title`, 'description', NEW.`description`, 'category_id', NEW.`category_id`, 'status_id', NEW.`status_id`, 'priority_id', NEW.`priority_id`, 'created_by_employee_id', NEW.`created_by_employee_id`, 'assigned_to_employee_id', NEW.`assigned_to_employee_id`, 'equipment_id', NEW.`equipment_id`, 'due_date', NEW.`due_date`, 'first_response_at', NEW.`first_response_at`, 'resolved_at', NEW.`resolved_at`, 'sla_response_due_at', NEW.`sla_response_due_at`, 'sla_resolve_due_at', NEW.`sla_resolve_due_at`, 'sla_response_breached_at', NEW.`sla_response_breached_at`, 'sla_resolve_breached_at', NEW.`sla_resolve_breached_at`, 'is_archived', NEW.`is_archived`, 'merged_into_ticket_id', NEW.`merged_into_ticket_id`, 'csat_score', NEW.`csat_score`, 'csat_comment', NEW.`csat_comment`, 'csat_submitted_at', NEW.`csat_submitted_at`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_tickets_audit_delete` AFTER DELETE ON `tickets` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'tickets', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'ticket_external_code', OLD.`ticket_external_code`, 'title', OLD.`title`, 'description', OLD.`description`, 'category_id', OLD.`category_id`, 'status_id', OLD.`status_id`, 'priority_id', OLD.`priority_id`, 'created_by_employee_id', OLD.`created_by_employee_id`, 'assigned_to_employee_id', OLD.`assigned_to_employee_id`, 'equipment_id', OLD.`equipment_id`, 'due_date', OLD.`due_date`, 'first_response_at', OLD.`first_response_at`, 'resolved_at', OLD.`resolved_at`, 'sla_response_due_at', OLD.`sla_response_due_at`, 'sla_resolve_due_at', OLD.`sla_resolve_due_at`, 'sla_response_breached_at', OLD.`sla_response_breached_at`, 'sla_resolve_breached_at', OLD.`sla_resolve_breached_at`, 'is_archived', OLD.`is_archived`, 'merged_into_ticket_id', OLD.`merged_into_ticket_id`, 'csat_score', OLD.`csat_score`, 'csat_comment', OLD.`csat_comment`, 'csat_submitted_at', OLD.`csat_submitted_at`, 'created_at', OLD.`created_at`), NULL, @app_ip_address, @app_user_agent);
END$$
...
CREATE TRIGGER `trg_employee_roles_audit_insert` AFTER INSERT ON `employee_roles` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'employee_roles', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'name', NEW.`name`, 'sidebar_show', NEW.`sidebar_show`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_employee_roles_audit_update` AFTER UPDATE ON `employee_roles` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'employee_roles', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'name', OLD.`name`, 'sidebar_show', OLD.`sidebar_show`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'name', NEW.`name`, 'sidebar_show', NEW.`sidebar_show`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_employee_roles_audit_delete` AFTER DELETE ON `employee_roles` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'employee_roles', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'name', OLD.`name`, 'sidebar_show', OLD.`sidebar_show`), NULL, @app_ip_address, @app_user_agent);
END$$
...
DROP TRIGGER IF EXISTS `trg_configuration_item_types_audit_insert`;

DROP TRIGGER IF EXISTS `trg_configuration_item_types_audit_update`;

DROP TRIGGER IF EXISTS `trg_configuration_item_types_audit_delete`;

DELIMITER $$

CREATE TRIGGER `trg_configuration_item_types_audit_insert` AFTER INSERT ON `configuration_item_types` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'configuration_item_types', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'name', NEW.`name`, 'source_slug', NEW.`source_slug`, 'icon', NEW.`icon`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_configuration_item_types_audit_update` AFTER UPDATE ON `configuration_item_types` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'configuration_item_types', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'name', OLD.`name`, 'source_slug', OLD.`source_slug`, 'icon', OLD.`icon`, 'active', OLD.`active`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'name', NEW.`name`, 'source_slug', NEW.`source_slug`, 'icon', NEW.`icon`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_configuration_item_types_audit_delete` AFTER DELETE ON `configuration_item_types` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'configuration_item_types', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'name', OLD.`name`, 'source_slug', OLD.`source_slug`, 'icon', OLD.`icon`, 'active', OLD.`active`), NULL, @app_ip_address, @app_user_agent);
END$$

DELIMITER ;

DROP TRIGGER IF EXISTS `trg_configuration_items_audit_insert`;

DROP TRIGGER IF EXISTS `trg_configuration_items_audit_update`;

DROP TRIGGER IF EXISTS `trg_configuration_items_audit_delete`;

DELIMITER $$

CREATE TRIGGER `trg_configuration_items_audit_insert` AFTER INSERT ON `configuration_items` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'configuration_items', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'ci_type_id', NEW.`ci_type_id`, 'name', NEW.`name`, 'external_ref', NEW.`external_ref`, 'record_module_slug', NEW.`record_module_slug`, 'record_id', NEW.`record_id`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_configuration_items_audit_update` AFTER UPDATE ON `configuration_items` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'configuration_items', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'ci_type_id', OLD.`ci_type_id`, 'name', OLD.`name`, 'external_ref', OLD.`external_ref`, 'record_module_slug', OLD.`record_module_slug`, 'record_id', OLD.`record_id`, 'active', OLD.`active`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'ci_type_id', NEW.`ci_type_id`, 'name', NEW.`name`, 'external_ref', NEW.`external_ref`, 'record_module_slug', NEW.`record_module_slug`, 'record_id', NEW.`record_id`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_configuration_items_audit_delete` AFTER DELETE ON `configuration_items` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'configuration_items', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'ci_type_id', OLD.`ci_type_id`, 'name', OLD.`name`, 'external_ref', OLD.`external_ref`, 'record_module_slug', OLD.`record_module_slug`, 'record_id', OLD.`record_id`, 'active', OLD.`active`), NULL, @app_ip_address, @app_user_agent);
END$$

DELIMITER ;

DROP TRIGGER IF EXISTS `trg_configuration_item_relationships_audit_insert`;

DROP TRIGGER IF EXISTS `trg_configuration_item_relationships_audit_update`;

DROP TRIGGER IF EXISTS `trg_configuration_item_relationships_audit_delete`;

DELIMITER $$

CREATE TRIGGER `trg_configuration_item_relationships_audit_insert` AFTER INSERT ON `configuration_item_relationships` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'configuration_item_relationships', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'parent_ci_id', NEW.`parent_ci_id`, 'child_ci_id', NEW.`child_ci_id`, 'relationship_type', NEW.`relationship_type`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_configuration_item_relationships_audit_update` AFTER UPDATE ON `configuration_item_relationships` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'configuration_item_relationships', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'parent_ci_id', OLD.`parent_ci_id`, 'child_ci_id', OLD.`child_ci_id`, 'relationship_type', OLD.`relationship_type`, 'active', OLD.`active`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'parent_ci_id', NEW.`parent_ci_id`, 'child_ci_id', NEW.`child_ci_id`, 'relationship_type', NEW.`relationship_type`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_configuration_item_relationships_audit_delete` AFTER DELETE ON `configuration_item_relationships` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'configuration_item_relationships', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'parent_ci_id', OLD.`parent_ci_id`, 'child_ci_id', OLD.`child_ci_id`, 'relationship_type', OLD.`relationship_type`, 'active', OLD.`active`), NULL, @app_ip_address, @app_user_agent);
END$$
...
DROP TRIGGER IF EXISTS `trg_change_request_cab_members_audit_insert`;

DROP TRIGGER IF EXISTS `trg_change_request_cab_members_audit_update`;

DROP TRIGGER IF EXISTS `trg_change_request_cab_members_audit_delete`;

DELIMITER $$

CREATE TRIGGER `trg_change_request_cab_members_audit_insert` AFTER INSERT ON `change_request_cab_members` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'change_request_cab_members', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'employee_id', NEW.`employee_id`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_change_request_cab_members_audit_update` AFTER UPDATE ON `change_request_cab_members` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'change_request_cab_members', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'employee_id', OLD.`employee_id`, 'active', OLD.`active`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'employee_id', NEW.`employee_id`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_change_request_cab_members_audit_delete` AFTER DELETE ON `change_request_cab_members` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'change_request_cab_members', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'employee_id', OLD.`employee_id`, 'active', OLD.`active`), NULL, @app_ip_address, @app_user_agent);
END$$

DELIMITER ;

DROP TRIGGER IF EXISTS `trg_change_request_approvals_audit_insert`;

DROP TRIGGER IF EXISTS `trg_change_request_approvals_audit_update`;

DROP TRIGGER IF EXISTS `trg_change_request_approvals_audit_delete`;

DELIMITER $$

CREATE TRIGGER `trg_change_request_approvals_audit_insert` AFTER INSERT ON `change_request_approvals` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'change_request_approvals', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'change_request_id', NEW.`change_request_id`, 'approver_employee_id', NEW.`approver_employee_id`, 'decision', NEW.`decision`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_change_request_approvals_audit_update` AFTER UPDATE ON `change_request_approvals` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'change_request_approvals', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'change_request_id', OLD.`change_request_id`, 'approver_employee_id', OLD.`approver_employee_id`, 'decision', OLD.`decision`, 'active', OLD.`active`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'change_request_id', NEW.`change_request_id`, 'approver_employee_id', NEW.`approver_employee_id`, 'decision', NEW.`decision`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_change_request_approvals_audit_delete` AFTER DELETE ON `change_request_approvals` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'change_request_approvals', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'change_request_id', OLD.`change_request_id`, 'approver_employee_id', OLD.`approver_employee_id`, 'decision', OLD.`decision`, 'active', OLD.`active`), NULL, @app_ip_address, @app_user_agent);
END$$

DELIMITER ;

DROP TRIGGER IF EXISTS `trg_change_request_settings_audit_insert`;

DROP TRIGGER IF EXISTS `trg_change_request_settings_audit_update`;

DROP TRIGGER IF EXISTS `trg_change_request_settings_audit_delete`;

DELIMITER $$

CREATE TRIGGER `trg_change_request_settings_audit_insert` AFTER INSERT ON `change_request_settings` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'change_request_settings', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'reminder_days_before', NEW.`reminder_days_before`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_change_request_settings_audit_update` AFTER UPDATE ON `change_request_settings` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'change_request_settings', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'reminder_days_before', OLD.`reminder_days_before`, 'active', OLD.`active`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'reminder_days_before', NEW.`reminder_days_before`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_change_request_settings_audit_delete` AFTER DELETE ON `change_request_settings` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'change_request_settings', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'reminder_days_before', OLD.`reminder_days_before`, 'active', OLD.`active`), NULL, @app_ip_address, @app_user_agent);
END$$
...
CREATE TRIGGER `trg_workstation_office_audit_insert` AFTER INSERT ON `workstation_office` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'workstation_office', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'name', NEW.`name`, 'build', NEW.`build`, 'eol_date', NEW.`eol_date`, 'extended_date', NEW.`extended_date`, 'esu_date', NEW.`esu_date`), @app_ip_address, @app_user_agent);
END$$
...
CREATE TRIGGER `trg_workstation_office_audit_delete` AFTER DELETE ON `workstation_office` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'workstation_office', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'name', OLD.`name`, 'build', OLD.`build`, 'eol_date', OLD.`eol_date`, 'extended_date', OLD.`extended_date`, 'esu_date', OLD.`esu_date`), NULL, @app_ip_address, @app_user_agent);
END$$
...
CREATE TRIGGER `trg_workstation_os_versions_audit_insert` AFTER INSERT ON `workstation_os_versions` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'workstation_os_versions', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'name', NEW.`name`, 'build', NEW.`build`, 'eol_date', NEW.`eol_date`, 'extended_date', NEW.`extended_date`, 'esu_date', NEW.`esu_date`), @app_ip_address, @app_user_agent);
END$$
...
CREATE TRIGGER `trg_workstation_os_versions_audit_delete` AFTER DELETE ON `workstation_os_versions` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'workstation_os_versions', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'name', OLD.`name`, 'build', OLD.`build`, 'eol_date', OLD.`eol_date`, 'extended_date', OLD.`extended_date`, 'esu_date', OLD.`esu_date`), NULL, @app_ip_address, @app_user_agent);
END$$
...
DROP TRIGGER IF EXISTS `trg_approval_inbox_items_audit_insert`$$

CREATE TRIGGER `trg_approval_inbox_items_audit_insert` AFTER INSERT ON `approval_inbox_items` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'approval_inbox_items', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'module_slug', NEW.`module_slug`, 'record_id', NEW.`record_id`, 'approval_stage', NEW.`approval_stage`, 'title', NEW.`title`, 'requester_employee_id', NEW.`requester_employee_id`, 'assignee_employee_id', NEW.`assignee_employee_id`, 'status', NEW.`status`, 'due_at', NEW.`due_at`, 'action_url', NEW.`action_url`, 'active', NEW.`active`, 'created_by', NEW.`created_by`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_approval_inbox_items_audit_update`$$

CREATE TRIGGER `trg_approval_inbox_items_audit_update` AFTER UPDATE ON `approval_inbox_items` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'approval_inbox_items', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'module_slug', OLD.`module_slug`, 'record_id', OLD.`record_id`, 'approval_stage', OLD.`approval_stage`, 'title', OLD.`title`, 'requester_employee_id', OLD.`requester_employee_id`, 'assignee_employee_id', OLD.`assignee_employee_id`, 'status', OLD.`status`, 'due_at', OLD.`due_at`, 'action_url', OLD.`action_url`, 'active', OLD.`active`, 'updated_by', OLD.`updated_by`, 'updated_at', OLD.`updated_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'module_slug', NEW.`module_slug`, 'record_id', NEW.`record_id`, 'approval_stage', NEW.`approval_stage`, 'title', NEW.`title`, 'requester_employee_id', NEW.`requester_employee_id`, 'assignee_employee_id', NEW.`assignee_employee_id`, 'status', NEW.`status`, 'due_at', NEW.`due_at`, 'action_url', NEW.`action_url`, 'active', NEW.`active`, 'updated_by', NEW.`updated_by`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_approval_inbox_items_audit_delete`$$

CREATE TRIGGER `trg_approval_inbox_items_audit_delete` AFTER DELETE ON `approval_inbox_items` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'approval_inbox_items', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'module_slug', OLD.`module_slug`, 'record_id', OLD.`record_id`, 'approval_stage', OLD.`approval_stage`, 'title', OLD.`title`, 'requester_employee_id', OLD.`requester_employee_id`, 'assignee_employee_id', OLD.`assignee_employee_id`, 'status', OLD.`status`, 'due_at', OLD.`due_at`, 'action_url', OLD.`action_url`, 'active', OLD.`active`), NULL, @app_ip_address, @app_user_agent);
END$$
...
DROP TRIGGER IF EXISTS `trg_ticket_activity_audit_insert`$$
CREATE TRIGGER `trg_ticket_activity_audit_insert` AFTER INSERT ON `ticket_activity` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_activity', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'ticket_id', NEW.`ticket_id`, 'actor_employee_id', NEW.`actor_employee_id`, 'event_type', NEW.`event_type`, 'payload_json', NEW.`payload_json`, 'active', NEW.`active`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_ticket_activity_audit_update`$$
CREATE TRIGGER `trg_ticket_activity_audit_update` AFTER UPDATE ON `ticket_activity` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_activity', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'ticket_id', OLD.`ticket_id`, 'actor_employee_id', OLD.`actor_employee_id`, 'event_type', OLD.`event_type`, 'payload_json', OLD.`payload_json`, 'active', OLD.`active`, 'created_at', OLD.`created_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'ticket_id', NEW.`ticket_id`, 'actor_employee_id', NEW.`actor_employee_id`, 'event_type', NEW.`event_type`, 'payload_json', NEW.`payload_json`, 'active', NEW.`active`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_ticket_activity_audit_delete`$$
CREATE TRIGGER `trg_ticket_activity_audit_delete` AFTER DELETE ON `ticket_activity` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
...
CREATE TRIGGER `trg_problems_audit_delete` AFTER DELETE ON `problems` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'problems', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'title', OLD.`title`, 'status', OLD.`status`, 'owner_employee_id', OLD.`owner_employee_id`, 'knowledge_base_id', OLD.`knowledge_base_id`, 'active', OLD.`active`), NULL, @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_problem_ticket_links_audit_insert`$$
CREATE TRIGGER `trg_problem_ticket_links_audit_insert` AFTER INSERT ON `problem_ticket_links` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'problem_ticket_links', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'problem_id', NEW.`problem_id`, 'ticket_id', NEW.`ticket_id`, 'linked_by', NEW.`linked_by`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_problem_ticket_links_audit_update`$$
CREATE TRIGGER `trg_problem_ticket_links_audit_update` AFTER UPDATE ON `problem_ticket_links` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'problem_ticket_links', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'problem_id', OLD.`problem_id`, 'ticket_id', OLD.`ticket_id`, 'linked_by', OLD.`linked_by`, 'active', OLD.`active`, 'deleted_by', OLD.`deleted_by`, 'deleted_at', OLD.`deleted_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'problem_id', NEW.`problem_id`, 'ticket_id', NEW.`ticket_id`, 'linked_by', NEW.`linked_by`, 'active', NEW.`active`, 'deleted_by', NEW.`deleted_by`, 'deleted_at', NEW.`deleted_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_problem_ticket_links_audit_delete`$$
CREATE TRIGGER `trg_problem_ticket_links_audit_delete` AFTER DELETE ON `problem_ticket_links` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'problem_ticket_links', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'problem_id', OLD.`problem_id`, 'ticket_id', OLD.`ticket_id`, 'linked_by', OLD.`linked_by`, 'active', OLD.`active`), NULL, @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_known_errors_audit_insert`$$
CREATE TRIGGER `trg_known_errors_audit_insert` AFTER INSERT ON `known_errors` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'known_errors', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'problem_id', NEW.`problem_id`, 'title', NEW.`title`, 'knowledge_base_id', NEW.`knowledge_base_id`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_known_errors_audit_update`$$
CREATE TRIGGER `trg_known_errors_audit_update` AFTER UPDATE ON `known_errors` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'known_errors', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'problem_id', OLD.`problem_id`, 'title', OLD.`title`, 'knowledge_base_id', OLD.`knowledge_base_id`, 'active', OLD.`active`, 'deleted_by', OLD.`deleted_by`, 'deleted_at', OLD.`deleted_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'problem_id', NEW.`problem_id`, 'title', NEW.`title`, 'knowledge_base_id', NEW.`knowledge_base_id`, 'active', NEW.`active`, 'deleted_by', NEW.`deleted_by`, 'deleted_at', NEW.`deleted_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_known_errors_audit_delete`$$
...
CREATE TRIGGER `trg_ticket_comments_audit_insert` AFTER INSERT ON `ticket_comments` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_comments', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'ticket_id', NEW.`ticket_id`, 'employee_id', NEW.`employee_id`, 'body', NEW.`body`, 'is_internal', NEW.`is_internal`, 'active', NEW.`active`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_ticket_comments_audit_update`$$
CREATE TRIGGER `trg_ticket_comments_audit_update` AFTER UPDATE ON `ticket_comments` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_comments', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'ticket_id', OLD.`ticket_id`, 'employee_id', OLD.`employee_id`, 'body', OLD.`body`, 'is_internal', OLD.`is_internal`, 'active', OLD.`active`, 'created_at', OLD.`created_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'ticket_id', NEW.`ticket_id`, 'employee_id', NEW.`employee_id`, 'body', NEW.`body`, 'is_internal', NEW.`is_internal`, 'active', NEW.`active`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_ticket_comments_audit_delete`$$
CREATE TRIGGER `trg_ticket_comments_audit_delete` AFTER DELETE ON `ticket_comments` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_comments', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'ticket_id', OLD.`ticket_id`, 'employee_id', OLD.`employee_id`, 'body', OLD.`body`, 'is_internal', OLD.`is_internal`, 'active', OLD.`active`, 'created_at', OLD.`created_at`), NULL, @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_employee_notifications_audit_insert`$$
CREATE TRIGGER `trg_employee_notifications_audit_insert` AFTER INSERT ON `employee_notifications` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'employee_notifications', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'employee_id', NEW.`employee_id`, 'module_slug', NEW.`module_slug`, 'record_id', NEW.`record_id`, 'title', NEW.`title`, 'is_read', NEW.`is_read`, 'active', NEW.`active`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_employee_notifications_audit_update`$$
CREATE TRIGGER `trg_employee_notifications_audit_update` AFTER UPDATE ON `employee_notifications` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'employee_notifications', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'employee_id', OLD.`employee_id`, 'module_slug', OLD.`module_slug`, 'record_id', OLD.`record_id`, 'title', OLD.`title`, 'is_read', OLD.`is_read`, 'active', OLD.`active`, 'created_at', OLD.`created_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'employee_id', NEW.`employee_id`, 'module_slug', NEW.`module_slug`, 'record_id', NEW.`record_id`, 'title', NEW.`title`, 'is_read', NEW.`is_read`, 'active', NEW.`active`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_employee_notifications_audit_delete`$$
CREATE TRIGGER `trg_employee_notifications_audit_delete` AFTER DELETE ON `employee_notifications` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'employee_notifications', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'employee_id', OLD.`employee_id`, 'module_slug', OLD.`module_slug`, 'record_id', OLD.`record_id`, 'title', OLD.`title`, 'is_read', OLD.`is_read`, 'active', OLD.`active`, 'created_at', OLD.`created_at`), NULL, @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_ticket_sla_policies_audit_insert`$$
CREATE TRIGGER `trg_ticket_sla_policies_audit_insert` AFTER INSERT ON `ticket_sla_policies` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_sla_policies', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'priority_id', NEW.`priority_id`, 'response_minutes', NEW.`response_minutes`, 'resolve_minutes', NEW.`resolve_minutes`, 'active', NEW.`active`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_ticket_sla_policies_audit_update`$$
CREATE TRIGGER `trg_ticket_sla_policies_audit_update` AFTER UPDATE ON `ticket_sla_policies` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_sla_policies', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'priority_id', OLD.`priority_id`, 'response_minutes', OLD.`response_minutes`, 'resolve_minutes', OLD.`resolve_minutes`, 'active', OLD.`active`, 'created_at', OLD.`created_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'priority_id', NEW.`priority_id`, 'response_minutes', NEW.`response_minutes`, 'resolve_minutes', NEW.`resolve_minutes`, 'active', NEW.`active`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_ticket_sla_policies_audit_delete`$$
CREATE TRIGGER `trg_ticket_sla_policies_audit_delete` AFTER DELETE ON `ticket_sla_policies` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
...
DROP TRIGGER IF EXISTS `trg_ticket_settings_audit_insert`$$
CREATE TRIGGER `trg_ticket_settings_audit_insert` AFTER INSERT ON `ticket_settings` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_settings', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'auto_issue_survey_on_close', NEW.`auto_issue_survey_on_close`, 'survey_send_email_on_issue', NEW.`survey_send_email_on_issue`, 'sla_enabled_on_create', NEW.`sla_enabled_on_create`, 'active', NEW.`active`, 'deleted_by', NEW.`deleted_by`, 'deleted_at', NEW.`deleted_at`, 'created_by', NEW.`created_by`, 'created_at', NEW.`created_at`, 'updated_by', NEW.`updated_by`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_ticket_settings_audit_update`$$
CREATE TRIGGER `trg_ticket_settings_audit_update` AFTER UPDATE ON `ticket_settings` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_settings', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'auto_issue_survey_on_close', OLD.`auto_issue_survey_on_close`, 'survey_send_email_on_issue', OLD.`survey_send_email_on_issue`, 'sla_enabled_on_create', OLD.`sla_enabled_on_create`, 'active', OLD.`active`, 'deleted_by', OLD.`deleted_by`, 'deleted_at', OLD.`deleted_at`, 'created_by', OLD.`created_by`, 'created_at', OLD.`created_at`, 'updated_by', OLD.`updated_by`, 'updated_at', OLD.`updated_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'auto_issue_survey_on_close', NEW.`auto_issue_survey_on_close`, 'survey_send_email_on_issue', NEW.`survey_send_email_on_issue`, 'sla_enabled_on_create', NEW.`sla_enabled_on_create`, 'active', NEW.`active`, 'deleted_by', NEW.`deleted_by`, 'deleted_at', NEW.`deleted_at`, 'created_by', NEW.`created_by`, 'created_at', NEW.`created_at`, 'updated_by', NEW.`updated_by`, 'updated_at', NEW.`updated_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_ticket_settings_audit_delete`$$
CREATE TRIGGER `trg_ticket_settings_audit_delete` AFTER DELETE ON `ticket_settings` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_settings', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'auto_issue_survey_on_close', OLD.`auto_issue_survey_on_close`, 'survey_send_email_on_issue', OLD.`survey_send_email_on_issue`, 'sla_enabled_on_create', OLD.`sla_enabled_on_create`, 'active', OLD.`active`, 'deleted_by', OLD.`deleted_by`, 'deleted_at', OLD.`deleted_at`, 'created_by', OLD.`created_by`, 'created_at', OLD.`created_at`, 'updated_by', OLD.`updated_by`, 'updated_at', OLD.`updated_at`), NULL, @app_ip_address, @app_user_agent);
END$$
...
CREATE TRIGGER `trg_ticket_canned_responses_audit_insert` AFTER INSERT ON `ticket_canned_responses` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_canned_responses', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'title', NEW.`title`, 'body', NEW.`body`, 'category_id', NEW.`category_id`, 'active', NEW.`active`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_ticket_canned_responses_audit_update`$$
CREATE TRIGGER `trg_ticket_canned_responses_audit_update` AFTER UPDATE ON `ticket_canned_responses` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_canned_responses', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'title', OLD.`title`, 'body', OLD.`body`, 'category_id', OLD.`category_id`, 'active', OLD.`active`, 'created_at', OLD.`created_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'title', NEW.`title`, 'body', NEW.`body`, 'category_id', NEW.`category_id`, 'active', NEW.`active`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_ticket_canned_responses_audit_delete`$$
CREATE TRIGGER `trg_ticket_canned_responses_audit_delete` AFTER DELETE ON `ticket_canned_responses` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_canned_responses', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'title', OLD.`title`, 'body', OLD.`body`, 'category_id', OLD.`category_id`, 'active', OLD.`active`, 'created_at', OLD.`created_at`), NULL, @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_ticket_inbound_email_messages_audit_insert`$$
CREATE TRIGGER `trg_ticket_inbound_email_messages_audit_insert` AFTER INSERT ON `ticket_inbound_email_messages` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_inbound_email_messages', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'message_id', NEW.`message_id`, 'ticket_id', NEW.`ticket_id`, 'email_log_id', NEW.`email_log_id`, 'from_email', NEW.`from_email`, 'subject', NEW.`subject`, 'processed_at', NEW.`processed_at`, 'active', NEW.`active`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_ticket_inbound_email_messages_audit_update`$$
CREATE TRIGGER `trg_ticket_inbound_email_messages_audit_update` AFTER UPDATE ON `ticket_inbound_email_messages` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_inbound_email_messages', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'message_id', OLD.`message_id`, 'ticket_id', OLD.`ticket_id`, 'email_log_id', OLD.`email_log_id`, 'from_email', OLD.`from_email`, 'subject', OLD.`subject`, 'processed_at', OLD.`processed_at`, 'active', OLD.`active`, 'created_at', OLD.`created_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'message_id', NEW.`message_id`, 'ticket_id', NEW.`ticket_id`, 'email_log_id', NEW.`email_log_id`, 'from_email', NEW.`from_email`, 'subject', NEW.`subject`, 'processed_at', NEW.`processed_at`, 'active', NEW.`active`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_ticket_inbound_email_messages_audit_delete`$$
CREATE TRIGGER `trg_ticket_inbound_email_messages_audit_delete` AFTER DELETE ON `ticket_inbound_email_messages` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_inbound_email_messages', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'message_id', OLD.`message_id`, 'ticket_id', OLD.`ticket_id`, 'email_log_id', OLD.`email_log_id`, 'from_email', OLD.`from_email`, 'subject', OLD.`subject`, 'processed_at', OLD.`processed_at`, 'active', OLD.`active`, 'created_at', OLD.`created_at`), NULL, @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_ticket_inbound_email_routing_rules_audit_insert`$$
CREATE TRIGGER `trg_ticket_inbound_email_routing_rules_audit_insert` AFTER INSERT ON `ticket_inbound_email_routing_rules` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_inbound_email_routing_rules', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'keyword', NEW.`keyword`, 'assigned_to_employee_id', NEW.`assigned_to_employee_id`, 'category_id', NEW.`category_id`, 'priority_id', NEW.`priority_id`, 'sort_order', NEW.`sort_order`, 'active', NEW.`active`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_ticket_inbound_email_routing_rules_audit_update`$$
CREATE TRIGGER `trg_ticket_inbound_email_routing_rules_audit_update` AFTER UPDATE ON `ticket_inbound_email_routing_rules` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_inbound_email_routing_rules', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'keyword', OLD.`keyword`, 'assigned_to_employee_id', OLD.`assigned_to_employee_id`, 'category_id', OLD.`category_id`, 'priority_id', OLD.`priority_id`, 'sort_order', OLD.`sort_order`, 'active', OLD.`active`, 'created_at', OLD.`created_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'keyword', NEW.`keyword`, 'assigned_to_employee_id', NEW.`assigned_to_employee_id`, 'category_id', NEW.`category_id`, 'priority_id', NEW.`priority_id`, 'sort_order', NEW.`sort_order`, 'active', NEW.`active`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_ticket_inbound_email_routing_rules_audit_delete`$$
CREATE TRIGGER `trg_ticket_inbound_email_routing_rules_audit_delete` AFTER DELETE ON `ticket_inbound_email_routing_rules` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'ticket_inbound_email_routing_rules', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'keyword', OLD.`keyword`, 'assigned_to_employee_id', OLD.`assigned_to_employee_id`, 'category_id', OLD.`category_id`, 'priority_id', OLD.`priority_id`, 'sort_order', OLD.`sort_order`, 'active', OLD.`active`, 'created_at', OLD.`created_at`), NULL, @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_live_chat_conversations_audit_insert`$$
CREATE TRIGGER `trg_live_chat_conversations_audit_insert` AFTER INSERT ON `live_chat_conversations` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'live_chat_conversations', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'conversation_type', NEW.`conversation_type`, 'ticket_id', NEW.`ticket_id`, 'requester_employee_id', NEW.`requester_employee_id`, 'assigned_to_employee_id', NEW.`assigned_to_employee_id`, 'status', NEW.`status`, 'rating', NEW.`rating`, 'active', NEW.`active`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_live_chat_conversations_audit_update`$$
CREATE TRIGGER `trg_live_chat_conversations_audit_update` AFTER UPDATE ON `live_chat_conversations` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'live_chat_conversations', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'conversation_type', OLD.`conversation_type`, 'ticket_id', OLD.`ticket_id`, 'requester_employee_id', OLD.`requester_employee_id`, 'assigned_to_employee_id', OLD.`assigned_to_employee_id`, 'status', OLD.`status`, 'rating', OLD.`rating`, 'active', OLD.`active`, 'created_at', OLD.`created_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'conversation_type', NEW.`conversation_type`, 'ticket_id', NEW.`ticket_id`, 'requester_employee_id', NEW.`requester_employee_id`, 'assigned_to_employee_id', NEW.`assigned_to_employee_id`, 'status', NEW.`status`, 'rating', NEW.`rating`, 'active', NEW.`active`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_live_chat_conversations_audit_delete`$$
CREATE TRIGGER `trg_live_chat_conversations_audit_delete` AFTER DELETE ON `live_chat_conversations` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'live_chat_conversations', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'conversation_type', OLD.`conversation_type`, 'ticket_id', OLD.`ticket_id`, 'requester_employee_id', OLD.`requester_employee_id`, 'assigned_to_employee_id', OLD.`assigned_to_employee_id`, 'status', OLD.`status`, 'rating', OLD.`rating`, 'active', OLD.`active`, 'created_at', OLD.`created_at`), NULL, @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_live_chat_participants_audit_insert`$$
CREATE TRIGGER `trg_live_chat_participants_audit_insert` AFTER INSERT ON `live_chat_participants` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'live_chat_participants', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'conversation_id', NEW.`conversation_id`, 'employee_id', NEW.`employee_id`, 'role', NEW.`role`, 'active', NEW.`active`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_live_chat_participants_audit_update`$$
CREATE TRIGGER `trg_live_chat_participants_audit_update` AFTER UPDATE ON `live_chat_participants` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'live_chat_participants', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'conversation_id', OLD.`conversation_id`, 'employee_id', OLD.`employee_id`, 'role', OLD.`role`, 'active', OLD.`active`, 'created_at', OLD.`created_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'conversation_id', NEW.`conversation_id`, 'employee_id', NEW.`employee_id`, 'role', NEW.`role`, 'active', NEW.`active`, 'created_at', NEW.`created_at`), @app_ip_address, @app_user_agent);
END$$

DROP TRIGGER IF EXISTS `trg_live_chat_participants_audit_delete`$$
CREATE TRIGGER `trg_live_chat_participants_audit_delete` AFTER DELETE ON `live_chat_participants` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'live_chat_participants', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'conversation_id', OLD.`conversation_id`, 'employee_id', OLD.`employee_id`, 'role', OLD.`role`, 'active', OLD.`active`, 'created_at', OLD.`created_at`), NULL, @app_ip_address, @app_user_agent);
END$$
...
-- Hotel booking audit triggers
DELIMITER $$

DROP TRIGGER IF EXISTS `trg_hotel_bookings_future_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_bookings_future_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_bookings_future_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_bookings_present_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_bookings_present_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_bookings_present_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_bookings_history_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_bookings_history_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_bookings_history_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_booking_rooms_types_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_booking_rooms_types_audit_update`$$
DROP TRIGGER IF EXISTS `trg_booking_rooms_types_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_housekeeping_statuses_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_housekeeping_statuses_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_housekeeping_statuses_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_amenities_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_amenities_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_amenities_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_hotels_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_hotels_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_hotels_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_hotel_photos_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_hotel_photos_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_hotel_photos_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_hotel_nearby_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_hotel_nearby_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_hotel_nearby_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_rooms_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_rooms_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_rooms_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_room_type_base_prices_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_room_type_base_prices_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_room_type_base_prices_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_room_photos_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_room_photos_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_room_photos_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_booking_rooms_type_photos_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_booking_rooms_type_photos_audit_update`$$
DROP TRIGGER IF EXISTS `trg_booking_rooms_type_photos_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_room_utilities_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_room_utilities_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_room_utilities_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_bookings_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_bookings_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_bookings_audit_delete`$$
...
DROP TRIGGER IF EXISTS `trg_hotel_booking_special_rate_codes_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_special_rate_codes_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_special_rate_codes_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_special_rates_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_special_rates_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_special_rates_audit_delete`$$
...
DROP TRIGGER IF EXISTS `trg_hotel_booking_portal_ui_copy_checkout_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_portal_ui_copy_checkout_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_portal_ui_copy_checkout_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_portal_ui_copy_confirm_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_portal_ui_copy_confirm_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_portal_ui_copy_confirm_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_portal_ui_copy_home_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_portal_ui_copy_home_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_portal_ui_copy_home_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_portal_ui_copy_step1_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_portal_ui_copy_step1_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_portal_ui_copy_step1_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_room_type_rate_overrides_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_room_type_rate_overrides_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_room_type_rate_overrides_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_room_type_blocks_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_room_type_blocks_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_room_type_blocks_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_last_rooms_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_last_rooms_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_last_rooms_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_payment_events_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_payment_events_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_payment_events_audit_delete`$$
...
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_channels_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_channels_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_channels_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_mappings_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_mappings_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_mappings_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_reservations_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_reservations_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_reservations_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_ari_events_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_ari_events_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_ari_events_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_rate_plan_mappings_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_rate_plan_mappings_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_rate_plan_mappings_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_ari_restrictions_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_ari_restrictions_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_ari_restrictions_audit_delete`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_webhook_queue_audit_insert`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_webhook_queue_audit_update`$$
DROP TRIGGER IF EXISTS `trg_hotel_booking_distribution_webhook_queue_audit_delete`$$
CREATE TRIGGER `trg_hotel_bookings_future_audit_insert` AFTER INSERT ON `hotel_bookings_future` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_bookings_future', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_bookings_future_audit_update` AFTER UPDATE ON `hotel_bookings_future` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_bookings_future', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_bookings_future_audit_delete` AFTER DELETE ON `hotel_bookings_future` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_bookings_future', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_bookings_present_audit_insert` AFTER INSERT ON `hotel_bookings_present` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_bookings_present', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_bookings_present_audit_update` AFTER UPDATE ON `hotel_bookings_present` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_bookings_present', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_bookings_present_audit_delete` AFTER DELETE ON `hotel_bookings_present` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_bookings_present', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_bookings_history_audit_insert` AFTER INSERT ON `hotel_bookings_history` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_bookings_history', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_bookings_history_audit_update` AFTER UPDATE ON `hotel_bookings_history` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_bookings_history', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_bookings_history_audit_delete` AFTER DELETE ON `hotel_bookings_history` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_bookings_history', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_booking_rooms_types_audit_insert` AFTER INSERT ON `booking_rooms_types` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'booking_rooms_types', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_booking_rooms_types_audit_update` AFTER UPDATE ON `booking_rooms_types` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'booking_rooms_types', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_booking_rooms_types_audit_delete` AFTER DELETE ON `booking_rooms_types` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'booking_rooms_types', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_housekeeping_statuses_audit_insert` AFTER INSERT ON `hotel_booking_housekeeping_statuses` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_housekeeping_statuses', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_housekeeping_statuses_audit_update` AFTER UPDATE ON `hotel_booking_housekeeping_statuses` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_housekeeping_statuses', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_housekeeping_statuses_audit_delete` AFTER DELETE ON `hotel_booking_housekeeping_statuses` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_housekeeping_statuses', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_amenities_audit_insert` AFTER INSERT ON `hotel_booking_amenities` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_amenities', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_amenities_audit_update` AFTER UPDATE ON `hotel_booking_amenities` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_amenities', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_amenities_audit_delete` AFTER DELETE ON `hotel_booking_amenities` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_amenities', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_hotels_audit_insert` AFTER INSERT ON `hotel_booking_hotels` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_hotels', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_hotels_audit_update` AFTER UPDATE ON `hotel_booking_hotels` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_hotels', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_hotels_audit_delete` AFTER DELETE ON `hotel_booking_hotels` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_hotels', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_hotel_photos_audit_insert` AFTER INSERT ON `hotel_booking_hotel_photos` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_hotel_photos', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_hotel_photos_audit_update` AFTER UPDATE ON `hotel_booking_hotel_photos` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_hotel_photos', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_hotel_photos_audit_delete` AFTER DELETE ON `hotel_booking_hotel_photos` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_hotel_photos', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_hotel_nearby_audit_insert` AFTER INSERT ON `hotel_booking_hotel_nearby` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_hotel_nearby', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_hotel_nearby_audit_update` AFTER UPDATE ON `hotel_booking_hotel_nearby` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_hotel_nearby', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_hotel_nearby_audit_delete` AFTER DELETE ON `hotel_booking_hotel_nearby` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_hotel_nearby', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_rooms_audit_insert` AFTER INSERT ON `hotel_booking_rooms` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_rooms', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_rooms_audit_update` AFTER UPDATE ON `hotel_booking_rooms` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_rooms', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_rooms_audit_delete` AFTER DELETE ON `hotel_booking_rooms` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_rooms', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_room_type_base_prices_audit_insert` AFTER INSERT ON `hotel_booking_room_type_base_prices` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_room_type_base_prices', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_room_type_base_prices_audit_update` AFTER UPDATE ON `hotel_booking_room_type_base_prices` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_room_type_base_prices', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_room_type_base_prices_audit_delete` AFTER DELETE ON `hotel_booking_room_type_base_prices` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_room_type_base_prices', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_room_photos_audit_insert` AFTER INSERT ON `hotel_booking_room_photos` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_room_photos', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_room_photos_audit_update` AFTER UPDATE ON `hotel_booking_room_photos` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_room_photos', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_room_photos_audit_delete` AFTER DELETE ON `hotel_booking_room_photos` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_room_photos', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_booking_rooms_type_photos_audit_insert` AFTER INSERT ON `booking_rooms_type_photos` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'booking_rooms_type_photos', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_booking_rooms_type_photos_audit_update` AFTER UPDATE ON `booking_rooms_type_photos` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'booking_rooms_type_photos', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_booking_rooms_type_photos_audit_delete` AFTER DELETE ON `booking_rooms_type_photos` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'booking_rooms_type_photos', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_room_utilities_audit_insert` AFTER INSERT ON `hotel_booking_room_utilities` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_room_utilities', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_room_utilities_audit_update` AFTER UPDATE ON `hotel_booking_room_utilities` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_room_utilities', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_room_utilities_audit_delete` AFTER DELETE ON `hotel_booking_room_utilities` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_room_utilities', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_bookings_audit_insert` AFTER INSERT ON `hotel_bookings` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_bookings', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_bookings_audit_update` AFTER UPDATE ON `hotel_bookings` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_bookings', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_bookings_audit_delete` AFTER DELETE ON `hotel_bookings` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_bookings', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_portal_users_audit_insert` AFTER INSERT ON `hotel_booking_portal_users` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_portal_users', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_portal_users_audit_update` AFTER UPDATE ON `hotel_booking_portal_users` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_portal_users', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_portal_users_audit_delete` AFTER DELETE ON `hotel_booking_portal_users` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_portal_users', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_last_rooms_audit_insert` AFTER INSERT ON `hotel_booking_last_rooms` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_last_rooms', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'booking_id', NEW.`booking_id`, 'room_number', NEW.`room_number`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_last_rooms_audit_update` AFTER UPDATE ON `hotel_booking_last_rooms` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_last_rooms', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'booking_id', OLD.`booking_id`, 'room_number', OLD.`room_number`), JSON_OBJECT('id', NEW.`id`, 'booking_id', NEW.`booking_id`, 'room_number', NEW.`room_number`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_last_rooms_audit_delete` AFTER DELETE ON `hotel_booking_last_rooms` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_last_rooms', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'booking_id', OLD.`booking_id`, 'room_number', OLD.`room_number`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_payment_events_audit_insert` AFTER INSERT ON `hotel_booking_payment_events` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_payment_events', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'booking_id', NEW.`booking_id`, 'event_type', NEW.`event_type`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_payment_events_audit_update` AFTER UPDATE ON `hotel_booking_payment_events` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_payment_events', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'event_type', OLD.`event_type`), JSON_OBJECT('id', NEW.`id`, 'event_type', NEW.`event_type`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_payment_events_audit_delete` AFTER DELETE ON `hotel_booking_payment_events` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_payment_events', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'booking_id', OLD.`booking_id`, 'event_type', OLD.`event_type`), NULL, @app_ip_address, @app_user_agent);
END$$
...
CREATE TRIGGER `trg_hotel_booking_special_rate_codes_audit_insert` AFTER INSERT ON `hotel_booking_special_rate_codes` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_special_rate_codes', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'hotel_id', NEW.`hotel_id`, 'rate_slug', NEW.`rate_slug`, 'code', NEW.`code`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_special_rate_codes_audit_update` AFTER UPDATE ON `hotel_booking_special_rate_codes` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_special_rate_codes', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'hotel_id', OLD.`hotel_id`, 'rate_slug', OLD.`rate_slug`, 'code', OLD.`code`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'hotel_id', NEW.`hotel_id`, 'rate_slug', NEW.`rate_slug`, 'code', NEW.`code`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_special_rate_codes_audit_delete` AFTER DELETE ON `hotel_booking_special_rate_codes` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_special_rate_codes', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'hotel_id', OLD.`hotel_id`, 'rate_slug', OLD.`rate_slug`, 'code', OLD.`code`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_special_rates_audit_insert` AFTER INSERT ON `hotel_booking_special_rates` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_special_rates', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'hotel_id', NEW.`hotel_id`, 'rate_slug', NEW.`rate_slug`, 'name', NEW.`name`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_special_rates_audit_update` AFTER UPDATE ON `hotel_booking_special_rates` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_special_rates', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'hotel_id', OLD.`hotel_id`, 'rate_slug', OLD.`rate_slug`, 'name', OLD.`name`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'hotel_id', NEW.`hotel_id`, 'rate_slug', NEW.`rate_slug`, 'name', NEW.`name`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_special_rates_audit_delete` AFTER DELETE ON `hotel_booking_special_rates` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_special_rates', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'hotel_id', OLD.`hotel_id`, 'rate_slug', OLD.`rate_slug`, 'name', OLD.`name`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_portal_rate_plans_audit_insert` AFTER INSERT ON `hotel_booking_portal_rate_plans` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_portal_rate_plans', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'hotel_id', NEW.`hotel_id`, 'plan_slot', NEW.`plan_slot`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_portal_rate_plans_audit_update` AFTER UPDATE ON `hotel_booking_portal_rate_plans` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_portal_rate_plans', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'hotel_id', OLD.`hotel_id`, 'plan_slot', OLD.`plan_slot`, 'cancellation_policy_url', OLD.`cancellation_policy_url`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'hotel_id', NEW.`hotel_id`, 'plan_slot', NEW.`plan_slot`, 'cancellation_policy_url', NEW.`cancellation_policy_url`), @app_ip_address, @app_user_agent);
END$$
...
CREATE TRIGGER `trg_hotel_booking_portal_ui_copy_checkout_audit_insert` AFTER INSERT ON `hotel_booking_portal_ui_copy_checkout` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_portal_ui_copy_checkout', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_portal_ui_copy_checkout_audit_update` AFTER UPDATE ON `hotel_booking_portal_ui_copy_checkout` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_portal_ui_copy_checkout', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_portal_ui_copy_checkout_audit_delete` AFTER DELETE ON `hotel_booking_portal_ui_copy_checkout` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_portal_ui_copy_checkout', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_portal_ui_copy_confirm_audit_insert` AFTER INSERT ON `hotel_booking_portal_ui_copy_confirm` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_portal_ui_copy_confirm', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_portal_ui_copy_confirm_audit_update` AFTER UPDATE ON `hotel_booking_portal_ui_copy_confirm` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_portal_ui_copy_confirm', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_portal_ui_copy_confirm_audit_delete` AFTER DELETE ON `hotel_booking_portal_ui_copy_confirm` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_portal_ui_copy_confirm', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_portal_ui_copy_home_audit_insert` AFTER INSERT ON `hotel_booking_portal_ui_copy_home` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_portal_ui_copy_home', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_portal_ui_copy_home_audit_update` AFTER UPDATE ON `hotel_booking_portal_ui_copy_home` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_portal_ui_copy_home', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_portal_ui_copy_home_audit_delete` AFTER DELETE ON `hotel_booking_portal_ui_copy_home` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_portal_ui_copy_home', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_portal_ui_copy_step1_audit_insert` AFTER INSERT ON `hotel_booking_portal_ui_copy_step1` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_portal_ui_copy_step1', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_portal_ui_copy_step1_audit_update` AFTER UPDATE ON `hotel_booking_portal_ui_copy_step1` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_portal_ui_copy_step1', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_portal_ui_copy_step1_audit_delete` AFTER DELETE ON `hotel_booking_portal_ui_copy_step1` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_portal_ui_copy_step1', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_room_type_rate_overrides_audit_insert` AFTER INSERT ON `hotel_booking_room_type_rate_overrides` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_room_type_rate_overrides', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'hotel_id', NEW.`hotel_id`, 'room_type_id', NEW.`room_type_id`, 'start_date', NEW.`start_date`, 'end_date', NEW.`end_date`, 'price_per_night', NEW.`price_per_night`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_room_type_rate_overrides_audit_update` AFTER UPDATE ON `hotel_booking_room_type_rate_overrides` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_room_type_rate_overrides', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'hotel_id', OLD.`hotel_id`, 'room_type_id', OLD.`room_type_id`, 'start_date', OLD.`start_date`, 'end_date', OLD.`end_date`, 'price_per_night', OLD.`price_per_night`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'hotel_id', NEW.`hotel_id`, 'room_type_id', NEW.`room_type_id`, 'start_date', NEW.`start_date`, 'end_date', NEW.`end_date`, 'price_per_night', NEW.`price_per_night`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_room_type_rate_overrides_audit_delete` AFTER DELETE ON `hotel_booking_room_type_rate_overrides` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_room_type_rate_overrides', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'hotel_id', OLD.`hotel_id`, 'room_type_id', OLD.`room_type_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_room_type_blocks_audit_insert` AFTER INSERT ON `hotel_booking_room_type_blocks` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_room_type_blocks', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'hotel_id', NEW.`hotel_id`, 'room_type_id', NEW.`room_type_id`, 'start_date', NEW.`start_date`, 'end_date', NEW.`end_date`, 'reason', NEW.`reason`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_room_type_blocks_audit_update` AFTER UPDATE ON `hotel_booking_room_type_blocks` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_room_type_blocks', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'hotel_id', OLD.`hotel_id`, 'room_type_id', OLD.`room_type_id`, 'start_date', OLD.`start_date`, 'end_date', OLD.`end_date`, 'reason', OLD.`reason`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'hotel_id', NEW.`hotel_id`, 'room_type_id', NEW.`room_type_id`, 'start_date', NEW.`start_date`, 'end_date', NEW.`end_date`, 'reason', NEW.`reason`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_room_type_blocks_audit_delete` AFTER DELETE ON `hotel_booking_room_type_blocks` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_room_type_blocks', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'hotel_id', OLD.`hotel_id`, 'room_type_id', OLD.`room_type_id`), NULL, @app_ip_address, @app_user_agent);
END$$
...
CREATE TRIGGER `trg_hotel_booking_distribution_channels_audit_insert` AFTER INSERT ON `hotel_booking_distribution_channels` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_channels', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'channel_code', NEW.`channel_code`, 'standard', NEW.`standard`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_channels_audit_update` AFTER UPDATE ON `hotel_booking_distribution_channels` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_channels', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'channel_code', OLD.`channel_code`, 'active', OLD.`active`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'channel_code', NEW.`channel_code`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_channels_audit_delete` AFTER DELETE ON `hotel_booking_distribution_channels` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_channels', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'channel_code', OLD.`channel_code`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_mappings_audit_insert` AFTER INSERT ON `hotel_booking_distribution_mappings` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_mappings', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'channel_id', NEW.`channel_id`, 'entity_type', NEW.`entity_type`, 'external_code', NEW.`external_code`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_mappings_audit_update` AFTER UPDATE ON `hotel_booking_distribution_mappings` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_mappings', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'external_code', OLD.`external_code`, 'active', OLD.`active`), JSON_OBJECT('id', NEW.`id`, 'external_code', NEW.`external_code`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_mappings_audit_delete` AFTER DELETE ON `hotel_booking_distribution_mappings` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_mappings', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'channel_id', OLD.`channel_id`, 'entity_type', OLD.`entity_type`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_reservations_audit_insert` AFTER INSERT ON `hotel_booking_distribution_reservations` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_reservations', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'channel_id', NEW.`channel_id`, 'hotel_booking_id', NEW.`hotel_booking_id`, 'external_reservation_id', NEW.`external_reservation_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_reservations_audit_update` AFTER UPDATE ON `hotel_booking_distribution_reservations` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_reservations', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'external_status', OLD.`external_status`, 'active', OLD.`active`), JSON_OBJECT('id', NEW.`id`, 'external_status', NEW.`external_status`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_reservations_audit_delete` AFTER DELETE ON `hotel_booking_distribution_reservations` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_reservations', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'external_reservation_id', OLD.`external_reservation_id`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_ari_events_audit_insert` AFTER INSERT ON `hotel_booking_distribution_ari_events` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_ari_events', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'channel_id', NEW.`channel_id`, 'event_type', NEW.`event_type`, 'status', NEW.`status`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_ari_events_audit_update` AFTER UPDATE ON `hotel_booking_distribution_ari_events` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_ari_events', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'status', OLD.`status`), JSON_OBJECT('id', NEW.`id`, 'status', NEW.`status`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_ari_events_audit_delete` AFTER DELETE ON `hotel_booking_distribution_ari_events` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_ari_events', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'event_type', OLD.`event_type`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_rate_plan_mappings_audit_insert` AFTER INSERT ON `hotel_booking_distribution_rate_plan_mappings` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_rate_plan_mappings', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'channel_id', NEW.`channel_id`, 'external_rate_plan_code', NEW.`external_rate_plan_code`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_rate_plan_mappings_audit_update` AFTER UPDATE ON `hotel_booking_distribution_rate_plan_mappings` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_rate_plan_mappings', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'external_rate_plan_code', OLD.`external_rate_plan_code`), JSON_OBJECT('id', NEW.`id`, 'external_rate_plan_code', NEW.`external_rate_plan_code`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_rate_plan_mappings_audit_delete` AFTER DELETE ON `hotel_booking_distribution_rate_plan_mappings` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_rate_plan_mappings', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'external_rate_plan_code', OLD.`external_rate_plan_code`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_ari_restrictions_audit_insert` AFTER INSERT ON `hotel_booking_distribution_ari_restrictions` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_ari_restrictions', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'stay_date', NEW.`stay_date`, 'room_type_id', NEW.`room_type_id`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_ari_restrictions_audit_update` AFTER UPDATE ON `hotel_booking_distribution_ari_restrictions` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_ari_restrictions', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'stop_sell', OLD.`stop_sell`), JSON_OBJECT('id', NEW.`id`, 'stop_sell', NEW.`stop_sell`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_ari_restrictions_audit_delete` AFTER DELETE ON `hotel_booking_distribution_ari_restrictions` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_ari_restrictions', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'stay_date', OLD.`stay_date`), NULL, @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_webhook_queue_audit_insert` AFTER INSERT ON `hotel_booking_distribution_webhook_queue` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_webhook_queue', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'event_type', NEW.`event_type`, 'status', NEW.`status`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_webhook_queue_audit_update` AFTER UPDATE ON `hotel_booking_distribution_webhook_queue` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_webhook_queue', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'status', OLD.`status`), JSON_OBJECT('id', NEW.`id`, 'status', NEW.`status`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_hotel_booking_distribution_webhook_queue_audit_delete` AFTER DELETE ON `hotel_booking_distribution_webhook_queue` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'hotel_booking_distribution_webhook_queue', COALESCE(OLD.`id`, 0), 'DELETE', JSON_OBJECT('id', OLD.`id`, 'status', OLD.`status`), NULL, @app_ip_address, @app_user_agent);
END$$
...
DROP TRIGGER IF EXISTS `trg_qr_codes_audit_insert`;

DROP TRIGGER IF EXISTS `trg_qr_codes_audit_update`;
...
CREATE TRIGGER `trg_qr_codes_audit_insert` AFTER INSERT ON `qr_codes` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'qr_codes', COALESCE(NEW.`id`, 0), 'INSERT', NULL, JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'employee_id', NEW.`employee_id`, 'title', NEW.`title`, 'type_slug', NEW.`type_slug`, 'encoding_mode', NEW.`encoding_mode`, 'scan_count', NEW.`scan_count`, 'active', NEW.`active`), @app_ip_address, @app_user_agent);
END$$

CREATE TRIGGER `trg_qr_codes_audit_update` AFTER UPDATE ON `qr_codes` FOR EACH ROW BEGIN
  INSERT INTO `audit_logs` (`company_id`, `employee_id`, `actor_username`, `actor_email`, `table_name`, `record_id`, `action`, `old_values`, `new_values`, `ip_address`, `user_agent`)
  VALUES (COALESCE(@app_company_id, NEW.`company_id`, OLD.`company_id`, 0), @app_employee_id, @app_username, @app_email, 'qr_codes', COALESCE(NEW.`id`, OLD.`id`, 0), 'UPDATE', JSON_OBJECT('id', OLD.`id`, 'company_id', OLD.`company_id`, 'employee_id', OLD.`employee_id`, 'title', OLD.`title`, 'type_slug', OLD.`type_slug`, 'encoding_mode', OLD.`encoding_mode`, 'scan_count', OLD.`scan_count`, 'active', OLD.`active`, 'deleted_by', OLD.`deleted_by`, 'deleted_at', OLD.`deleted_at`), JSON_OBJECT('id', NEW.`id`, 'company_id', NEW.`company_id`, 'employee_id', NEW.`employee_id`, 'title', NEW.`title`, 'type_slug', NEW.`type_slug`, 'encoding_mode', NEW.`encoding_mode`, 'scan_count', NEW.`scan_count`, 'active', NEW.`active`, 'deleted_by', NEW.`deleted_by`, 'deleted_at', NEW.`deleted_at`), @app_ip_address, @app_user_agent);
END$$
