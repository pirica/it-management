-- Per-hotel general contact and reservations email columns (destructive — back up before apply).
...
-- Re-seed hotel rows after apply (see db/02_data.sql hotel_booking_hotels INSERT blocks).
