-- Hash integration API keys on ui_configuration (SHA-256 + prefix; plaintext api_key deprecated).
...
-- Existing plaintext api_key values are not auto-migrated; re-save or generate keys in Settings → API Access.
