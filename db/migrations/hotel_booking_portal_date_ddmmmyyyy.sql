-- Portal date format DD/MMM/YYYY (european_ddmmmyyyy) on hotel_booking_settings.portal_date_format.
-- Apply on existing DBs: php scripts/migrate.php --apply
-- Destructive: DROP removes all hotel_booking_settings rows for every tenant.
