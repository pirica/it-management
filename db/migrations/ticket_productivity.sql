-- Ticket productivity: merge + CSAT columns on tickets (destructive).
...
CREATE TABLE `tickets` (
  ...
  CONSTRAINT `tickets_ibfk_7` FOREIGN KEY (`equipment_id`) REFERENCES `equipment` (`id`) ON DELETE SET NULL
