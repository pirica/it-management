...
-- Table structure for `software_license_links`
...
-- Table structure for `vlans_config`
...
-- Table structure for `vlans_uplink`
...
-- Table structure for `vlans_group_policy`
...
-- Table structure for `vlans_vpn_mode`
...
-- Table structure for `vlans_per_port_modules`
...
-- Table structure for `vlans_per_port_types`
...
-- Table structure for `vlans_per_port_access_policies`
...
-- Table structure for `vlans_per_port`
DROP TABLE IF EXISTS `vlans_per_port`;
...
-- Generic background job queue (scripts/run_job_queue.php worker)
...
-- Table structure for `network_discovery_profiles`
...
-- Table structure for `network_discovery_staging`
...
CREATE TABLE `short_url_settings` (
  ...
  `require_https_destination` TINYINT(1) NOT NULL DEFAULT 1,
  `enforce_domain_allowlist` TINYINT(1) NOT NULL DEFAULT 0,
  `allowed_destination_domains` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `interstitial_warning_enabled` TINYINT(1) NOT NULL DEFAULT 1,
  `creation_rate_limit_per_hour` INT NOT NULL DEFAULT 30,
