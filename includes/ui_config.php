    ...
    return [
        ...
        [
            ...
            'items' => [
                ...
                ['id' => 'ticket_activity', 'label' => '📋 Ticket Activity', 'href' => 'modules/ticket_activity/', 'match_dir' => 'ticket_activity'],
                ['id' => 'ticket_comments', 'label' => '💬 Ticket Comments', 'href' => 'modules/ticket_comments/', 'match_dir' => 'ticket_comments'],
                ['id' => 'ticket_sla_policies', 'label' => '⏱️ Ticket SLA Policies', 'href' => 'modules/ticket_sla_policies/', 'match_dir' => 'ticket_sla_policies'],
                ['id' => 'ticket_sla_dashboard', 'label' => '📊 SLA Command Center', 'href' => 'modules/ticket_sla_dashboard/', 'match_dir' => 'ticket_sla_dashboard'],
                ['id' => 'ticket_questionnaires', 'label' => '📋 Ticket Questionnaires', 'href' => 'modules/ticket_questionnaires/', 'match_dir' => 'ticket_questionnaires'],
                ['id' => 'ticket_surveys', 'label' => '⭐ Ticket Surveys', 'href' => 'modules/ticket_surveys/', 'match_dir' => 'ticket_surveys'],
                ['id' => 'ticket_survey_dashboard', 'label' => '📊 Survey Dashboard', 'href' => 'modules/ticket_survey_dashboard/', 'match_dir' => 'ticket_survey_dashboard'],
                ['id' => 'problems', 'label' => '🔍 Problem Management', 'href' => 'modules/problems/', 'match_dir' => 'problems'],
                ['id' => 'configuration_items', 'label' => '🧩 Configuration Items', 'href' => 'modules/configuration_items/', 'match_dir' => 'configuration_items'],
                ['id' => 'configuration_item_types', 'label' => '🏷️ CI Types', 'href' => 'modules/configuration_item_types/', 'match_dir' => 'configuration_item_types'],
                ['id' => 'change_requests', 'label' => '📝 Change Requests', 'href' => 'modules/change_requests/', 'match_dir' => 'change_requests'],
        ...
        [
            ...
            'items' => [
                ...
                ['id' => 'employee_departments', 'label' => '🏢 Employee Departments', 'href' => 'modules/employee_departments/', 'match_dir' => 'employee_departments'],
                ['id' => 'employee_notifications', 'label' => '🔔 Employee Notifications', 'href' => 'modules/employee_notifications/', 'match_dir' => 'employee_notifications'],
        ...
        [
            ...
            'items' => [
                ...
                ['id' => 'bills', 'label' => '🧾 Bills', 'href' => 'modules/bills/', 'match_dir' => 'bills'],
                ['id' => 'invoices', 'label' => '📄 Invoices', 'href' => 'modules/invoices/', 'match_dir' => 'invoices'],
                ['id' => 'bill_line_items', 'label' => '🧾 Bill Line Items', 'href' => 'modules/bill_line_items/', 'match_dir' => 'bill_line_items'],
                ['id' => 'invoice_line_items', 'label' => '📄 Invoice Line Items', 'href' => 'modules/invoice_line_items/', 'match_dir' => 'invoice_line_items'],
                ['id' => 'finance_attachments', 'label' => '📎 Finance Attachments', 'href' => 'modules/finance_attachments/', 'match_dir' => 'finance_attachments'],
                ['id' => 'finance_payment_allocations', 'label' => '💰 Finance Payment Allocations', 'href' => 'modules/finance_payment_allocations/', 'match_dir' => 'finance_payment_allocations'],
                ['id' => 'customers', 'label' => '👥 Customers', 'href' => 'modules/customers/', 'match_dir' => 'customers'],
                ['id' => 'bank_accounts', 'label' => '🏦 Bank Accounts', 'href' => 'modules/bank_accounts/', 'match_dir' => 'bank_accounts'],
                ...
                ['id' => 'tax_rates', 'label' => '📊 Tax Rates', 'href' => 'modules/tax_rates/', 'match_dir' => 'tax_rates'],
                ['id' => 'paid_statuses', 'label' => '💰 Paid Statuses', 'href' => 'modules/paid_statuses/', 'match_dir' => 'paid_statuses'],
                ['id' => 'payment_modes', 'label' => '💳 Payment Modes', 'href' => 'modules/payment_modes/', 'match_dir' => 'payment_modes'],
        ...
        [
            ...
            'title' => '🏨 Hospitality',
            'items' => [
                ['id' => 'hotel_bookings', 'label' => '🏨 Hotel Bookings', 'href' => 'modules/hotel_bookings/', 'match_dir' => 'hotel_bookings'],
                ['id' => 'hotel_booking_hotels', 'label' => '🏨 Hotels', 'href' => 'modules/hotel_booking_hotels/', 'match_dir' => 'hotel_booking_hotels'],
                ['id' => 'hotel_booking_hotel_nearby', 'label' => '📍 Hotel Nearby', 'href' => 'modules/hotel_booking_hotel_nearby/', 'match_dir' => 'hotel_booking_hotel_nearby'],
                ['id' => 'hotel_booking_hotel_photos', 'label' => '🖼️ Hotel Photos', 'href' => 'modules/hotel_booking_hotel_photos/', 'match_dir' => 'hotel_booking_hotel_photos'],
                ['id' => 'hotel_booking_portal_users', 'label' => '👤 Portal Users', 'href' => 'modules/hotel_booking_portal_users/', 'match_dir' => 'hotel_booking_portal_users'],
                ['id' => 'booking_rooms_types', 'label' => '🛏️ Room Types', 'href' => 'modules/booking_rooms_types/', 'match_dir' => 'booking_rooms_types'],
                ['id' => 'booking_rooms_type_photos', 'label' => '🖼️ Room Type Photos', 'href' => 'modules/booking_rooms_type_photos/', 'match_dir' => 'booking_rooms_type_photos'],
                ...
                ['id' => 'hotel_booking_special_rates', 'label' => '🏷️ Booking Special Rates', 'href' => 'modules/hotel_booking_special_rates/', 'match_dir' => 'hotel_booking_special_rates'],
                ['id' => 'hotel_booking_room_type_calendar', 'label' => '📆 Room Type Calendar', 'href' => 'modules/hotel_booking_room_type_calendar/', 'match_dir' => 'hotel_booking_room_type_calendar'],
                ...
                ['id' => 'hotel_booking_housekeeping_statuses', 'label' => '🧹 HSK Statuses', 'href' => 'modules/hotel_booking_housekeeping_statuses/', 'match_dir' => 'hotel_booking_housekeeping_statuses'],
                ['id' => 'hotel_booking_housekeeping_maintenance_status', 'label' => '🔧 HSK Maintenance Status', 'href' => 'modules/hotel_booking_housekeeping_maintenance_status/', 'match_dir' => 'hotel_booking_housekeeping_maintenance_status'],
                ['id' => 'hotel_booking_housekeeping_maintenance', 'label' => '🛠️ HSK Maintenance', 'href' => 'modules/hotel_booking_housekeeping_maintenance/', 'match_dir' => 'hotel_booking_housekeeping_maintenance'],
                ...
                ['id' => 'hotel_booking_distribution_channels', 'label' => '📡 Distribution Channels', 'href' => 'modules/hotel_booking_distribution_channels/', 'match_dir' => 'hotel_booking_distribution_channels'],
        ...
        [
            ...
            'items' => [
                ...
                ['id' => 'webmail_email_reads', 'label' => '📬 Webmail Email Reads', 'href' => 'modules/webmail_email_reads/', 'match_dir' => 'webmail_email_reads'],
                ...
                ['id' => 'appointments', 'label' => '📅 Appointments', 'href' => 'modules/appointments/', 'match_dir' => 'appointments'],
                ['id' => 'appointment_business_hours', 'label' => '⏰ Appointment Business Hours', 'href' => 'modules/appointment_business_hours/', 'match_dir' => 'appointment_business_hours'],
                ['id' => 'appointment_type', 'label' => '📋 Appointment Type', 'href' => 'modules/appointment_type/', 'match_dir' => 'appointment_type'],
                ['id' => 'appointment_visit_reasons', 'label' => '📝 Appointment Visit Reasons', 'href' => 'modules/appointment_visit_reasons/', 'match_dir' => 'appointment_visit_reasons'],
                ['id' => 'appointment_settings', 'label' => '⚙️ Appointment Settings', 'href' => 'modules/appointment_settings/', 'match_dir' => 'appointment_settings'],
                ...
                ['id' => 'live_chat_conversations', 'label' => '💬 Live Chat Conversations', 'href' => 'modules/live_chat_conversations/', 'match_dir' => 'live_chat_conversations'],
                ['id' => 'live_chat_messages', 'label' => '💬 Live Chat Messages', 'href' => 'modules/live_chat_messages/', 'match_dir' => 'live_chat_messages'],
                ['id' => 'live_chat_participants', 'label' => '👥 Live Chat Participants', 'href' => 'modules/live_chat_participants/', 'match_dir' => 'live_chat_participants'],
                ['id' => 'live_chat_typing', 'label' => '⌨️ Live Chat Typing', 'href' => 'modules/live_chat_typing/', 'match_dir' => 'live_chat_typing'],
            ],
        ],
        [
            'id' => 'admin',
            ...
            'items' => [
                ...
                ['id' => 'share_modules', 'label' => '📱 Share Modules', 'href' => 'modules/share_modules/', 'match_dir' => 'share_modules'],
                ['id' => 'company_module_share', 'label' => '📱 Company Module Share', 'href' => 'modules/company_module_share/', 'match_dir' => 'company_module_share'],
                ...
                ['id' => 'vault_org_recovery', 'label' => '🔐 Vault Org Recovery', 'href' => 'modules/vault_org_recovery/', 'match_dir' => 'vault_org_recovery'],
                ['id' => 'approval_inbox', 'label' => '📥 Approval Inbox', 'href' => 'modules/approval_inbox/', 'match_dir' => 'approval_inbox'],
                ...
                ['id' => 'job_queue', 'label' => '⏱️ Job Queue', 'href' => 'modules/job_queue/', 'match_dir' => 'job_queue'],
...
function itm_sidebar_module_default_label($moduleName) {
    ...
    $labels = [
        ...
        'appointment_settings' => '⚙️ Appointment Settings',
        ...
        'booking_rooms_type_photos' => '🖼️ Room Type Photos',
        ...
        'vault_org_recovery' => '🔐 Vault Org Recovery',
        'hotel_booking_hotel_nearby' => '📍 Hotel Nearby',
        'hotel_booking_hotel_photos' => '🖼️ Hotel Photos',
        'hotel_booking_portal_users' => '👤 Portal Users',
        'live_chat' => '💬 Live Chat',
        ...
        'live_chat_typing' => '⌨️ Live Chat Typing',
        'share_sessions' => '🔗 Share Sessions',
        'ticket_activity' => '📋 Ticket Activity',
        'ticket_comments' => '💬 Ticket Comments',
        'ticket_sla_policies' => '⏱️ Ticket SLA Policies',
        'ticket_sla_dashboard' => '📊 SLA Command Center',
        'ticket_questionnaires' => '📋 Ticket Questionnaires',
        'ticket_surveys' => '⭐ Ticket Surveys',
        'ticket_survey_dashboard' => '📊 Survey Dashboard',
        'problems' => '🔍 Problem Management',
        'configuration_items' => '🧩 Configuration Items',
        'configuration_item_types' => '🏷️ CI Types',
        'change_requests' => '📝 Change Requests',
        'master_tickets' => '🎫 Master Tickets',
        'ticket_canned_responses' => '💬 Ticket Canned Responses',
...
$sql = "CREATE TABLE IF NOT EXISTS `ui_configuration` (
        ...
        `table_actions_position` VARCHAR(30) NOT NULL DEFAULT 'left',
