...
- **itm_employees_auth_sensitive_fields.php** — canonical Employees list/view column denylist (`password`, `vault_key_hash`, reset-token fields); `itm_employees_auth_filter_ui_columns()` strips them from `$uiColumns`.
