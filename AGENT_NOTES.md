...
- **dashboard.php** — Employee landing: **smart widgets** (`includes/itm_dashboard_widgets.php` — role/RBAC-aware metrics + Chart.js sparklines) above personal stat cards via `includes/itm_employee_dashboard.php` / `itm_employee_dashboard_cards.php`; **My Activity** → `modules/myactivity/`; **Private** section cards; no Sidebar Prefs or Audit Logs cards. Regression: `php scripts/verify_employee_dashboard.php`, `php scripts/verify_dashboard_widgets.php`.
