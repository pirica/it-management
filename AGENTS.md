...
| **`bulk_cancel`** | **Browser:** after **Select to Delete**, `cancelButton.textContent = 'Cancel'` (`js/bulk-delete-selection.js`) hides checkboxes and clears selection without POST. **Runner:** N/A (not automated). |
