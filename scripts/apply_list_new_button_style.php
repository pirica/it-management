...
Browser: <a href="apply_list_new_button_style.php">dry-run</a> / <a href="apply_list_new_button_style.php?apply=1">apply=1</a>. CLI: <code>php scripts/apply_list_new_button_style.php</code> then <code>php scripts/apply_list_new_button_style.php --apply</code>.
