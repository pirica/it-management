...
#   4. scripts/check_ui_configuration_coverage.php (optional; see SMOKE_SKIP_UI_CONFIG)
#
...
if [[ "${SMOKE_SKIP_UI_CONFIG:-0}" == "1" ]]; then
  echo "==> Step 4/4: check_ui_configuration_coverage.php (skipped — SMOKE_SKIP_UI_CONFIG=1)"
else
