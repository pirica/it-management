...
function run_git_reset_with_method($method, $post_data = []) {
    $post_init = "";
...
$outputGet = run_git_reset_with_method('GET');
...
$outputPostInvalid = run_git_reset_with_method('POST', ['confirm' => '1', 'csrf_token' => 'invalid_token']);
...
// NOTE: We don't actually want to run the full destructive reset in the test if we can help it,
// but we want to see it reach the 'Starting Git history reset' line.
$outputPostValid = run_git_reset_with_method('POST', ['confirm' => '1', 'csrf_token' => 'valid_token']);
