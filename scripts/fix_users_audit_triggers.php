 ...
 *
 * Updates the database triggers for the 'employees' table to prevent
...
$queries = [
    ...
    "CREATE TRIGGER `trg_users_audit_insert` AFTER INSERT ON `employees` FOR EACH ROW BEGIN
