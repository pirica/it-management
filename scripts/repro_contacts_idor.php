...
<code>php scripts/repro_contacts_idor.php</code> — expects PASS when IDOR is blocked. Clears <code>@app_employee_id</code> before create to avoid <code>audit_logs</code> FK failures.
