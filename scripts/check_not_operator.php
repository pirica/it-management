...
Browser: plain-text report. CLI: <code>php scripts/check_not_operator.php</code> — always exit <code>0</code> (Warning tier). Optional <code>--include-scripts</code> / <code>?include_scripts=1</code>. Run when reviewing Codacy <code>!</code> findings; fix case-by-case or add <code>itm-not-operator-exempt:</code>.
