...
Browser: <a href="fix_sql_departments.php">dry-run</a> / <a href="fix_sql_departments.php?apply=1">apply=1</a>. CLI: <code>php scripts/fix_sql_departments.php</code> then <code>--apply</code>.
