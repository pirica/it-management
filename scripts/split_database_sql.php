<?php
/**
 * Generate db/01_schema.sql, 02_data.sql, 03_triggers.sql from database.sql.
 *
...
if (!$apply) {
    echo colorText('Dry run only. Re-run with --apply or ?apply=1 to write db/01_schema.sql, 02_data.sql, 03_triggers.sql.', 'info') . $nl;
    exit(0);
}
