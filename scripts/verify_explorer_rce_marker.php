...
<code>php scripts/verify_explorer_rce_marker.php</code>
...
$company_id = 1;
$testUser = itm_script_test_employee_create($conn, $company_id, ['script_slug' => 'verify-explorer-rce-marker']);
...
if (file_exists($htaccess_path)) {
    ...
    if (strpos($content, "AddType") !== false) {
        echo colorText("[FAIL] Explorer RCE: Malicious .htaccess with marker uploaded successfully!", 'fail') . itm_script_output_nl();
    } else {
