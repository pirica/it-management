...
<strong>Log in first.</strong> Open <a href="test_email_forgot.php" target="_blank" rel="nofollow noreferrer">test_email_forgot.php</a>. CLI: <code>php scripts/test_email_forgot.php email=test@example.com</code> or <code>php scripts/test_email_forgot.php email=test@example.com --company=1</code>
