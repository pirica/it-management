...
<code>php scripts/perform_audit.php</code> (optional <code>--loop</code> for triage). Windows Laragon: full path to <code>php.exe</code> in parent and child processes.
