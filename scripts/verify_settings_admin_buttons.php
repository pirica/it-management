...
Browser: <a href="verify_settings_admin_buttons.php">verify_settings_admin_buttons.php</a>. CLI: <code>php scripts/verify_settings_admin_buttons.php</code>. Run when changing Settings admin shortcuts or system-flag layout.
