<?php
/**
 * Static audit: fail on stale Users-module prose and employee_companies user_id helpers.
 *
...
if (empty($failures)) {
    echo "PASS: No stale Users-module prose or employee_companies user_id helper references.\n";
    exit(0);
}
