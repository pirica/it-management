...
| 2 | 25 | Manual static `check_*` cluster + UTF-8 gates + FK display audit |
...
php scripts/check_script_php_utf8_no_bom.php
php scripts/repair_db_utf8_seed_corruption.php
...
| 0 | `matrix_safe_run_once.php` | PHP | low | runtime | One-shot safe matrix runner (tiers 1-3) |
...
| 2 | `check_crud_boolean_cell_display.php` | PHP | none | static-manual | Pre-merge static gate (not in smoke) |
| 2 | `check_crud_has_company_from_field_columns.php` | PHP | none | static-manual | Pre-merge static gate (not in smoke) |
