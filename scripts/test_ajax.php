...
Browser: <a href="test_ajax.php" target="_blank" rel="nofollow noreferrer">form</a> (Admin). CLI: <code>php scripts/test_ajax.php &lt;PHPSESSID&gt; &lt;title&gt;</code> — excluded from <code>perform_audit.php</code>.
