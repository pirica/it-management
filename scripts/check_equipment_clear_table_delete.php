...
Browser: <a href="check_equipment_clear_table_delete.php" target="_blank" rel="nofollow noreferrer">run</a>. CLI: <code>php scripts/check_equipment_clear_table_delete.php</code> — run after equipment delete/clear-table changes (AGENTS.md).
