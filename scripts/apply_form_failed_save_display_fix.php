...
Browser: <a href="apply_form_failed_save_display_fix.php" target="_blank" rel="nofollow noreferrer">dry-run</a> / <a href="apply_form_failed_save_display_fix.php?apply=1" target="_blank" rel="nofollow noreferrer">apply=1</a> · <a href="apply_form_failed_save_display_fix.php?module=manufacturers" target="_blank" rel="nofollow noreferrer">?module=manufacturers</a>. CLI: <code>php scripts/apply_form_failed_save_display_fix.php</code> then <code>php scripts/apply_form_failed_save_display_fix.php --apply</code> · <code>--module=manufacturers</code>
