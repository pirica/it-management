...
Browser: <a href="apply_pagination_first_last.php">dry-run</a> / <a href="apply_pagination_first_last.php?apply=1">apply=1</a>. CLI: <code>php scripts/apply_pagination_first_last.php</code> then <code>php scripts/apply_pagination_first_last.php --apply</code>.
