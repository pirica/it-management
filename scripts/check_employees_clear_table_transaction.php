...
Browser: <a href="check_employees_clear_table_transaction.php" target="_blank" rel="nofollow noreferrer">run</a>. CLI: <code>php scripts/check_employees_clear_table_transaction.php</code> — run after employees <code>clear_table</code> changes (AGENTS.md).
