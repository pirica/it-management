...
| `itm_titles_list_audit.php` | Shared scan/summary helpers for `titles_list.php` and `titles_list_show.php` (module file collection, app-name suffix match, summary output) |
