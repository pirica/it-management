 ...
 * IDF rack view device icon now derives its dot count/tooltip from SFP and SFP+ port metadata (matching switch-port-manager fiber port context) without CSS/style changes.
