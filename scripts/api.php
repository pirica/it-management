...
{"ok": true, "inserted": 2}</code></pre>
    ...
    <div class="card">
        ...
        <ul>
            <li><strong>2026-05-13:</strong> IDF rack port click actions in <code>modules/idfs/view.php</code> now stay on the same rack page by opening <code>modules/idfs/device.php</code> inside an in-page modal iframe (instead of full-page navigation), covering both edit-port and create-link flows from RJ45/SFP visualizer clicks.</li>
