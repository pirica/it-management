...
{"ok": true, "inserted": 2}</code></pre>
    ...
    <div class="card">
        ...
        <ul>
            <li><strong>2026-05-13:</strong> Global responsive hardening now covers shared layout/navigation and module CRUD screens without changing backend behavior: mobile sidebar drawer with backdrop/escape/link-close support, multi-breakpoint spacing/typography tuning (mobile/tablet/laptop/large desktop), touch-friendly controls, safer table/card overflow handling, and responsive fixes for inline legacy flex/title/search layouts (notably Settings UI configuration + SideMenu controls) across <code>css/styles.css</code>, <code>js/theme.js</code>, <code>includes/header.php</code>, and <code>includes/sidebar.php</code>.</li>
