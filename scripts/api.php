...
{"ok": true, "inserted": 2}</code></pre>
    ...
    <div class="card">
        ...
        <ul>
            <li><strong>2026-05-13:</strong> IDF device view color parity fix now aligns <code>modules/idfs/device.php</code> cable-color precedence with <code>modules/idfs/view.php</code> so matching port IDs render the same visual color/status blend (for example Port 3/13 and SFP Port 3 no longer diverge between pages).</li>
