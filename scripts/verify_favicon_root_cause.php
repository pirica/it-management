...
Browser: <a href="verify_favicon_root_cause.php">verify_favicon_root_cause.php</a>. CLI: <code>php scripts/verify_favicon_root_cause.php</code> · sample: <code>--module=employees</code>
