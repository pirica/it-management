...
| `php scripts/verify_pentest_report.php` | Static regression for `docs/report.md` ITM-PENTEST-001–022. Output: `[PASS]` remediated (001–003, 006–007, 012, 014), `[OPEN]` documented gaps (004–005, 008–011, 013, 015–016), `[INFO]` positive controls (017–022), `[FAIL]` drift. Invokes `check_sql_injection_coverage.php` and `check_csrf_coverage.php`. PHPUnit: `--filter PentestReport`. Browser: [verify_pentest_report.php?run=1](http://localhost/it-management/scripts/verify_pentest_report.php?run=1) (Administrator). |
