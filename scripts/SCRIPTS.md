...
| `php scripts/verify_company_module_access.php` | Regression: registry coverage, strict opt-in deny, seeded company × module rows |
| `php scripts/seed_company_module_access.php` | Backfill `company_module_access` rows (`enabled=1`) for all companies or one company |
