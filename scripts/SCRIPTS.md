...
| `php scripts/seed_hotel_booking_sample_photos.php` | Copy `booking/images/hotel-sample-*.jpg` + `images/hotel_booking/1/hotel/1/hb_seed_*.jpg` onto disk and upsert `hotel_booking_hotel_photos` for company 1 / hotel 1 (`--apply` writes; default dry-run) |
