...
| `php scripts/rules.php` | Read-only browser list of Cursor project rules under `.cursor/rules/*.mdc` (Admin; shared **Main menu** with Scripts catalog and Pitfalls). CLI: `--json` file list. |
