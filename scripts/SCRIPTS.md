...
| `scripts/lib/itm_mojibake_audit.php` | UTF-8 / mojibake scan helpers for `verify_source_utf8_mojibake.php` and `apply_utf8_mojibake_fix.php` |
...
```bash
php scripts/verify_source_utf8_mojibake.php              # exit 0 when clean
php scripts/verify_source_utf8_mojibake.php --path=modules/patches_updates
php scripts/apply_utf8_mojibake_fix.php                  # dry-run repair list
php scripts/apply_utf8_mojibake_fix.php --apply          # write known fixes
```
