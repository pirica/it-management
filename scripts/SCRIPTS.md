...
- `php scripts/verify_command_palette_search.php` — `includes/itm_command_palette_search.php`, `modules/search/api.php`, `js/command-palette.js`, header Ctrl+K wiring, RBAC gates
