...
* `scripts/verify_tickets_create_defaults.php` (tickets create **Created By** default + `itm_ensure_company_context_employee_session()` stale-session remap at company 4; edit `TCK-0001` seed FK probe).
...
| `php scripts/verify_employee_dashboard.php` | Regression: employee **dashboard.php** hero + grouped stat cards, company switcher (`Switch Company` / `itm_switch_active_company_session`), smart widget wiring + Chart.js, `includes/itm_employee_dashboard.php` loader |
