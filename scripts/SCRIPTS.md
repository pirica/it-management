...
| `php scripts/verify_cmdb.php` | Regression for CMDB Lite (`includes/itm_cmdb.php`, `configuration_items*`, `change_requests`, subnet/system_access sync, cycle detection, impact BFS, equipment/IDF sync hooks). |
