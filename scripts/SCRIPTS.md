...
Run `verify_setup_wizard_database.php` when changing setup wizard step 3 database probe, create, replace confirmation, import guards, or step 7 skip minimal single-user cleanup (`setup/index.php`, `setup/includes/itm_setup_wizard.php`).
