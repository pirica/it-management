...
Browser: HTML report (Admin). CLI: <code>php scripts/list_active_and_checkboxes.php</code> · JSON: <code>--json</code> · list compliant files: <code>--all</code> · exit <code>1</code> on violations
