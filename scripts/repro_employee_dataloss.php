...
Browser: open <a href="repro_employee_dataloss.php">repro_employee_dataloss.php</a>. CLI: <code>php scripts/repro_employee_dataloss.php</code> (exit <code>0</code> on pass, non-zero on failure).
