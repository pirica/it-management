        ...
        <div class="scripts-catalog-grid"><table class="scripts-catalog">
            ...
            <tbody>
                ...
                <tr data-tags="Mixed">
                    ...
                    <td>Browser: <a href="fast_create_acc.php">scripts/fast_create_acc.php</a>, <a href="fast_create_acc_browser.php">scripts/fast_create_acc_browser.php</a>, or <a href="../modules/employees/fast_create_acc.php">modules/employees/fast_create_acc.php</a>. CLI: <code>php scripts/fast_create_acc.php --seed-demo-bundle --company=1</code>.</td>
                </tr>
                <tr data-tags="employees">
    ...
    <div class="scripts-card" id="deployment">
        ...
        <div class="scripts-catalog-grid"><table class="scripts-catalog">
            ...
            <tr data-tags="Codebase">
                ...
                <td><strong>Log in first.</strong> Open <code>it-management/reset_git_history.php</code>. <strong>DANGER: Destructive.</strong> <strong>BETA / pre-production only</strong> — no implementation changes while the project remains in BETA and not yet in production.</td>
            </tr>
        </tbody>
        </table></div>
    </div>
