        ...
        <div class="scripts-table-wrap"><table class="scripts-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><code>php scripts/verify_employees_equipment_search_coverage.php</code> — run after changing <code>itm_employees_search.php</code>, <code>itm_equipment_search.php</code>, or employees/equipment index search.</td>
                </tr>
                <tr>
