        ...
        <div class="scripts-catalog-grid"><table class="scripts-catalog">
            ...
            <tbody>
                ...
                <tr data-tags="Mixed">
                    ...
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="mixed">Mixed</span></span></td>
                    <td>Static regression for <code>docs/report.md</code> pentest ITM-PENTEST-001–022. Labels: <code>[PASS]</code> remediated, <code>[OPEN]</code> documented gap, <code>[INFO]</code> positive control, <code>[FAIL]</code> drift. Invokes <code>check_sql_injection_coverage.php</code> and <code>check_csrf_coverage.php</code>. PHPUnit: <code>--filter PentestReport</code>.</td>
