        ...
        <div class="scripts-table-wrap"><table class="scripts-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td>Imports the full <code>database.sql</code> against a live MySQL 8.0 server and asserts <strong>88</strong> tables in <code>itmanagement</code>. Catches INSERT/SELECT column-count mismatches (for example cross-company <code>equipment</code> seed at <code>department_id</code>). Used by CI job <strong>database-import</strong> in <code>.github/workflows/smoke.yml</code>.</td>
                    <td><code>bash scripts/verify_database_sql_import.sh</code> — requires MySQL on <code>127.0.0.1</code>, user <code>root</code>, password <code>itmanagement</code>. Env: <code>MYSQL_HOST</code>, <code>MYSQL_USER</code>, <code>MYSQL_PASSWORD</code>, <code>EXPECTED_TABLE_COUNT</code>.</td>
                </tr>
                <tr>
