    ...
    <div class="scripts-section scripts-catalog-section" id="security">
        ...
        <div class="scripts-catalog-grid"><table class="scripts-catalog">
            ...
            <tbody>
                ...
                <tr data-tags="Mixed">
                    <td><a href="send_mailpit_inbound_test_email.php" target="_blank" rel="nofollow noreferrer">send_mailpit_inbound_test_email.php</a></td>
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="mixed">Mixed</span></span></td>
                    <td>Sends a test email <strong>To</strong> a tenant <code>companies.email</code> via Mailpit SMTP (<code>127.0.0.1:1025</code>); optional <code>--process</code> runs inbound ticket creation.</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Mixed">
        ...
        <div class="scripts-catalog-grid"><table class="scripts-catalog">
            ...
            <tbody>
                ...
                <tr data-tags="Codebase">
                    ...
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="codebase">Codebase</span></span></td>
                    <td>Compares <code>CREATE TABLE</code> names in <code>db/</code> split bundle with <code>information_schema</code> for <code>itmanagement</code>. Use after PowerShell/MySQL imports that report success but stop early (partial import — live count below <code>grep -c '^CREATE TABLE' db/01_schema.sql</code>). Lists missing/extra tables; exit <code>1</code> on mismatch.</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Server">
                    ...
                    <td>Imports the full <code>db/</code> split bundle against a live MySQL 8.0 server and asserts the live <code>itmanagement</code> table count matches every <code>CREATE TABLE</code> in <code>db/01_schema.sql</code> (derived at runtime — same count as <code>grep -c '^CREATE TABLE' db/01_schema.sql</code>). Catches INSERT/SELECT column-count mismatches (for example cross-company <code>equipment</code> seed at <code>department_id</code>). Used by CI job <strong>database-import</strong> in <code>.github/workflows/smoke.yml</code>. Split alternative: <code>import_database_split.sh</code>.</td>
        ...
        <div class="scripts-catalog-grid"><table class="scripts-catalog">
            ...
            <tbody>
                ...
                <tr data-tags="tickets">
                    ...
                    <td>
                        CLI regression for tickets create <strong>Created By</strong> default at company <code>4</code>: stale Admin session (<code>employee_id=1</code>, <code>company_id=4</code>) must remap via <code>itm_ensure_company_context_employee_session()</code> during <code>config.php</code> bootstrap (<code>itm_is_admin()</code> in <code>itm_company_session.php</code>) and <code>tickets_default_created_by_employee_id()</code>; probes edit seed <code>TCK-0001</code> FKs. Read-only.
                    </td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
        ...
        <div class="scripts-catalog-grid"><table class="scripts-catalog">
            ...
            <tbody>
                ...
                <tr data-tags="Codebase">
                    ...
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="codebase">Codebase</span></span></td>
                    <td>Exploratory Tier 1–3 script subprocess audit (excludes Tier 4/5, <code>repro_*</code>, <code>verify_*</code>, <code>_tmp_*</code>). Per-script <code>exit_code</code> + isolated <code>docs/error_log.txt</code> deltas → <code>scripts/php_error_audit_results.json</code>. Allowlist: <code>scripts/data/perform_audit_allowlist.json</code>. Not a CI gate.</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Codebase">
                ...
                <tr data-tags="Codebase">
                    <td><a href="apply_crud_fk_label_display.php" target="_blank" rel="nofollow noreferrer">apply_crud_fk_label_display.php</a></td>
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="codebase">Codebase</span></span></td>
                    <td>One-time/maintenance: add canonical <code>$GLOBALS['fkMap']</code> label branch to flattened CRUD <code>cr_render_cell_value()</code> so list/view cells show FK names instead of raw ids. <strong>Default = dry-run</strong>; writes with CLI <code>--apply</code> or browser <code>?apply=1</code> (Admin). Verify with <code>list_raw_columns.php</code>. Idempotent.</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Codebase">
                ...
                <tr data-tags="Mixed">
                    ...
                    <td>Dry-run detect (default) or repair with <code>--apply</code> / <code>?run=1&amp;apply=1</code> for <code>????</code> emoji corruption in <code>ui_configuration.app_name</code>, <code>configuration_item_types.icon</code>, and <code>equipment_types.field_edit_emoji</code>. Static seed audit when MySQL unavailable. <strong>Tier 2:</strong> runs <code>--apply</code> (same as browser <code>?run=1&amp;apply=1</code>) when MySQL is available, with <code>check_equipment_type_sidebar_emoji.php</code>. Prefer <code>import_database_split.php</code> on Windows.</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Codebase">
                ...
                <tr data-tags="Codebase">
                    ...
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="codebase">Codebase</span></span></td>
                    <td>Static audit: visible <code>tinyint(1)</code> list/view columns must not fall through to raw <code>0</code>/<code>1</code> in <code>cr_render_cell_value()</code> — <code>active</code> uses badges; other checkbox columns use <code>itm_crud_render_checkbox_boolean_cell_value()</code> or bespoke ✅/❌.</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Codebase">
                    <td><a href="check_crud_has_company_from_field_columns.php" target="_blank" rel="nofollow noreferrer">check_crud_has_company_from_field_columns.php</a></td>
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="codebase">Codebase</span></span></td>
                    <td>Static audit: flattened CRUD modules must set <code>$hasCompany</code> from schema <code>$columns</code> — not UI-filtered <code>$fieldColumns</code> after <code>cr_is_hidden_*</code> removes <code>company_id</code> (breaks tenant scope + Add sample data).</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Codebase">
                    ...
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="codebase">Codebase</span></span></td>
                    <td>Static audit: dynamic scaffold modules with <code>$viewColumns</code> detail loops must expose the same business fields on create/edit (minus <code>company_id</code> and audit meta). Detects <code>$*ListHidden</code> / <code>$*ListHiddenFields</code> on <code>$uiColumns</code> when view still shows those columns. Exit <code>1</code> on parity gaps. Browser prints red parity failure lines and related list-hidden notes via <code>colorText</code>; plain per-scope reference gaps with module folder links (<code>../modules/&lt;slug&gt;/</code>). Shared lib: <code>itm_crud_view_edit_field_parity_audit.php</code>.</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Codebase">
    ...
    <div class="scripts-section scripts-catalog-section" id="admin-tools">
        ...
        <div class="scripts-catalog-grid"><table class="scripts-catalog">
            ...
            <tbody>
                ...
                <tr data-tags="Mixed">
                    <td><a href="apply_budget_categories_category_kind.php" target="_blank" rel="nofollow noreferrer">apply_budget_categories_category_kind.php</a></td>
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="mixed">Mixed</span></span></td>
                    <td>Backfill <code>budget_categories.category_kind</code> from canonical names and insert missing GL <code>7100</code> annual budgets for CAPEX demos. Use <code>--apply</code> or <code>?run=1&amp;apply=1</code> (Admin).</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Mixed">
                    <td><a href="verify_capex_opex.php" target="_blank" rel="nofollow noreferrer">verify_capex_opex.php</a></td>
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="mixed">Mixed</span></span></td>
                    <td>Regression for <code>modules/capex/</code> and <code>modules/opex/</code>: <code>budget_categories.category_kind</code> seeds, CAPEX/OPEX GL isolation (7100 vs 6100/6200), and report SQL month/full-year modes.</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Mixed">
                ...
                <tr data-tags="Codebase">
                    ...
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-cli">CLI</span><span class="scripts-badge scripts-badge-browser">Browser</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="codebase">Codebase</span></span></td>
                    <td>Per-module <strong>display</strong> date audit: <strong>OK</strong> when UK <code>dd/mmm/yyyy</code> helpers are used; <strong>WARN</strong> on raw ISO echo, legacy <code>date('d/m/Y')</code>, <code>type="date"</code> / <code>datetime-local</code> (with <code>--include-inputs</code>), or non-UK <code>date()</code> patterns. <strong>SKIP</strong> (<code>module_skip</code>) for exempt modules. Default WARN-only; <code>--module=</code> filter. Detection only. Included in <code>run_tier2_checks.php</code>. Lib: <code>scripts/lib/itm_module_date_format_display_audit.php</code>.</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Mixed">
                ...
                <tr data-tags="Mixed">
                    ...
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="mixed">Mixed</span></span></td>
                    <td>Regression for hospitality bundle: core hotel booking tables, <code>hotel_booking_last_rooms</code>, planning Arrivals/Departures/In-house/Future + hide filters, <code>itm_hotel_booking_resolve_segment()</code>, company 1 <code>PENDING</code> future status seed, confirmation PDF Manage my booking <code>/URI</code> link helper + markup, <code>hotel_bookings.auth2</code> guest PIN helpers, manage session rate-limit + locked INSERT (<code>FOR UPDATE</code>), Step 4 draft occupancy lock + <code>public_portal_enabled</code> browse/book gate wiring, portal fallback JPGs, stay-bar occupancy interactive on checkout steps 1–4 (<code>apply-occupancy.php</code>, <code>hotel-booking-occupancy.js</code>, <code>itm_hotel_booking_portal_apply_checkout_occupancy_change</code>), cancellation-policy URL extension allowlist + <code>booking/cancellation_policy/.htaccess</code>, calendar/From/Step 1 show cheapest tax-inclusive rate (STD BAR <code>75.00</code> × NR 10% + tourist tax ≈ <code>69.50</code>; Select Dates auto-advance from <code>calendar_month_advance_days_left</code>; <code>show_discount_strikethrough</code> admin toggle for list-price strikethrough), seed room <code>id=1</code> STD, Flexible vs Non-refundable rate-plan offer labels + <code>plan_surcharge_percent</code>, rooms list JS prices include tourist tax + cheapest plan discount/surcharge, free-cancel days + rate-plan merchandising seeded for companies 1–5, and subprocess render probe for all 13 Hospitality sidebar modules.</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="hotel_bookings">
                ...
                <tr data-tags="appointments appointment_visit_reasons">
                    ...
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="table">appointment_visit_reasons</span></span></td>
                    <td>Copy company 1 <code>appointment_visit_reasons</code> to all other tenants (<code>INSERT IGNORE</code>). Dry-run default; <code>--apply</code> or <code>?run=1&amp;apply=1</code> (Admin).</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                ...
                <tr data-tags="Mixed">
                    ...
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="mixed">Mixed</span></span></td>
                    <td>Static regression for <code>docs/report.md</code> pentest ITM-PENTEST-001–023. Labels: <code>[PASS]</code> remediated (001–003, 006–008, 009–016, 023), <code>[INFO]</code> documented posture (004, 004-mitigation, 005, 017–022), <code>[OPEN]</code> regression drift on remediated findings, <code>[FAIL]</code> drift. Invokes <code>check_sql_injection_coverage.php</code> and <code>check_csrf_coverage.php</code>. PHPUnit: <code>--filter PentestReport</code>.</td>
                ...
                <tr data-tags="saved_report_views scheduled_reports">
                ...
                <tr data-tags="Mixed">
                    <td><a href="verify_sso_ldap.php" target="_blank" rel="nofollow noreferrer">verify_sso_ldap.php</a></td>
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="mixed">Mixed</span></span></td>
                    <td>Regression: LDAP SSO schema columns, <code>itm_ldap_encrypt_config</code> round-trip, PHP <code>ldap</code> extension check (N/A when missing), <code>sso-ldap.php</code> + <code>includes/itm_ldap_auth.php</code>.</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Mixed">
                    <td><a href="verify_vault_org_recovery.php" target="_blank" rel="nofollow noreferrer">verify_vault_org_recovery.php</a></td>
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-cli">CLI</span><span class="scripts-badge scripts-badge-web">Browser</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="mixed">Mixed</span></span></td>
                    <td>Regression: vault org recovery schema, escrow crypto round-trip, consent + request + complete workflow (<code>includes/itm_vault_org_recovery.php</code>, <code>modules/vault_org_recovery/</code>).</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Mixed">
                ...
                <tr data-tags="employees">
                    ...
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="table">employees</span></span></td>
                    <td>Regression for employee <code>dashboard.php</code>: hero + grouped stat cards, Admin-only company switcher from login employee identity, Admin tenant remap load-order (<code>itm_is_admin()</code> in <code>itm_company_session.php</code>), smart widget wiring + Chart.js, <code>includes/itm_employee_dashboard.php</code> loader, no employment-status counts.</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="employees">
    ...
    <div class="scripts-section scripts-catalog-section" id="verification">
        ...
        <div class="scripts-catalog-grid"><table class="scripts-catalog">
            ...
            <tbody>
                ...
                <tr data-tags="Mixed">
                    <td><a href="verify_force_password_change.php" target="_blank" rel="nofollow noreferrer">verify_force_password_change.php</a></td>
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="mixed">Mixed</span></span></td>
                    <td>ITM-PENTEST-004 mitigation: <code>employees.must_change_password</code>, seed Admin flag, <code>force-password-change.php</code> gate wiring.</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Mixed">
                ...
                <tr data-tags="Mixed">
                    ...
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="mixed">Mixed</span></span></td>
                    <td>Ticket productivity pack: canned responses, CSAT token/URL, merge smoke.</td>
                    <td class="scripts-catalog-how-stub"><code>php scripts/verify_ticket_productivity.php</code></td>
                </tr>
                <tr data-tags="Mixed">
                ...
                <tr data-tags="Mixed">
                    ...
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="mixed">Mixed</span></span></td>
                    <td>Explorer <code>file.php</code> profile ACL: same-tenant peer read of <code>Private/{user}/profile/</code> allowed; cross-tenant without <code>employee_companies</code> grant denied; other Private paths owner-scoped.</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Mixed">
                ...
                <tr data-tags="Codebase setup">
                    ...
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="codebase">Codebase</span></span></td>
                    <td>Regression for setup wizard project-root repair: collapsed Windows session paths, step 1 confirmed root vs PHP runtime fallback, step 2 upload subdirectory resolution, Step 8 <code>setup/index.php</code> unlink. Uses <code>DB_HOST</code> (fallback <code>localhost</code>) and last complete JSON object from subprocess stdout (<code>setup/includes/itm_setup_wizard.php</code>).</td>
                ...
                <tr data-tags="Codebase setup">
                    ...
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="codebase">Codebase</span></span></td>
                    <td>Regression for setup wizard step 3 database probe/create/replace: missing schema <code>needs_create</code>, existing tables <code>needs_replace_confirm</code>, <code>DROP DATABASE</code> reset before import, and sample-data seeding isolation via <code>itm_setup_wizard_install_sample_data_for_companies()</code> (single company vs batch; fail closed if the extra schema cannot be created) (<code>setup/includes/itm_setup_wizard.php</code>).</td>
                ...
                <tr data-tags="Codebase">
                    ...
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="codebase">Codebase</span></span></td>
                    <td>Pre-deploy production hardening gate — seed passwords, browser error reporting, legacy web-root <code>error_log.txt</code>, dev env bypass flags, no-auth allowlists, and HTTP reachability of <code>bypass_login.php</code>. Enforces when <code>APP_ENV=production</code>; development prints <code>[WARN]</code> unless <code>--enforce</code>. Not part of CI smoke.</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Codebase">
                    ...
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="codebase">Codebase</span></span></td>
                    <td>Bulk repair — insert early <code>itm_crud_mutation_guard_entry()</code> on flattened CRUD <code>index.php</code> routers and strip duplicate per-handler guards. <strong>Default = dry-run</strong>; writes with CLI <code>--apply</code> or browser <code>?apply=1</code> (Admin). Idempotent.</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Codebase">
                    <td><a href="apply_crud_mutation_bootstrap.php" target="_blank" rel="nofollow noreferrer">apply_crud_mutation_bootstrap.php</a></td>
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-web">Browser</span><span class="scripts-badge scripts-badge-cli">CLI</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="codebase">Codebase</span></span></td>
                    <td>Bulk repair — insert <code>itm_crud_mutation_guard_entry()</code> on standalone <code>create.php</code> / <code>edit.php</code> / <code>delete.php</code> (skips index wrappers and redirect stubs). <strong>Default = dry-run</strong>; writes with CLI <code>--apply</code> or browser <code>?apply=1</code> (Admin). Idempotent.</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Mixed">
