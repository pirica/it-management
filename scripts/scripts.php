        ...
        <div class="scripts-catalog-grid"><table class="scripts-catalog">
            ...
            <tbody>
                ...
                <tr data-tags="Codebase">
                    ...
                    <td class="scripts-access-cell"><span class="scripts-access-badges"><span class="scripts-badge scripts-badge-cli">CLI</span><span class="scripts-badge scripts-badge-browser">Browser</span></span></td>
                    <td class="scripts-tags-cell"><span class="scripts-tag-badges"><span class="scripts-badge scripts-badge-tag" data-tag-kind="codebase">Codebase</span></span></td>
                    <td>Per-module <strong>display</strong> date audit: <strong>OK</strong> when UK <code>dd/mm/yyyy</code> helpers are used; <strong>WARN</strong> on raw ISO list/view echo or non-UK <code>date()</code> on output. Native <code>type="date"</code> / <code>datetime-local</code> skipped by default (<code>--include-inputs</code> to WARN). Default WARN-only; <code>--module=</code> filter. Detection only. Lib: <code>scripts/lib/itm_module_date_format_display_audit.php</code>.</td>
                    <td class="scripts-catalog-how-stub">Open in browser for usage.</td>
                </tr>
                <tr data-tags="Mixed">
