        ...
        <div class="scripts-table-wrap"><table class="scripts-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>CLI: <code>php scripts/benchmark_sidebar_module_access.php</code> · optional <code>--company=1 --employee=1 --iterations=3</code>. Browser: <a href="benchmark_sidebar_module_access.php">benchmark_sidebar_module_access.php</a> · query params <code>company</code>, <code>employee</code>, <code>iterations</code>. Env thresholds: <code>ITM_BSMA_MAX_FULL_QUERIES</code> (default 45), <code>ITM_BSMA_MIN_REDUCTION_PCT</code> (default 50). Run when changing sidebar discovery or module-access caching.</td>
                </tr>
                <tr>
