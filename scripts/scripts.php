        ...
        <div class="scripts-table-wrap"><table class="scripts-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>Browser: plain-text module list. CLI: <code>php scripts/check_ui_configuration_coverage.php</code> — run manually when module UI/layout changes; exits <code>2</code> on failure. Audits table actions, export card, search, Settings <code>records_per_page</code> pagination, bulk Select to Delete / Clear Table, and CRUD entry files. Skips bespoke/custom modules listed in <code>scripts/data/ui_configuration_excluded_modules.txt</code> (synced with <code>docs/list_bespoke_UI.txt</code>) and <code>is_*</code> prefixes in <code>ui_configuration_excluded_prefixes.txt</code>. Default output shows skip <strong>counts</strong> only; <code>--list-excluded</code> / <code>?list_excluded=1</code> prints slug names.</td>
                </tr>
                <tr>
