...
- **check_company_id_ui_column.php** — static inventory of modules whose list/view may show **Company** (`company_id`); scans every `modules/{slug}/**/*.php` file (recursive). CLI `--list-exposed` / `--strict`; lib `scripts/lib/itm_company_id_ui_column_audit.php`. Catalog: **`scripts/scripts.php`**.
