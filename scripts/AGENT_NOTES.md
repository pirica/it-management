...
- **verify_source_utf8_mojibake.php** / **apply_utf8_mojibake_fix.php** — UTF-8 / mojibake static audit and optional repair via `scripts/lib/itm_mojibake_audit.php`. Browser + CLI; `--path=` / `?path=` scope; apply dry-run default. Catalog: **`scripts/scripts.php`**.
