...
- **repro_audit_token_leak.php** / **repro_vulnerabilities.php** / **repro_esa_vulnerability.php** / **repro_auth_bypass_v3.php** — security repro scripts; subprocess spawns use `escapeshellarg()`; audit token repro uses prepared statements for disposable test-user `reset_token` updates.
