...
- **split_database_sql.php** / **verify_database_split_parity.php** / **import_database_split.sh** — generate and verify `db/01_schema.sql`, `db/03_data.sql`, `db/02_triggers.sql` from `database.sql`; import order 01 → 03 → 02 in one session. Shared lib: `lib/itm_database_sql_split.php`. See `db/AGENT_NOTES.md`.
