...
- **check_company_id_ui_column.php** — static inventory of modules whose list table may show **Company** (`company_id`): scaffold `$hideCompanyIdTables` vs bespoke hide filters. CLI `--list-exposed` / `--strict`; lib `scripts/lib/itm_company_id_ui_column_audit.php`. Catalog: **`scripts/scripts.php`**.
