...
- **fast_create_acc.php** — Admin browser UI + CLI `--seed-demo-bundle` to seed/update demo employees via **`lib/itm_demo_module_users_seed.php`** (FK form fields, role/RBAC, sidebar, `ui_configuration`).
