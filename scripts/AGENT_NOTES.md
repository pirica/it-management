...
- **Auto-Scaffolding Workspace Clean up** — Added `git clean -fd modules/` commands to `phpunit/tests/Unit/Includes/CompanyModuleAccessDiscoveryTest.php::tearDown()` and the end of `scripts/run_tests.php` to ensure any auto-scaffolded directory or file generated during test runs is automatically removed, maintaining a pristine workspace.
