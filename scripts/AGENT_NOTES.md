...
- **check_crud_view_edit_field_parity.php** — static view/edit form parity for dynamic scaffold modules (`$viewColumns` vs `$uiColumns` / `$*ListHidden` / edit-section helpers). Shared lib: **`itm_crud_view_edit_field_parity_audit.php`**. Catalog: **`scripts/scripts.php`**; workflow: **`SCRIPTS.md`** → *CRUD view/edit field parity*.
