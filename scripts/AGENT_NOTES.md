...
- **debug_resignations_termination_date.php** — diagnoses resignations weekly filter for a given `termination_date` (default `18/06/2026`); compares PHP/MySQL week metadata, ISO bounds, legacy predicates, module SQL, and today's verify-probe bounds.
