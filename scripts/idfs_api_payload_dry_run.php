...
Browser: <a href="idfs_api_payload_dry_run.php?samples=1">samples</a> · <code>?endpoint=port_update&amp;json=…</code><br> CLI: <code>php scripts/idfs_api_payload_dry_run.php --samples</code> · <code>--endpoint=port_update --file=payload.json</code>
