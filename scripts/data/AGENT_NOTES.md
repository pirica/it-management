...
- **fields_missing_reviewed.json** — reviewed bespoke `[SKIP][fail]` gate lines for `fields_missing.php` (manifest: `fields_missing_reviewed.php`). Matching failures print as `[SKIP][fail][reviewed]` (informational only).
