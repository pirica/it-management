...
- **php.ini.dunebox-7.4.template** — `php.ini` body for Dunebox PHP under `D:\dunebox-v1.0.6` (`__EXT_DIR__` placeholder). Applied by `scripts/setup_dunebox_php_from_laragon.ps1` (copies `php_xdebug.dll` from Laragon portable).
