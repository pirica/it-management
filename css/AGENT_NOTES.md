...
## 10. Common Pitfalls
- Overwriting global variables without checking their impact on other modules.
- Fixed-width sidebars (`280px`, `320px`) without a mobile stack breakpoint.
- `white-space: nowrap` on table headers/cells without a scroll wrapper or mobile override.
- Duplicating `.audit-table-wrap` in module CSS — define once in `styles.css`.
