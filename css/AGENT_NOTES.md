...
| `chatbot.css` | Floating IT Support Assistant widget (`#itmChatbotToggle`, `#itmChatbotContainer`). Toggle and panel are fixed on the **right edge at ~55% viewport height** so list pagination controls at the bottom stay clickable. |
