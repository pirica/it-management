...
/* 3) Obter o resultado numérico */
mysqli_stmt_bind_result($stmt, $total_events_forme);
mysqli_stmt_fetch($stmt);
mysqli_stmt_close($stmt);

// Agora a variável $total_events_forme tem o número exato de eventos ativos
//echo "Total de eventos ativos: " . $total_events_forme;
...
// Agora a variável $total_events tem o número exato de eventos ativos
//echo "Total de eventos ativos: " . $total_events_created;
...
$dir = __DIR__ . "/files/{$company_id}/Private/{$foldername}/";
