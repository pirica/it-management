...
class MonthlyBudgetsTest extends TestCase
{
    ...
    public function testCRUD()
    {
        ...
        $resannual_budget_id = mysqli_query($this->conn, "SELECT id FROM `annual_budgets` WHERE " . (strpos('annual_budgets', 'companies') === false && strpos('annual_budgets', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
