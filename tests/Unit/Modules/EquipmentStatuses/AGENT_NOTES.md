# AGENT_NOTES.md - EquipmentStatuses Tests

## 1. Module Purpose
Unit/regression tests for `modules/equipment_statuses/`.

## 3. Required Relationships
- Production docs: `modules/equipment_statuses/AGENT_NOTES.md` (when present).
