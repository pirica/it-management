...
class ApproversTest extends TestCase
{
    ...
    public function testCRUD()
    {
        ...
        $resapprover_type_id = mysqli_query($this->conn, "SELECT id FROM `approver_type` WHERE " . (strpos('approver_type', 'companies') === false && strpos('approver_type', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
