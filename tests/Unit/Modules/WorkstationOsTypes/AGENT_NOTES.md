# AGENT_NOTES.md - WorkstationOsTypes Tests

## 1. Module Purpose
Unit/regression tests for `modules/workstation_os_types/`.

## 3. Required Relationships
- Production docs: `modules/workstation_os_types/AGENT_NOTES.md` (when present).
