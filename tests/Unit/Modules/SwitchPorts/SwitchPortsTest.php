...
class SwitchPortsTest extends TestCase
{
    ...
    public function testCRUD()
    {
        ...
        $resport_type = mysqli_query($this->conn, "SELECT type FROM `switch_port_types` WHERE " . (strpos('switch_port_types', 'companies') === false && strpos('switch_port_types', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resstatus_id = mysqli_query($this->conn, "SELECT id FROM `switch_status` WHERE " . (strpos('switch_status', 'companies') === false && strpos('switch_status', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resrj45_speed_id = mysqli_query($this->conn, "SELECT id FROM `rj45_speed` WHERE " . (strpos('rj45_speed', 'companies') === false && strpos('rj45_speed', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resfiber_port_id = mysqli_query($this->conn, "SELECT id FROM `equipment_fiber` WHERE " . (strpos('equipment_fiber', 'companies') === false && strpos('equipment_fiber', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resfiber_patch_id = mysqli_query($this->conn, "SELECT id FROM `equipment_fiber_patch` WHERE " . (strpos('equipment_fiber_patch', 'companies') === false && strpos('equipment_fiber_patch', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resfiber_rack_id = mysqli_query($this->conn, "SELECT id FROM `equipment_fiber_rack` WHERE " . (strpos('equipment_fiber_rack', 'companies') === false && strpos('equipment_fiber_rack', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $residf_id = mysqli_query($this->conn, "SELECT id FROM `idfs` WHERE " . (strpos('idfs', 'companies') === false && strpos('idfs', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resto_idf_id = mysqli_query($this->conn, "SELECT id FROM `idfs` WHERE " . (strpos('idfs', 'companies') === false && strpos('idfs', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resto_rack_id = mysqli_query($this->conn, "SELECT id FROM `racks` WHERE " . (strpos('racks', 'companies') === false && strpos('racks', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resrack_id = mysqli_query($this->conn, "SELECT id FROM `racks` WHERE " . (strpos('racks', 'companies') === false && strpos('racks', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resto_location_id = mysqli_query($this->conn, "SELECT id FROM `it_locations` WHERE " . (strpos('it_locations', 'companies') === false && strpos('it_locations', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resmanagement_id = mysqli_query($this->conn, "SELECT id FROM `equipment_environment` WHERE " . (strpos('equipment_environment', 'companies') === false && strpos('equipment_environment', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
