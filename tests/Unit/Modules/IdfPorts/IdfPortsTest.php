...
class IdfPortsTest extends TestCase
{
    ...
    public function testCRUD()
    {
        ...
        $resposition_id = mysqli_query($this->conn, "SELECT id FROM `idf_positions` WHERE " . (strpos('idf_positions', 'companies') === false && strpos('idf_positions', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resport_type = mysqli_query($this->conn, "SELECT id FROM `switch_port_types` WHERE " . (strpos('switch_port_types', 'companies') === false && strpos('switch_port_types', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resspeed_id = mysqli_query($this->conn, "SELECT id FROM `equipment_fiber` WHERE " . (strpos('equipment_fiber', 'companies') === false && strpos('equipment_fiber', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resfiber_ports_number = mysqli_query($this->conn, "SELECT id FROM `equipment_fiber_count` WHERE " . (strpos('equipment_fiber_count', 'companies') === false && strpos('equipment_fiber_count', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resswitch_port_numbering_layout_id = mysqli_query($this->conn, "SELECT id FROM `switch_port_numbering_layout` WHERE " . (strpos('switch_port_numbering_layout', 'companies') === false && strpos('switch_port_numbering_layout', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $respoe_id = mysqli_query($this->conn, "SELECT id FROM `equipment_poe` WHERE " . (strpos('equipment_poe', 'companies') === false && strpos('equipment_poe', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
