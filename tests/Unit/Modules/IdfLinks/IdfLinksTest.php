...
class IdfLinksTest extends TestCase
{
    ...
    public function testCRUD()
    {
        ...
        $resport_id_a = mysqli_query($this->conn, "SELECT id FROM `idf_ports` WHERE " . (strpos('idf_ports', 'companies') === false && strpos('idf_ports', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resport_id_b = mysqli_query($this->conn, "SELECT id FROM `idf_ports` WHERE " . (strpos('idf_ports', 'companies') === false && strpos('idf_ports', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resequipment_rj45_speed_id = mysqli_query($this->conn, "SELECT id FROM `rj45_speed` WHERE " . (strpos('rj45_speed', 'companies') === false && strpos('rj45_speed', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resequipment_fiber_port_id = mysqli_query($this->conn, "SELECT id FROM `equipment_fiber` WHERE " . (strpos('equipment_fiber', 'companies') === false && strpos('equipment_fiber', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resequipment_fiber_patch_id = mysqli_query($this->conn, "SELECT id FROM `equipment_fiber_patch` WHERE " . (strpos('equipment_fiber_patch', 'companies') === false && strpos('equipment_fiber_patch', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resequipment_fiber_rack_id = mysqli_query($this->conn, "SELECT id FROM `equipment_fiber_rack` WHERE " . (strpos('equipment_fiber_rack', 'companies') === false && strpos('equipment_fiber_rack', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resequipment_to_idf_id = mysqli_query($this->conn, "SELECT id FROM `idfs` WHERE " . (strpos('idfs', 'companies') === false && strpos('idfs', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resequipment_to_rack_id = mysqli_query($this->conn, "SELECT id FROM `racks` WHERE " . (strpos('racks', 'companies') === false && strpos('racks', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $resequipment_to_location_id = mysqli_query($this->conn, "SELECT id FROM `it_locations` WHERE " . (strpos('it_locations', 'companies') === false && strpos('it_locations', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
        ...
        $rescable_color_id = mysqli_query($this->conn, "SELECT id FROM `cable_colors` WHERE " . (strpos('cable_colors', 'companies') === false && strpos('cable_colors', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
