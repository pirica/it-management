...
class IdfPositionsTest extends TestCase
{
    ...
    public function testCRUD()
    {
        ...
        $resdevice_type = mysqli_query($this->conn, "SELECT id FROM `idf_device_type` WHERE " . (strpos('idf_device_type', 'companies') === false && strpos('idf_device_type', 'users') === false ? "company_id = {$this->companyId}" : "1=1") . " LIMIT 1");
