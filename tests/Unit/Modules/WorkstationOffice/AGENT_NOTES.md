# AGENT_NOTES.md - WorkstationOffice Tests

## 1. Module Purpose
Unit/regression tests for `modules/workstation_office/`.

## 3. Required Relationships
- Production docs: `modules/workstation_office/AGENT_NOTES.md` (when present).
