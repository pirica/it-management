# AGENT_NOTES.md - AssignmentTypes Tests

## 1. Module Purpose
Unit/regression tests for `modules/assignment_types/`.

## 3. Required Relationships
- Production docs: `modules/assignment_types/AGENT_NOTES.md` (when present).
